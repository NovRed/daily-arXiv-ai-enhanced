...
Motivation: Addresses the challenge of accurately identifying graphical implicit correlations in multimodal irony detection tasks.

Method: Introduces ConceptNet for common-sense reasoning, designs word and sample-level cross-modal semantic similarity modules, and uses contrastive learning for feature optimization.

Result: Achieves 88.87% accuracy and 86.33% F1, outperforming existing methods by 1.64% and 2.88%, respectively.
...
Method: Develop Argus Inspection benchmark and Eye of Panoptes framework with a binary parametric Sigmoid metric.

Result: Highest performance in visual fine-grained reasoning is 0.46, indicating need for improvement.

Conclusion: The research provides insights for refining MLLMs' capabilities.
...
<details>
  <summary>Details</summary>
Motivation: To improve the accuracy and efficiency of falcon disease detection, ensuring better health surveillance for these birds.

Method: Uses a hybrid of ConvNeXt and EfficientNet models to classify three conditions: Normal, Liver Disease, and Aspergillosis.
...
Conclusion: The hybrid AI model advances falcon disease detection and opens avenues for AI in avian healthcare.
...
Method: ViLLa integrates a visual detection module, a language parser, and a symbolic reasoning layer to ground visual data into symbolic facts and apply logic-based inference for query answering.

Result: The system successfully bridges visual content with structured queries, demonstrating interpretability and accuracy in animal monitoring tasks.

Conclusion: ViLLa offers a modular and transparent alternative to black-box models, effectively combining perception, understanding, and reasoning for animal monitoring.
...
Method: Proposes Dual Gaussians Graph Attention for dynamic geometric and semantic graph construction, coupled with Multi-scale Graph Attention for fine and coarse-grained feature modeling.

Result: Achieves 24.10% mIoU on SurroundOcc dataset with 1.97% improvement and 13.7% memory reduction (6.1 GB GPU usage).

Conclusion: GraphGSOcc effectively addresses key limitations in 3DGS methods, improving performance and efficiency for autonomous driving applications.
...
<details>
  <summary>Details</summary>
Motivation: The need for reliable, explainable methods to distinguish AI-generated videos from authentic ones, as current binary classification lacks insight.
...
Conclusion: Explainable detection methods, like DAVID-XR1, are promising for trustworthy identification of AI-generated videos.
...
Method: Categorizes existing methods by architectural design, input representations, and prediction strategies, using the ETH/UCY benchmark for evaluation.

Result: Highlights advancements and trends in multi-agent trajectory prediction.

Conclusion: Identifies key challenges and suggests future research directions in the field.
...
<details>
  <summary>Details</summary>
Motivation: To objectively analyze and compare human-designed and machine-generated 3D forms to improve generative design tools.
...
Result: The model achieved 94.29% accuracy, 96.2% precision, and 98.51% recall in distinguishing form origins.

Conclusion: Human-designed forms excel in spatial organization and detail, while the study offers insights for improving generative tools.
...
<details>
  <summary>Details</summary>
Motivation: Direct DETR application in monocular 3D detection has limitations; MonoVQD aims to overcome these for better performance.

Method: Introduces Mask Separated Self-Attention, Variational Query Denoising, and self-distillation to enhance DETR-based detection.

Result: Achieves superior performance on KITTI and generalizes well to nuScenes, showing broad applicability.

Conclusion: MonoVQD advances monocular 3D detection with robust components that improve performance and generalization.
...
Conclusion: The proposed method effectively enhances MLLMs' chart-to-code generation by leveraging structured instructions and iterative refinement.
...
Result: PictSure achieves superior out-of-domain performance while matching in-domain results, highlighting the importance of embedding model pretraining.

Conclusion: Optimizing embedding model pretraining is crucial for effective ICL-based FSIC, as demonstrated by PictSure's success.
...
<details>
  <summary>Details</summary>
Motivation: Kernel size selection in CNNs is often overlooked but impacts model performance. BKSEF addresses this by optimizing kernel size layer-wise.

Method: BKSEF integrates information theory, signal processing, and learning theory to balance accuracy and efficiency.

Result: Experiments show up to 3.1% accuracy improvement and 42.8% FLOPs reduction. Case studies confirm practical benefits in medical imaging and edge devices.

Conclusion: BKSEF redefines kernel size as an optimizable parameter, offering theoretical and practical benefits for CNN design.
...
<details>
  <summary>Details</summary>
Motivation: Manual video annotation in retail is time-consuming, costly, and non-robust. Automation is needed to improve efficiency and reduce operational expenses.
...
Conclusion: The approach significantly enhances efficiency and cost-effectiveness in retail video annotation, benefiting applications like shopper analysis and security monitoring.
...
<details>
  <summary>Details</summary>
Motivation: Determining the most valuable viewpoints for accurate 3D reconstruction is a challenge. Existing methods rely on learning radiance fields or computing uncertainty per viewpoint, which can be computationally expensive.

Method: UPNet predicts uncertainty maps from a single input image, leveraging heuristics from natural objects. It aggregates these maps to select optimal viewpoints, reducing redundancy and computational overhead.

Result: The method achieves comparable accuracy with half the viewpoints, speeds up AVS by 400x, and reduces CPU, RAM, and GPU usage by over 50%. It generalizes to novel object categories without retraining.

Conclusion: UPNet offers an efficient, scalable solution for AVS, balancing accuracy and computational efficiency while generalizing well to unseen object categories.
...
<details>
  <summary>Details</summary>
Motivation: To improve alignment in T2I models for better intent capture, safety, and fairness, extending DPO from LLMs to T2I systems.

Method: DPO-Kernels with hybrid loss, kernelized representations (RBF, Polynomial, Wavelet), and divergence selection (Wasserstein, R'enyi). Introduces DETONATE benchmark and AQI measure.

Result: DPO-Kernels show strong generalization via HT-SR. DETONATE provides a large-scale bias benchmark. AQI reveals latent-space vulnerabilities.

Conclusion: DPO-Kernels enhance T2I alignment, with DETONATE and AQI offering tools for evaluating and improving model fairness and robustness.
...
TL;DR: PeRL, a reinforcement learning approach, enhances vision-language models for multimodal reasoning by addressing multi-image positional relationships and improving learning efficiency.


<details>
  <summary>Details</summary>
Motivation: Existing RL approaches for VLMs struggle with multi-image positional reasoning, limiting their applicability to complex real-world scenarios.

Method: Introduces permutation of image sequences for diversity and a rollout filtering mechanism for efficient policy exploitation.

Result: PeRL outperforms baselines on multi-image benchmarks while maintaining performance on single-image tasks.

Conclusion: PeRL advances multimodal reasoning by effectively handling interleaved tasks and improving generalization.
...
Method: Introduces FCRE, focusing on mid-frequency reconstruction errors, excluding high and low frequencies, and using structural similarity index scores for membership determination.

Result: FCRE outperforms existing MIA methods on medical image datasets.

Conclusion: The FCRE method effectively mitigates challenges in MIAs for medical images, enhancing privacy risk quantification.
...
<details>
  <summary>Details</summary>
Motivation: Improving jet tagging in high-energy physics is crucial for new physics searches and precision measurements, but ViT architectures remain underexplored for direct calorimeter image analysis.

Method: The study uses simulated 2012 CMS Open Data to construct multi-channel jet-view images and evaluates ViT and hybrid models against CNN baselines.
...
Conclusion: This work establishes a framework for applying ViTs to jet classification and provides a dataset for future deep learning research in this domain.
...
<details>
  <summary>Details</summary>
Motivation: Traditional compliance detection lacks portability and scalability, while existing neural methods using tactile sensors have low accuracy.

Method: Developed LRCNs and Transformer models leveraging RGB tactile images from GelSight to predict compliance metrics.

Result: Models showed significant performance improvement over baselines; harder objects were more challenging to estimate.

Conclusion: The proposed models effectively improve compliance prediction accuracy, though harder objects remain a challenge.
...
Method: PALETTE uses hyper-local sampling for precise feature extraction and hyper-local positional embeddings for spatial interactions. SynthMap+ generates synthetic training data.

Result: PALETTE outperforms SOTA text spotters on benchmark datasets, especially for long and angled text, and has processed 60,000 maps with 100M+ labels.

Conclusion: PALETTE and SynthMap+ provide an effective solution for text extraction from historical maps, supporting large-scale applications like the David Rumsey collection.
...
Method: 1. Semantic-based style injection using BLIP and CLIP. 2. Human feedback-driven data augmentation. 3. Training-free triple diffusion process with query preservation.
...
Conclusion: Using Wasserstein distance effectively mitigates key issues in vector quantization, enhancing model performance and stability.
...
Conclusion: SynPo effectively addresses the limitations of LVMs in medical image segmentation by improving prompt quality without training.
...
Method: PDSA leverages high-dimensional correlations to correct feature distribution during aggregation, using a lightweight cross-stage structural descriptor and a key point mechanism to optimize computational overhead.

Result: Experiments on semantic segmentation and classification tasks show significant performance improvements with fewer parameters.

Conclusion: PDSA effectively addresses limitations of existing methods, offering better computational efficiency and robustness, as validated by ablation studies and visualizations.
...
Method: Echo-DND combines Gaussian and Bernoulli noises, uses multi-scale fusion conditioning, and spatial coherence calibration for precise segmentation.
...
Conclusion: ReSeDis provides a realistic testbed for advancing multimodal search systems.
...
<details>
  <summary>Details</summary>
Motivation: Specialized medical image models are limited to predefined tasks, requiring expertise and resources. Generalist models offer flexibility by allowing on-the-fly task definition without task-specific development.

Method: The study uses visual in-context learning (VICL) to train generalist models for retinal OCT, enabling generalization across tasks based on few examples at inference time.

Result: A state-of-the-art medical VICL approach is evaluated on multiple OCT datasets, establishing a baseline and highlighting VICL's potential and current limitations.

Conclusion: Generalist models via VICL show promise for OCT, though limitations exist. Openly released code aims to foster further research and adoption.
...
<details>
  <summary>Details</summary>
Motivation: To safeguard user privacy by preventing images from being exploited by search engines and VLP models, while retaining image utility.

Method: Introduces PSIC with a Conditional Latent Trigger Generation (CLTG) module and Uncertainty-Aware Encryption-Oriented (UAEO) optimization, integrating adaptive multi-objective optimization for improved performance.

Result: Demonstrates effectiveness across multiple downstream tasks, balancing encryption and perceptual quality.

Conclusion: PSIC is a plug-and-play solution that enhances privacy protection in image compression without compromising functionality.
...
<details>
  <summary>Details</summary>
Motivation: Existing MMIF methods struggle with detailed feature capture and cross-modal interaction, leading to suboptimal fused image quality.

Method: A two-stage approach: Stage I uses a diffusion process with UNet for image reconstruction, while Stage II inputs noisy images into a fusion network with adaptive modules. A hybrid loss function optimizes brightness, color, contrast, and detail.

Result: The method outperforms in objective metrics, producing fused images with balanced brightness, rich textures, clear edges, and comprehensive radioactive tracer distribution.

Conclusion: DM-FNet effectively improves MMIF quality by leveraging diffusion models and adaptive fusion modules, validated by superior experimental results.
...
<details>
  <summary>Details</summary>
Motivation: To enhance video understanding by generating detailed and accurate descriptions in natural language.

Method: Uses low-rank adaptation (LoRA) and multi-round DPO (MrDPO) with periodic updates, merging, and ground-truth guidance.

Result: Reduces captioning error rates by 28%, surpassing GPT-4o and Gemini-1.5-Pro in video captioning.

Conclusion: Video-SALMONN 2 achieves state-of-the-art performance in video captioning with competitive results in video QA tasks.
...
<details>
  <summary>Details</summary>
Motivation: SAR ship detection faces issues like scale variations, noise from small vessels, and complex backgrounds, necessitating better feature representation and fusion methods.

Method: C-AFBiFPN introduces a Convolutional Feature Enhancement (CFE) module and integrates BiFormer attention into BiFPN, creating AFBiFPN for improved feature fusion and global modeling.

Result: Experiments on SSDD show enhanced detection accuracy for small targets, robustness against occlusions, and better multi-scale feature adaptability.

Conclusion: C-AFBiFPN effectively addresses SAR ship detection challenges, offering improved performance through advanced feature enhancement and fusion.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods for 3D reconstruction (NeRF, 3DGS) rely on accurate camera poses, but struggle with complex trajectories. RA-NeRF aims to address this limitation.

Method: RA-NeRF integrates photometric consistency, flow-driven pose regulation, and an implicit pose filter to enhance pose accuracy and robustness.
...
Conclusion: RA-NeRF is effective and robust for scene reconstruction under complex camera trajectories, outperforming prior methods.
...
<details>
  <summary>Details</summary>
Motivation: Existing COD methods lack mechanisms for historical context, limiting adaptability in complex camouflage scenes.

Method: RetroMem uses a two-stage training paradigm: learning (with DMA for multi-scale info) and recall (with DMM and IPR for dynamic memory).

Result: Extensive experiments show RetroMem significantly outperforms state-of-the-art methods.

Conclusion: RetroMem's dynamic memory integration improves camouflage scene understanding and detection performance.
...
<details>
  <summary>Details</summary>
Motivation: High demand and competition in semiconductors necessitate faster time-to-market and quality. DA reduces manual re-labeling and computational costs, leveraging deep learning for Industry 4.0/5.0 applications.
...
Conclusion: The DBACS approach advances DA techniques, proving effective for semiconductor defect classification, reducing costs, and optimizing expert focus.
...
Method: Proposes MSNeRV with temporal windows, GoP-level grids, a multi-scale spatial decoder, and a multi-scale feature block for enhanced feature extraction.

Result: Superior representation capability among INR-based methods and better compression efficiency than VTM-23.7 in dynamic scenarios.

Conclusion: MSNeRV addresses INR limitations and advances neural video representation and compression.
...
Method: BCRNet includes Multi-modal Feature Extraction (MFE), Adaptive Curve Proposal Initialization (ACPI), and Hierarchical Curve Refinement (HCR) for iterative curve adjustment.
...
Conclusion: BCRNet enhances surgical navigation by improving landmark detection, with code availability for further use.
...
<details>
  <summary>Details</summary>
Motivation: Traditional ME analysis methods treat spotting and recognition separately, which is suboptimal for real-world applications. The emergence of multimodal large language models (MLLMs) and large vision-language models (LVLMs) offers new opportunities to enhance ME analysis.

Method: The paper proposes two tasks: (1) ME spot-then-recognize (ME-STR), a unified pipeline for ME spotting and recognition, and (2) ME visual question answering (ME-VQA), which uses MLLMs/LVLMs for ME understanding through diverse questions.

Result: The MEGC 2025 challenge introduces these tasks, requiring algorithms to run on a test set and submit results to a leaderboard.

Conclusion: The paper aims to advance ME analysis by integrating spotting and recognition and leveraging multimodal models, setting new research directions for the field.
...
Method: MapFM incorporates a foundation model for encoding camera images and uses auxiliary prediction heads for BEV semantic segmentation to enhance feature representation and prediction quality.

Result: The multi-task learning approach yields richer contextual supervision, leading to higher accuracy and improved quality of vectorized HD maps.

Conclusion: MapFM demonstrates the effectiveness of combining foundation models and multi-task learning for superior online HD map generation.
...
<details>
  <summary>Details</summary>
Motivation: Traditional Active Learning (AL) methods assume a closed-set scenario and waste labeling costs in open-set scenarios with Out-Of-Distribution (OOD) data. OpenPath addresses this inefficiency.

Method: OpenPath uses task-specific prompts in the first query to select In-Distribution (ID) samples and employs Diverse Informative ID Sampling (DIS) in subsequent queries to ensure purity and informativeness.

Result: Experiments on two public datasets show OpenPath significantly improves model performance by selecting high-purity samples, outperforming state-of-the-art open-set AL methods.

Conclusion: OpenPath effectively reduces labeling costs and enhances performance in open-set pathology image classification, offering a practical solution for real-world clinical environments.
...
<details>
  <summary>Details</summary>
Motivation: To enable accurate counting of unique object instances in videos, especially in crowded scenes with occlusions and similar objects.
...
Conclusion: The model and dataset are publicly available, offering a robust solution for open-world object counting in videos.
...
Conclusion: The framework enhances re-identification accuracy without requiring ground truth UV annotations, using self-supervised training.
...
<details>
  <summary>Details</summary>
Motivation: The utility of open-source pre-trained models declines without original training data, and existing DFIS methods produce samples deviating from the true distribution due to lack of natural image priors.

Method: DDIS leverages a diffusion model as an image prior, introduces Domain Alignment Guidance (DAG) for domain alignment, and optimizes a Class Alignment Token (CAT) for class-specific attributes.
...
Conclusion: DDIS achieves state-of-the-art performance in data-free applications by accurately aligning synthetic images with the training data distribution.
...
<details>
  <summary>Details</summary>
Motivation: Reliability in deep learning for medical imaging is critical, especially for detecting OOD samples that could indicate anomalies. Existing methods may not fully capture OOD diversity.

Method: NERO clusters neuron-level relevance for ID classes into centroids, uses a relevance distance metric for OOD detection, and refines performance with scaled relevance and feature norms.
...
<details>
  <summary>Details</summary>
Motivation: The field of 3D AIGC is complex and largely inaccessible to non-experts, prompting the need for a practical tutorial.

Method: The tutorial uses Hunyuan3D 2.1, which includes Hunyuan3D-DiT for shape generation and Hunyuan3D-Paint for texture synthesis, covering data preparation, model architecture, training, and evaluation.

Result: Participants will gain the ability to develop or finetune a 3D generative model for applications like gaming and design.

Conclusion: The tutorial equips users with practical knowledge to leverage advanced 3D AIGC systems like Hunyuan3D 2.1.
...
Conclusion: MRG-LLM effectively integrates LLMs with medical imaging, enabling precise report generation.
...
<details>
  <summary>Details</summary>
Motivation: The challenge lies in synthesizing 4D HOI sequences due to limited large-scale datasets, despite advances in diffusion models and motion datasets.

Method: A two-stage approach: 1) Object-AnchorNet reconstructs sparse 3D HOI keyframes for unseen objects; 2) ContactDM interpolates these into dense 4D sequences using contact-aware techniques.
...
Conclusion: GenHOI effectively addresses 4D HOI synthesis challenges, demonstrating robust generalization and high-quality output.
...
Result: 17 teams submitted solutions, demonstrating progress in shadow removal.
...
Method: CLAIM uses a diffusion-based generator (SMILE module) guided by the AHA 17-segment model for anatomically consistent scar synthesis and joint training for segmentation.
...
<details>
  <summary>Details</summary>
Motivation: Current dense-supervised methods for radar-based depth estimation are costly and data-intensive. RaCalNet aims to reduce reliance on dense labels while maintaining accuracy.

Method: RaCalNet recalibrates sparse radar points to create depth priors, which guide monocular depth prediction without dense supervision, improving structural consistency and detail preservation.

Result: RaCalNet outperforms dense-supervised methods, reducing RMSE by 35.30% and 34.89% on the ZJU-4DRadarCam dataset and real-world scenarios, respectively.

Conclusion: RaCalNet demonstrates that sparse supervision can achieve superior depth estimation, offering a cost-effective and efficient alternative to dense-supervised approaches.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods using pre-trained Text-to-Image models struggle with imprecise localization and artifacts. WinWinLay addresses these issues.

Method: Proposes Non-local Attention Energy Function for better alignment and Adaptive Update (Langevin dynamics-based) to avoid out-of-distribution artifacts.

Result: WinWinLay outperforms state-of-the-art methods in control and visual fidelity.

Conclusion: WinWinLay effectively enhances layout adherence and realism without additional training.
...
<details>
  <summary>Details</summary>
Motivation: To create scalable and versatile models for multimodal tasks across text, images, and videos.

Method: Uses a 3D causal variational autoencoder with dual-path spatial-temporal fusion, autoregressive modeling for text, and flow matching for image/video generation. Includes a two-stage training recipe.

Result: Show-o2 effectively handles diverse multimodal tasks, demonstrating versatility.

Conclusion: The approach enables scalable and unified multimodal understanding and generation, with released code and models.
...
Method: Proposes a semi-supervised segmentation framework using SAM2 and a FreqWeaver Adapter for fine-grained detail modeling, with only 5.96% of total model parameters.
...
Conclusion: The framework provides robust segmentation with superior structural consistency, addressing practical needs for higher-resolution imagery under weak supervision.
...
TL;DR: The paper proposes a Dual LoRA Learning (DLoRAL) paradigm to enhance video super-resolution (Real-VSR) by balancing spatial detail reproduction and temporal consistency using stable diffusion (SD).


<details>
  <summary>Details</summary>
Motivation: Existing SD-based Real-VSR methods often sacrifice spatial details for temporal coherence, leading to suboptimal visual quality. The challenge is to maintain both aspects effectively.

Method: DLoRAL uses a Cross-Frame Retrieval (CFR) module and two LoRA branches (C-LoRA for temporal consistency and D-LoRA for spatial details) trained iteratively. The merged LoRA branches enable efficient one-step diffusion.

Result: DLoRAL achieves strong performance in accuracy and speed, producing detail-rich and temporally consistent video outputs.

Conclusion: The proposed method effectively addresses the trade-off between spatial details and temporal consistency in Real-VSR, offering a practical solution with high-quality results.
...
TL;DR: M2M-Reg is a novel framework for multi-modal deformable image registration (DIR) that uses mono-modal similarity, outperforming prior methods in PET-MRI and FA-MRI alignment.
...
Method: Proposes M2M-Reg, training multi-modal DIR models using mono-modal similarity, and introduces GradCyCon for diffeomorphism. Extends to semi-supervised settings without ground-truth data.
...
TL;DR: A novel reconstruction-free online framework for memory-efficient, real-time 3D object detection using pre-trained models and multi-view fusion.


<details>
  <summary>Details</summary>
Motivation: Address computational overhead and memory constraints in existing dense point cloud reconstruction methods for real-time deployment in autonomous driving and embodied AI.

Method: Leverages Cubify Anything and CLIP for single-view 3D detection, with association and optimization modules for multi-view fusion using 3D NMS and particle filtering.
...
Conclusion: The reconstruction-free paradigm offers efficient, scalable 3D detection with strong generalization for diverse scenarios.
...
Conclusion: HOIDiNi successfully generates realistic, physically valid HOI with precise control, advancing text-driven synthesis.
...
TL;DR: The paper introduces a new benchmark in the Habitat simulator to evaluate long-range embodied tasks, addressing limitations of current vision-language models in handling long-term memory and embodied reasoning.


<details>
  <summary>Details</summary>
Motivation: Current vision-language models struggle with long-term memory and embodied reasoning, limiting their real-world robotics applications. Existing benchmarks lack focus on embodied challenges like object manipulation and navigation.

Method: A new benchmark is developed for the Habitat simulator, featuring 60 tasks requiring memory and contextual awareness. Baselines integrate state-of-the-art VLMs with navigation policies.

Result: The benchmark enables scalable evaluation of memory and reasoning in embodied agents, highlighting areas for improvement in current VLMs.

Conclusion: The work provides a tool to assess and improve memory-based capabilities in embodied agents, advancing their application in real-world robotics.
...
Method: Systematically study MLLMs using controlled image degradations and stylistic shifts. Introduce VQ-TTT, a module that adapts image quality dynamically.

Result: VQ-TTT improves accuracy across MLLMs and datasets without extra data or models.

Conclusion: Adaptive image quality, not universally clean images, is key for MLLMs, redefining visual input standards.
...
TL;DR: ViMaR is a two-stage inference framework for VLMs that improves efficiency and output fidelity by combining a value model with margin-aware rewards, achieving faster and more reliable captions.


<details>
  <summary>Details</summary>
Motivation: Existing inference-time search methods for VLMs are inefficient and prone to low-confidence generations, leading to hallucinations.
...
Result: ViMaR generates more reliable, accurate, and detailed captions with a 4x speedup and shows cross-model generalization.

Conclusion: ViMaR is scalable, transferable, and enhances VLM performance when used for self-training.
...
<details>
  <summary>Details</summary>
Motivation: Overcome limitations of existing relighting methods, which struggle with data scarcity, error accumulation, and realism in complex lighting/material scenarios.

Method: Jointly estimates albedo and synthesizes relit outputs in one pass using video diffusion models, leveraging synthetic and real-world data.

Result: Achieves superior generalization, visual fidelity, and temporal consistency compared to prior methods.

Conclusion: The proposed approach effectively addresses relighting challenges, offering realistic and consistent results across diverse scenes.
...
<details>
  <summary>Details</summary>
Motivation: Existing video datasets lack diversity, duration, and annotations for world exploration, limiting their utility.

Method: The authors collect and annotate over 5,000 hours of first-person and drone videos from 750 cities, using a custom toolbox for processing.

Result: The dataset is validated for quality, and a subset is used to train YUME, an interactive video exploration model.

Conclusion: Sekai is expected to advance video generation and world exploration research, enabling new applications.
...
TL;DR: ECAD is a genetic algorithm for accelerating diffusion models by learning efficient caching schedules, offering speedups and quality-latency trade-offs without modifying model parameters.


<details>
  <summary>Details</summary>
Motivation: Diffusion models are slow and computationally expensive; existing caching methods rely on rigid heuristics, limiting acceleration and generalization.

Method: ECAD uses a genetic algorithm to learn per-model caching schedules, forming a Pareto frontier from calibration prompts.

Result: ECAD achieves significant speedups (e.g., 2.58x on PixArt-alpha) and outperforms prior methods (e.g., 4.47 COCO FID improvement).

Conclusion: ECAD is scalable, generalizable, and effective for accelerating diffusion models across diverse benchmarks and architectures.
...
TL;DR: CALM integrates symbolic reasoning with neural networks for context-sensitive decisions using multi-modal data, outperforming classical logic and LLMs in tasks.


<details>
  <summary>Details</summary>
Motivation: Classic logic lacks nuance in human decision-making, while neural networks lack interpretability. CALM bridges this gap to create robust AI systems.

Method: CALM uses domain trees for predicates, refining analog truth values with neural networks and symbolic reasoning for constraint satisfaction.
...
Conclusion: CALM combines logic precision with neural multi-modal processing, paving the way for interpretable and robust AI systems.
...
TL;DR: MEAL is the first benchmark for continual multi-agent reinforcement learning (CMARL), addressing gaps in current CL benchmarks by using GPU acceleration for longer task sequences.


<details>
  <summary>Details</summary>
Motivation: Existing CL benchmarks are CPU-based, causing computational bottlenecks and limiting task sequences. The intersection of CL and cooperative multi-agent RL is underexplored.

Method: MEAL leverages JAX for GPU acceleration, enabling learning across 100 tasks on a desktop PC. It evaluates CL and MARL methods in complex settings.

Result: Naive CL and MARL combinations work in simple environments but fail in complex ones. Ablation studies highlight key architectural and algorithmic features for CMARL.

Conclusion: MEAL provides a scalable benchmark for CMARL, identifying critical features for success in complex cooperative settings.
...
TL;DR: T-PPO improves PPO efficiency for training reasoning LLMs by optimizing policy updates and response generation, achieving 2.5x faster training without performance loss.


<details>
  <summary>Details</summary>
Motivation: PPO's inefficiency in long-response generation due to low hardware utilization and synchronization delays motivates the need for a more efficient method like T-PPO.
...
Result: T-PPO achieves up to 2.5x training efficiency improvement and outperforms competitors on the AIME 2024 benchmark.

Conclusion: T-PPO is a scalable and efficient alternative to PPO for training reasoning LLMs, addressing hardware underutilization and synchronization bottlenecks.
...
Method: HeurAgenix uses a two-stage approach: (1) evolving heuristics by comparing seed and high-quality solutions, and (2) dynamically selecting the best heuristic for each problem state, guided by LLMs. A dual-reward mechanism fine-tunes the selector.

Result: HeurAgenix outperforms existing LLM-based hyper-heuristics and matches or exceeds specialized solvers in canonical benchmarks.

Conclusion: HeurAgenix demonstrates the potential of LLMs in automating heuristic design and selection for combinatorial optimization, offering flexibility and robustness.
...
<details>
  <summary>Details</summary>
Motivation: The rapid growth of LEO satellites has improved EO missions, but autonomous coordination remains a challenge due to real-time demands and traditional optimization limitations.

Method: The study models single-satellite operations and extends to multi-satellite constellations using MARL frameworks (PPO, IPPO, MAPPO, HAPPO), evaluating performance in a near-realistic simulation.

Result: MARL effectively balances imaging and resource management, handling non-stationarity and reward interdependency in decentralized coordination.

Conclusion: The findings provide a foundation for autonomous satellite operations and practical guidelines for improving policy learning in EO missions.
...
TL;DR: The paper proposes a cooperative MEC framework using UAVs and vessels to address computation offloading and resource allocation challenges in MIoT, leveraging Lyapunov optimization and a heterogeneous-agent soft actor-critic for uncertain tasks.


<details>
  <summary>Details</summary>
Motivation: The rapid growth of MIoT demands efficient computation offloading and resource allocation, but uncertain maritime tasks pose significant challenges.

Method: A cooperative MEC framework is introduced, combining Lyapunov optimization for task unpredictability and a Markov game approach with a heterogeneous-agent soft actor-critic for solving the problem.

Result: Simulations confirm the framework's effectiveness in optimizing execution time and handling uncertain MIoT tasks.

Conclusion: The proposed solution successfully addresses computation offloading and resource allocation in MIoT through UAV-vessel cooperation and advanced optimization techniques.
...
<details>
  <summary>Details</summary>
Motivation: Existing navigation methods process historical observations without considering internal causal structures, limiting performance. The paper addresses this gap by analyzing navigation tasks through causality.
...
Result: Empirical evaluations show CAN consistently outperforms baselines across tasks and environments, with gains attributed to the Causal Understanding Module.

Conclusion: CAN generalizes effectively in Reinforcement and Supervised Learning settings without added computational cost, demonstrating the value of causal modeling in navigation tasks.
...
Method: Design and implementation of an LPA combining LLMs with planning capabilities and external tool use.

Result: The LPA effectively processes queries, retrieves data, and generates human-readable responses, proving reliable for FA tasks.

Conclusion: The LPA enhances FA workflows by autonomously handling complex tasks, demonstrating practical utility.
...
TL;DR: A framework for constructing natural language state representations for LLM agents in repeated multi-agent games, highlighting the impact of state representation on behavior and comparability between studies.


<details>
  <summary>Details</summary>
Motivation: Address the ad hoc approaches in encoding game history for LLM agents, which obscure the impact of state representation and limit study comparability.

Method: Characterize state representation methods along three axes: action informativeness, reward informativeness, and prompting style (natural language compression). Apply this to a dynamic selfish routing game.

Result: Summarized history, regret information, and limited action details lead to behavior closer to game theory equilibrium, while other representations cause deviations or instability.

Conclusion: State representation significantly influences LLM agent behavior, with specific representations aligning better with theoretical predictions and stability.
...
TL;DR: The paper highlights the need for integrating AI policy and ethics into CS curricula, introduces an AI Policy Module, and evaluates its impact on students' attitudes and confidence.


<details>
  <summary>Details</summary>
Motivation: Current CS curricula lack preparation for AI practitioners to address ethical and policy challenges in AI development.

Method: Developed and piloted an AI Policy Module, including a technical assignment on AI regulation, and assessed student attitudes via surveys.

Result: Students showed increased concern about AI ethics and greater confidence in discussing AI regulation post-module.

Conclusion: The AI Policy Module effectively prepares students for ethical and policy challenges in AI, with the AI Regulation Assignment being a key tool.
...
TL;DR: The paper addresses overthinking in large reasoning models (LRMs) and proposes two methods—Efficiency Steering and Self-Rewarded Efficiency RL—to enhance efficiency without compromising accuracy.


<details>
  <summary>Details</summary>
Motivation: LRMs exhibit overthinking, generating verbose content that increases inference costs. The study aims to uncover inefficiency origins and improve model efficiency.

Method: Two methods are introduced: Efficiency Steering (activation steering) and Self-Rewarded Efficiency RL (reinforcement learning for brevity and accuracy).

Result: Experiments on seven LRM backbones show reduced reasoning length while maintaining or improving task performance.
...
Method: SwarmAgentic uses language-driven exploration and PSO-inspired feedback-guided updates to evolve candidate systems.

Result: Outperforms baselines, achieving +261.8% improvement on TravelPlanner, demonstrating effectiveness in unconstrained tasks.

Conclusion: SwarmAgentic advances scalable, autonomous agentic system design by integrating swarm intelligence with automated multi-agent generation.
...
TL;DR: The paper introduces Embodied Web Agents, a new AI paradigm combining physical embodiment and web-scale reasoning, with a benchmark for tasks requiring both.
...
Method: Developed a unified simulation platform (Embodied Web Agents task environments) and benchmark for cross-domain tasks like cooking and navigation.

Result: Revealed performance gaps between state-of-the-art AI and humans, highlighting challenges and opportunities.

Conclusion: The work establishes a foundation for AI agents that bridge embodiment and web-scale reasoning, with publicly available resources.
...
TL;DR: A manually annotated corpus for Adverse Event (AE) extraction from elderly patients' discharge summaries is presented, addressing underrepresented populations and complex annotation challenges.
...
Method: The dataset includes 14 clinically significant AEs with contextual attributes. Multiple models (e.g., BERT-cased) were evaluated across fine-grained, coarse-grained, and negation-included granularities using FlairNLP.

Result: Transformer models perform well on coarse-grained extraction (F1 = 0.943) but struggle with fine-grained tasks (F1 = 0.675), especially for rare events and complex attributes.

Conclusion: The dataset, developed in a Trusted Research Environment, highlights challenges in AE extraction and serves as a benchmark for future research and cross-dataset generalization.
...
<details>
  <summary>Details</summary>
Motivation: Autoregressive models for structured NLP tasks often produce low-quality outputs during constrained decoding at test time due to unawareness of constraints during training.

Method: BoostCD uses a two-phase approach: Phase 1 generates weak predictions from constrained and unconstrained decoding; Phase 2 combines these predictions using a learned boosted model.

Result: BoostCD, applied to closed information extraction (BoostIE), outperforms prior methods in and out of distribution, addressing common errors.

Conclusion: BoostCD effectively improves structured NLP task performance by exploiting complementary errors between constrained and unconstrained decoding.
...
Method: CrEst uses semantic coherence among credible documents for automated credibility estimation and integrates it into LLM inference via black-box and white-box strategies.

Result: CrEst outperforms baselines with up to 26.86% accuracy and 3.49% F1 score improvements, even in high-noise conditions.
...
<details>
  <summary>Details</summary>
Motivation: Existing benchmarks for multi-document reasoning are scarce due to annotation costs, despite its relevance to LLM capabilities.

Method: MDBench uses a novel synthetic generation process, leveraging LLM-assisted edits on structured seed knowledge to create document sets and QA examples.

Result: MDBench poses significant challenges for current LLMs and prompting techniques, even with short document sets.
...
TL;DR: The study explores LLMs for diabetes prediction using PIDD, comparing six LLMs (including open-source and proprietary) with traditional ML models. Proprietary LLMs like GPT-4o and Gemma-2-27B outperform others, but challenges like prompt sensitivity remain.


<details>
  <summary>Details</summary>
Motivation: To investigate the untapped potential of LLMs for structured numerical data in diabetes prediction, comparing them with traditional ML methods.
...
Result: Proprietary LLMs (GPT-4o, Gemma-2-27B) perform best, with Gemma-2-27B surpassing traditional ML in F1-score. Performance varies with prompting strategies.
...
<details>
  <summary>Details</summary>
Motivation: To explore LLMs' capability for reversible embeddings and their potential applications in retrieval, compression, and controlled text generation.

Method: Introduce a memory token whose embedding is optimized for fixed sequences; evaluate across languages (English, Spanish), sequence lengths (~240 tokens), and model scales (100M to 8B parameters).

Result: Llama 3.1 8B successfully reconstructs all tested sequences.

Conclusion: The findings reveal LLMs' unique capability for reversible embeddings, suggesting practical uses in memory-based tasks.
...
TL;DR: The paper uses NLP to identify social isolation and loneliness in suicide narratives, revealing higher risks for men, gay individuals, and divorced persons.


<details>
  <summary>Details</summary>
Motivation: Social isolation and loneliness are rising and linked to suicide, but aren't tracked in NVDRS. NLP can help identify these factors.
...
Result: Identified 1,198 cases of chronic social isolation. Higher odds for men, gay individuals, and divorced persons. Found predictors like divorce, custody loss, and eviction.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods for evaluating long-form generation often miss key aspects like coherence and relevance, or are biased by pretraining data, creating a gap in reliable evaluation.
...
Conclusion: PrefBERT offers a reliable and human-aligned solution for evaluating and improving long-form generation.
...
TL;DR: The paper explores how learning-time choices in knowledge encoding affect the effectiveness of unlearning in large language models (LLMs), finding that paraphrased descriptions improve unlearning and that unlearning from chunks of text is difficult.


<details>
  <summary>Details</summary>
Motivation: To address the need for reliable post-hoc unlearning in LLMs due to privacy, outdated, or harmful content.

Method: Empirical investigation of learning-time knowledge encoding's impact on unlearning effectiveness.
...
TL;DR: A Discourse-aware Clarification Module (DCM) and Contribution-aware Preference Optimization (CPO) are proposed to improve dialogue discourse parsing by resolving ambiguities and reducing errors.


<details>
  <summary>Details</summary>
Motivation: Ambiguities in dialogues due to linguistic features like omission and idiom obscure discourse relations, challenging parsers.

Method: DCM uses clarification type and discourse goal reasoning, while CPO optimizes DCM's contributions to reduce errors.

Result: Experiments on STAC and Molweni datasets show the approach outperforms SOTA baselines.

Conclusion: The proposed method effectively resolves ambiguities and enhances parsing performance.
...
TL;DR: The paper introduces CKD-EHR, a framework using knowledge distillation to enhance disease prediction from EHR data, improving accuracy and efficiency.
...
Method: CKD-EHR fine-tunes Qwen2.5-7B as a teacher model, distills knowledge via multi-granularity attention, and transfers it to a lightweight BERT student model.

Result: On MIMIC-III, CKD-EHR boosts diagnostic accuracy by 9%, F1-score by 27%, and speeds up inference by 22.2x.

Conclusion: CKD-EHR improves clinical resource efficiency, accuracy, and timeliness, offering a practical solution for EHR-based disease prediction.
...
TL;DR: The paper proposes a two-stage framework for Open-domain Dialogue (OD) generation, decomposing it into Multi-Response Generation (MRG) and Preference-based Selection (PS) to enhance diversity and quality. It introduces o2mDial, a corpus for MRG and PS, and new evaluation metrics, showing improved performance in smaller LLMs.


<details>
  <summary>Details</summary>
Motivation: Most LLM-based dialogue agents do not explicitly model the one-to-many (o2m) property of OD, which limits response diversity. This work aims to address this gap by explicitly modeling o2m.

Method: Decompose OD generation into MRG (generating diverse responses) and PS (selecting based on preference). Introduce o2mDial corpus and propose in-context learning, instruction-tuning, and evaluation metrics for MRG and PS.

Result: The framework improves response diversity and quality in smaller LLMs, achieving up to 90% better performance, closing the gap with larger models.

Conclusion: Explicitly modeling the o2m property in OD generation enhances diversity and coherence, making smaller LLMs more competitive with larger ones.
...
<details>
  <summary>Details</summary>
Motivation: To design a tokenizer that reduces token fertility (number of tokens) while maintaining model performance, specifically for the Korean language.

Method: Uses rule-based pre-tokenization aligned with Korean linguistic structure, a seed vocabulary of linguistic units, and a branching entropy-based selection algorithm to increase token length.

Result: Reduces fertility by 10% (improves inference speed by 10%) compared to BPE, with no performance drop in downstream tasks.
...
TL;DR: The paper investigates memory mechanisms in state-space language models, focusing on primacy and recency effects, and identifies three key mechanisms driving memory retention and forgetting.
...
Result: A U-shaped accuracy profile is observed, with strong performance at sequence start and end. Three mechanisms are identified: sparse channel encoding for long-term memory, delta-modulated recurrence for short-term memory, and dynamic modulation by semantic regularity.

Conclusion: The study reveals distinct mechanisms for memory retention and forgetting in state-space models, validated on large-scale Mamba-based models.
...
TL;DR: The study evaluates LLMs for SDG-related text classification, comparing proprietary and open-source models. It finds optimized smaller models can match larger ones like GPT.


<details>
  <summary>Details</summary>
Motivation: Tracking SDG progress is challenging due to data complexity, requiring automated text analysis tools like LLMs.
...
Conclusion: Optimized smaller LLMs are viable for SDG text classification, reducing reliance on larger models.
...
TL;DR: ProtoReasoning enhances LLMs' reasoning via abstract prototypes, improving performance across tasks like logic, planning, and math.
...
Method: Proposes ProtoReasoning, a framework with automated prototype construction, verification via Prolog/PDDL, and scalable problem synthesis.

Result: Achieves improvements: 4.7% (logic), 6.3% (planning), 4.0% (general reasoning), 1.0% (math). Confirms better generalization with prototypes.

Conclusion: Reasoning prototypes are foundational for generalizable reasoning in LLMs, validated by performance gains and ablation studies.
...
TL;DR: MinosEval is a novel method for evaluating open-ended QA, distinguishing factoid and non-factoid questions and using tailored strategies for each, outperforming traditional metrics.


<details>
  <summary>Details</summary>
Motivation: Existing metrics like ROUGE and BERTScore fail to capture semantic nuances in open-ended QA, and current LLM-based methods lack interpretability and adaptability.
...
Result: Experiments show MinosEval aligns better with human judgments and provides more interpretable results than existing methods.

Conclusion: MinosEval addresses limitations of current evaluation methods, offering a more refined and interpretable approach for open-ended QA.
...
TL;DR: The paper evaluates language models' ability to handle Basque and Spanish linguistic variations, finding performance drops, especially in Basque, due to linguistic diversity, not lexical overlap.


<details>
  <summary>Details</summary>
Motivation: To assess how well current language technologies understand Basque and Spanish language varieties, focusing on linguistic variation.

Method: Uses Natural Language Inference (NLI) with a new parallel dataset in Basque and Spanish. Tests crosslingual and in-context learning with encoder-only and decoder-based LLMs.

Result: Performance declines with linguistic variation, notably in Basque. Encoder-only models struggle with Western Basque, aligning with linguistic theory.

Conclusion: Linguistic variation, not lexical overlap, challenges models, especially for peripheral dialects like Western Basque. Data and code are publicly shared.
...
TL;DR: The paper introduces Graph RAG, a framework combining chain-of-thought prompting, self-instruction generation, and process supervision to automate historical knowledge extraction with minimal manual effort. It improves model alignment with historical knowledge and reduces hallucinations.
...
Method: Proposes Graph RAG framework with chain-of-thought prompting, self-instruction generation, and process supervision. Uses a collaborative mechanism between knowledge graphs and retrieval-augmented generation.

Result: Domain-specific model Xunzi-Qwen1.5-14B achieves F1=0.68 in relation extraction. GraphRAG improves F1 by 11% on C-CLUE dataset, reducing hallucinations and enhancing interpretability.
...
TL;DR: TopClustRAG is a hybrid RAG system combining sparse/dense retrieval and K-Means clustering for diverse, relevant answers, ranking 2nd in faithfulness and 7th in correctness.


<details>
  <summary>Details</summary>
Motivation: To enhance answer diversity, relevance, and faithfulness in large-scale question answering by leveraging clustering and prompt aggregation.

Method: Uses hybrid retrieval (sparse/dense indices), K-Means clustering, cluster-specific prompts for LLM, and multi-stage filtering/reranking.
...
TL;DR: Thunder-DeID is a proposed framework for de-identifying court judgments in South Korea, addressing legal and technical challenges with a DNN-based pipeline and annotated dataset.


<details>
  <summary>Details</summary>
Motivation: Current de-identification processes in South Korea are inadequate for large-scale court judgments due to vague legal definitions and technical limitations.

Method: The framework includes (i) a Korean legal dataset with annotations, (ii) systematic PII categorization, and (iii) a DNN-based de-identification pipeline.

Result: The model achieves state-of-the-art performance in de-identifying court judgments.

Conclusion: Thunder-DeID effectively balances open justice and data protection, offering a scalable legal-compliant solution.
...
TL;DR: The paper surveys LLM applications in clinical trial-patient matching, highlighting their potential but noting limitations like proprietary models and weak benchmarks.
...
Method: Analyzes trial-patient matching, contextualizes LLM-based approaches, and critically examines benchmarks, methods, and evaluation frameworks.

Result: Identifies challenges in adopting LLM technologies in clinical research and suggests future directions.

Conclusion: LLMs hold promise for trial-patient matching but require better benchmarks and open models for broader adoption.
...
<details>
  <summary>Details</summary>
Motivation: Addressing poor performance of low-resource languages in LID due to class imbalance and bias, often limited to single-domain data.
...
TL;DR: DeVisE framework evaluates LLMs' clinical understanding using ICU discharge notes with controlled counterfactuals, revealing differences in reasoning between zero-shot and fine-tuned models.


<details>
  <summary>Details</summary>
Motivation: Current evaluation methods for LLMs in clinical decision support lack distinction between genuine medical reasoning and superficial patterns.

Method: DeVisE uses ICU discharge notes from MIMIC-IV, generating raw and synthetic versions with counterfactuals for demographics and vital signs. Five LLMs are evaluated under zero-shot and fine-tuned settings.
...
<details>
  <summary>Details</summary>
Motivation: To address the lack of tools for assessing language models' comprehension of local socio-cultural contexts, particularly in India.
...
Result: Evaluation showed significant disparities in models' ability to handle culturally nuanced queries, especially in region-specific contexts.

Conclusion: SANSKRITI sets a new standard for improving cultural understanding in language models.
...
TL;DR: COSMMIC is a new multimodal, multilingual dataset for Indian languages, integrating text, images, and user comments to enhance summarization. It evaluates four configurations using advanced models like LLama3 and GPT-4.
...
Method: Introduces COSMMIC, a dataset with 4,959 article-image pairs and 24,484 comments. Tests summarization across four configurations (text-only, text+comments, text+images, all combined) using models like LLama3 and GPT-4. Includes comment and image classifiers for noise filtering and insight extraction.

Result: The dataset uniquely combines text, images, and user feedback, advancing NLP research for Indian languages.

Conclusion: COSMMIC bridges gaps in Indian language resources, fostering inclusivity and enhancing summarization techniques.
...
TL;DR: The paper introduces Targeted Lexical Injection (TLI), a fine-tuning method to improve lexical alignment in low-resource languages like Swahili for LLMs, showing significant improvements in cross-lingual word pair similarity.


<details>
  <summary>Details</summary>
Motivation: Address the performance gap of LLMs in low-resource languages due to data scarcity and underrepresentation, focusing on improving cross-lingual lexical alignment.

Method: Uses Targeted Lexical Injection (TLI) with Low-Rank Adaptation (LoRA) and contrastive learning to fine-tune embeddings from an optimal early layer identified in the model.

Result: TLI improves average cosine similarity for trained Swahili-English word pairs by 28.08% and generalizes well to unseen word pairs (28.32% improvement).

Conclusion: TLI effectively enhances lexical alignment in LLMs for low-resource languages, offering a parameter-efficient solution.
...
Result: The framework and methods reveal nuanced failure modes, improve interpretability, and enhance model robustness in GUI interactions.

Conclusion: The proposed solutions provide actionable insights, improving the reliability and performance of MLLMs in GUI agent tasks.
...
TL;DR: AgentGroupChat-V2 is a novel multi-agent framework addressing challenges in architecture, generalizability, and performance with innovations like parallel processing, adaptive collaboration, and efficient problem decomposition, achieving superior results in complex tasks.
...
Method: Introduces three innovations: (1) divide-and-conquer parallel architecture, (2) adaptive collaboration engine, (3) agent organization optimization.

Result: Achieves 91.50% accuracy on GSM8K, 30.4% on AIME, and 79.20% pass@1 on HumanEval, with performance improving with task difficulty.

Conclusion: AgentGroupChat-V2 is a comprehensive solution for efficient, general-purpose LLM multi-agent systems, excelling in complex reasoning.
...
<details>
  <summary>Details</summary>
Motivation: To clarify whether LLMs' high accuracy stems from true reasoning or training data memorization.
...
Conclusion: The framework highlights LLMs' limitations in true reasoning and suggests further research to improve hierarchical reasoning skills.
...
TL;DR: CINGS is a post-training method that improves grounding in LLMs by training with context prepended to responses, masking context in loss computation, and outperforms other methods in grounding without degrading performance.


<details>
  <summary>Details</summary>
Motivation: To address the issue of LLMs not reliably grounding responses in provided external context, despite its importance for reducing hallucination and supplementing knowledge.

Method: Proposes CINGS, a post-training supervision where models are trained with relevant context prepended to responses, but loss is computed only over response tokens (context masked).

Result: CINGS-trained models show stronger grounding in textual and visual domains, outperform other methods on 11 datasets, reduce hallucinations in vision-language tasks, and maintain factual consistency.

Conclusion: CINGS effectively shifts model behavior to rely more on external context, improving grounding without harming general performance.
...
Result: SPARE improves reasoning performance and efficiency, achieving competitive results with 2.6x greater efficiency.

Conclusion: SPARE is effective for process supervision and offers significant efficiency gains, with publicly released code for reproducibility.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods for hyperbole and metaphor detection focus on superficial features, missing deeper associations and implicit emotions. This limits their effectiveness.

Method: EmoBi combines emotion analysis, domain mapping, and bidirectional dynamic interaction to detect hyperbole and metaphor. A verification mechanism ensures reliability.

Result: EmoBi outperforms baselines, with F1 scores increasing by 28.1% for hyperbole and 23.1% for metaphor on specific datasets.

Conclusion: The framework is effective and has potential for advancing hyperbole and metaphor detection in NLP.
...
TL;DR: The paper explores using reinforcement learning (RL) and internal reasoning to improve grounding in LLMs, achieving better performance in generating accurate, well-cited responses and handling unanswerable queries.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of generating grounded and trustworthy responses in LLMs, particularly issues like missing answers, incorrect citations, or unnecessary refusals.

Method: Uses GRPO (Group Relative Policy Optimization) with verifiable outcome-based rewards for training, focusing on answer correctness, citation sufficiency, and refusal quality. Also employs a two-stage training setup and GPT-4 distillation.

Result: Reasoning-augmented models outperform instruction-only variants, especially in unanswerable queries and well-cited responses. Two-stage training and GPT-4 distillation further enhance performance.

Conclusion: Combining reasoning, stage-wise optimization, and outcome-driven RL improves the verifiability and reliability of LLMs.
...
TL;DR: RATTENTION, a local-global attention model, improves efficiency and performance by integrating linear attention for out-of-window tokens, achieving full-attention performance with a smaller window size (512).


<details>
  <summary>Details</summary>
Motivation: Address the limitation of local attention ignoring out-of-window tokens and improve the Pareto tradeoff between performance and efficiency.

Method: Proposes RATTENTION, combining local attention with a linear attention mechanism to capture out-of-window tokens.

Result: RATTENTION matches full-attention performance with a 512 window size and enhances long-context performance without compromising training efficiency.

Conclusion: RATTENTION shifts the Pareto frontier, offering better efficiency and performance in short-context regimes while maintaining training speed.
...
TL;DR: A method to approximate training data from model weights using gradient-based selection from a public corpus, improving model performance.


<details>
  <summary>Details</summary>
Motivation: Address the challenge of closed training data in modern language models by approximating it from model weights.

Method: Gradient-based approach to select high-matching data from a public corpus, tested on classification and supervised-finetuning tasks.

Result: Improved performance from 65% to 80% on AG News and reduced perplexity from 3.3 to 2.3 on MSMARCO, nearing expert benchmarks.

Conclusion: The method effectively recovers useful training data from model weights, enhancing model performance without access to original data.
...
<details>
  <summary>Details</summary>
Motivation: LLMs in voice chat cause latency, especially on consumer hardware, due to slow first-sentence generation for TTS.

Method: Proposes Predictive Generation (PredGen), using speculative decoding to generate responses during user speech.

Result: Simulations show ~2x latency reduction with negligible extra computation.

Conclusion: PredGen effectively addresses LLM-TTS latency, enhancing real-time voice chat experiences.
...
TL;DR: The paper introduces the Gender Inclusivity Fairness Index (GIFI) to evaluate gender fairness in LLMs, revealing biases and variations across 22 models.


<details>
  <summary>Details</summary>
Motivation: Prior studies focus on binary gender, but this work addresses inclusivity for all genders, emphasizing the need for fairness in LLMs.

Method: Developed GIFI, a multi-level metric, and tested 22 LLMs to assess gender inclusivity and biases.

Result: Found significant variations in gender inclusivity among LLMs, highlighting existing biases.

Conclusion: The study underscores the need for improving LLMs' gender inclusivity and sets a benchmark for future work.
...
Method: Created SciVer with 3,000 expert-annotated examples from 1,113 papers, testing 21 models like Gemini-2.5-Flash.

Result: Models lag behind human experts; RAG and error analysis highlight key limitations.

Conclusion: SciVer provides insights to enhance multimodal scientific reasoning in models.
...
TL;DR: The paper introduces DiscoSG, a task for discourse-level text scene graph parsing, and DiscoSG-Refiner, a method to improve parsing efficiency and accuracy over existing baselines.


<details>
  <summary>Details</summary>
Motivation: Current text scene graph parsers fail to handle multi-sentence descriptions effectively, missing cross-sentence phenomena like coreference, leading to fragmented graphs and poor VLM performance.

Method: The authors propose DiscoSG-Refiner, which uses two small PLMs: one to draft a base graph and another to iteratively refine it, reducing overhead compared to large PLMs like GPT-4.
...
Conclusion: DiscoSG-Refiner offers a scalable and efficient solution for discourse-level scene graph parsing, balancing performance and computational cost.
...
<details>
  <summary>Details</summary>
Motivation: Existing benchmarks lack emphasis on complex reasoning over multi-modal documents, necessitating a new evaluation framework.

Method: Created WikiMixQA with 1,000 MCQs from 4,000 Wikipedia pages, testing 12 vision-language models on cross-modal reasoning.

Result: Proprietary models (e.g., GPT-4-o) achieve ~70% accuracy with direct context but drop below 50% with long-context retrieval. Open-source models max at 27%.

Conclusion: WikiMixQA highlights challenges in long-context multi-modal reasoning and serves as a key benchmark for advancing document understanding.
...
Method: Generative models produce Portuguese MCQs aligned with curriculum and difficulty levels, evaluated via expert review and psychometric analysis.
...
Conclusion: Generative models show promise for MCQ automation but require improvements in clarity and distractor quality for real-world use.
...
TL;DR: The paper studies regret in large language models, proposing methods to identify and analyze regret expressions and neurons, enhancing model reliability.


<details>
  <summary>Details</summary>
Motivation: Understanding regret mechanisms in models improves reliability and reveals neural network cognition.

Method: Proposes workflow for regret dataset, S-CDI for optimal layers, RDS/GIC for neuron analysis.

Result: Identified optimal regret layer, M-shaped decoupling pattern, and categorized neurons.

Conclusion: The methods enhance understanding of regret in models, aiding reliability and cognition studies.
...
Result: Cross-cultural differences arise from both literal meaning variations and differing emphasis on utterance cost, not just semantics or politeness norms.
...
TL;DR: The paper introduces Ordered CommonGen, a benchmark to evaluate LLMs' ability to follow concept order instructions and generalize compositionally. It found biases in LLMs leading to low-diversity outputs and only 75% ordered coverage even in the best-performing model.


<details>
  <summary>Details</summary>
Motivation: To assess LLMs' instruction-following and compositional generalization abilities when generating sentences with ordered concepts.

Method: Proposed Ordered CommonGen benchmark, measuring ordered coverage of concepts in generated sentences. Evaluated 36 LLMs.

Result: LLMs showed biases in concept order, leading to low-diversity outputs. The best model achieved only ~75% ordered coverage.
...
Conclusion: Lightweight character n-gram methods can achieve state-of-the-art accuracy for Romanian authorship attribution, even rivaling complex methods.
...
TL;DR: CC-Learn is a reinforcement learning framework that improves LLM reasoning consistency by training on cohorts of similar questions, enhancing accuracy and stability.


<details>
  <summary>Details</summary>
Motivation: Large language models struggle with consistent and robust reasoning, prompting the need for methods like CC-Learn to improve reliability.

Method: CC-Learn uses a composite objective (cohort accuracy, retrieval bonus, rejection penalty) in reinforcement learning to enforce uniform reasoning patterns across similar questions.

Result: Experiments on benchmarks (ARC-Challenge, StrategyQA) show CC-Learn improves accuracy and reasoning stability over baselines.
...
TL;DR: Privacy leakage in reasoning traces of large models is significant, as sensitive data can be extracted or leaked, especially with increased reasoning steps.
...
Result: Increased reasoning steps amplify privacy leakage, creating a trade-off between utility and privacy.

Conclusion: Safety efforts must address the model's internal reasoning, not just outputs, to mitigate privacy risks.
...
TL;DR: The paper evaluates 21 MT systems for their ability to handle gender ambiguity in translations, finding a lack of gender-neutral translations but noting a few exceptions.
...
Method: Assessed 21 MT systems across three translation directions, categorizing observed gender-neutral strategies and examining binary gender stereotypes.

Result: Most MT systems failed to provide gender-neutral translations, though a few used specific strategies depending on the target language.

Conclusion: The study highlights the need for improved gender-inclusive MT systems, with some promising but limited exceptions.
...
TL;DR: GenRecal is a general-purpose distillation framework for VLMs that addresses architectural diversity, enabling efficient knowledge transfer from large to smaller models.


<details>
  <summary>Details</summary>
Motivation: Deploying large VLMs on resource-constrained devices is challenging due to computational demands, and existing methods are limited by VLM diversity.
...
Conclusion: GenRecal provides an effective solution for distilling knowledge across diverse VLM architectures, enhancing efficiency without sacrificing performance.
...
TL;DR: PhantomHunter is a detector for text from privately-tuned LLMs, outperforming existing methods with 96% F1 scores.


<details>
  <summary>Details</summary>
Motivation: The rise of privately-tuned LLMs has degraded existing detectors' performance, necessitating a specialized solution.

Method: PhantomHunter uses a family-aware learning framework to detect shared traits across LLM families.
...
<details>
  <summary>Details</summary>
Motivation: Clinical decision-making is complex and often biased. Current LLM usage lacks interaction depth, missing real-world medical complexities.

Method: Proposed MedSyn framework facilitates multi-step, interactive dialogues between physicians and LLMs, allowing mutual refinement of decisions.
...
TL;DR: The paper introduces a 2D parallel tempering algorithm (2D-PT) to improve sampling in constrained Ising problems, eliminating the need for penalty strength tuning and achieving faster mixing.
...
Method: Extends parallel tempering (PT) by adding a second dimension of replicas interpolating penalty strengths, ensuring constraint satisfaction in final replicas.
...
Conclusion: 2D-PT broadly improves constrained Ising problem sampling and is deployable on existing Ising machines.
...
TL;DR: The paper compares two AI systems: DeepSeek-V3 (a large-scale LLM) and NetraAI (a framework for stable, interpretable analysis of clinical data). NetraAI combines dynamical systems, information geometry, and evolutionary algorithms to identify predictive patient subgroups, aided by an LLM Strategist for meta-evolutionary guidance. Case studies show significant improvements in classification accuracy.


<details>
  <summary>Details</summary>
Motivation: To address the need for interpretable and stable AI in clinical settings, especially for small datasets, by combining dynamical systems, information geometry, and evolutionary learning.

Method: NetraAI uses contraction mappings, information geometry, and evolutionary algorithms to identify patient subgroups. An LLM Strategist acts as a meta-evolutionary layer to guide discovery.
...
<details>
  <summary>Details</summary>
Motivation: Overcoming challenges in decoding natural language from EEG, especially for open-vocabulary scenarios, where noise and variability hinder performance.

Method: Integrates EEG with synchronized eye-tracking data for open-vocabulary text generation and sentiment classification.
...
TL;DR: A transfer learning method using a convolutional neural network (ConvNet) is proposed to predict onflow parameters like angle of attack and speed, addressing challenges of sensor faults and data distribution changes.
...
Method: The method involves offline training a ConvNet, freezing most weights, and retraining selected layers for transfer learning. It's tested on steady CFD data for domain and task adaptation.

Result: The approach successfully adapts to changing data distributions, domain extensions, and task updates, but performs poorly with noisy data.

Conclusion: The transfer learning method shows promise for real-time prediction of onflow parameters, though noise handling needs improvement.
...
<details>
  <summary>Details</summary>
Motivation: Existing multimodal approaches neglect visual data in time series forecasting, missing critical physical information like geospatial context in satellite imagery.

Method: PIPE introduces physics-informed positional indexing and variant-frequency positional encoding to embed physical and sequential information into VLMs.
...
Conclusion: PIPE effectively bridges the gap in utilizing visual data for forecasting, demonstrating significant accuracy improvements in climate science applications.
...
<details>
  <summary>Details</summary>
Motivation: Address retrieval challenges in multi-deep storage systems due to lane blockages and heterogeneous item configurations.

Method: Graph-based state representation with GNN for local topology and item attributes, combined with Transformer for global priority assignments.

Result: Outperforms heuristic methods in minimizing retrieval tardiness and adapts to diverse layouts.

Conclusion: The framework effectively optimizes retrieval operations in multi-deep storage systems.
...
<details>
  <summary>Details</summary>
Motivation: The scarcity of comprehensive T1D datasets limits progress in personalized therapy and AI-driven solutions.

Method: AZT1D collects data from 25 T1D patients on AID systems, including CGM, insulin pump data, and lifestyle details over 6-8 weeks.

Result: The dataset provides granular insulin delivery details and supports diverse AI/ML applications for T1D care.

Conclusion: AZT1D enhances research and clinical decision-making by offering rich, naturalistic data for T1D management.
...
<details>
  <summary>Details</summary>
Motivation: Recurring concept drift causes forgetting of learned patterns, reducing prediction accuracy. Existing methods update parameters but may lose knowledge and lack retention mechanisms.

Method: CEP stores forecasters for different concepts, retrieves the nearest forecaster for test samples, and evolves new models for emerging concepts while clearing outdated knowledge.

Result: CEP effectively retains conceptual knowledge and significantly improves prediction accuracy in online forecasting with recurring concepts.
...
TL;DR: Injecting dropout at inference time in Protein Language Models (PLMs) like ESM2 improves zero-shot prediction of protein fitness without retraining.


<details>
  <summary>Details</summary>
Motivation: To enhance zero-shot performance of PLMs on protein fitness prediction without additional training.

Method: Add a dropout layer (0.1 rate) between the featurizer and transformer during inference, averaging outputs like Monte-Carlo dropout.

Result: Improved zero-shot performance on the ProteinGym dataset, even without prior dropout training.

Conclusion: Dropout at inference boosts PLM performance for protein fitness prediction, offering a simple, training-free enhancement.
...
TL;DR: The paper introduces 'Assembly-of-Experts' (AoE), a method to efficiently create capable child models from Mixture-of-Experts parents by interpolating weights, reducing computational costs and enabling straightforward model space exploration.
...
Method: AoE interpolates individual weight tensors from parent models to create child variants, enhancing or suppressing semantic features without fine-tuning.

Result: The DeepSeek R1T 'Chimera' model, combining features of two parent models, achieves R1-level intelligence with 40% fewer output tokens and V3 speed.

Conclusion: AoE enables efficient creation of functional child models with emergent traits, demonstrating compact and orderly reasoning without additional training.
...
<details>
  <summary>Details</summary>
Motivation: To understand the fundamental limits of representational tradeoffs in models, especially how semantic resolution affects generalization and identification.

Method: Theoretical derivation of closed-form expressions for generalization and identification probabilities, extended to noisy and heterogeneous spaces. Validated using a minimal ReLU network and complex models like CNNs and vision-language models.

Result: Reveals a universal Pareto front for generalization-identification tradeoff, a sharp 1/n capacity collapse, and non-monotonic optimal generalization. Empirical results align with theory.

Conclusion: Finite-resolution similarity is a fundamental constraint in deep networks and brains, providing an exact theory for the generalization-identification tradeoff.
...
<details>
  <summary>Details</summary>
Motivation: To improve time series forecasting by addressing computational inefficiencies of Transformers and enhancing generalization and interpretability.
...
<details>
  <summary>Details</summary>
Motivation: To bridge the gap between discrete optimization methods and their continuous-time approximations, particularly focusing on the Heavy-Ball momentum method and its discretization error.
...
Result: Provides a continuous-time model for the Heavy-Ball method with arbitrary-order step size control and identifies implicit regularization in directional smoothness.

Conclusion: The approach offers new theoretical tools for studying optimization methods, with practical implications for deep learning, supported by numerical experiments.
...
TL;DR: PARC is a framework to analyze prompt sensitivity in Vision Language Models (VLMs), revealing VLMs mirror LLM language prompt sensitivity and identifying robust models like InternVL2.


<details>
  <summary>Details</summary>
Motivation: VLMs integrate visual and language modalities, inheriting prompt sensitivity from LLMs. Understanding this sensitivity is crucial for real-world applications.

Method: PARC evaluates prompt sensitivity using plausible variations, a reliability score, and calibration for cross-dataset analysis.

Result: VLMs show sensitivity similar to LLMs, with InternVL2 models being notably robust. Sensitivity may relate to training data.
...
Conclusion: The framework reduces stockouts and excess inventory, highlighting adaptive AI's role in optimizing supply chains.
...
Result: Achieves superior knowledge transfer and performance in continuous control and visual tasks compared to other methods.

Conclusion: The proposed modular neural network effectively balances scalability, plasticity, and performance in continual learning.
...
TL;DR: TRAINCHECK is a framework for detecting and debugging silent errors in deep learning training by inferring and using tailored invariants.
...
Result: TRAINCHECK detected 18 out of 20 reproduced silent errors in one iteration and found 6 unknown bugs in training libraries.

Conclusion: TRAINCHECK effectively addresses silent training errors, proving its utility in real-world scenarios.
...
TL;DR: The paper proposes a semi-supervised $p$-Laplacian regression model to predict body composition variables (ALM, BFP, BMD) using 3D optical images, offering a cost-effective alternative to DXA scans.


<details>
  <summary>Details</summary>
Motivation: DXA scans are expensive and time-consuming; the study aims to provide a cheaper, efficient alternative using biomarkers from 3D images.

Method: A $p$-Laplacian regression model is applied to a dataset of 847 patients, alongside supervised models like SVR, to predict ALM, BFP, and BMD.

Result: The $p$-Laplacian model achieved errors of ~13% (ALM), ~10% (BMD), and ~20% (BFP) with limited training data (10%). Supervised SVR performed better (~8% for ALM/BMD, ~11% for BFP) with more data (80%).

Conclusion: The $p$-Laplacian model is promising for healthcare in data-constrained settings, though supervised methods outperform with sufficient data.
...
TL;DR: Smaller-scale VLMs trained with GRPO and external tools (e.g., zoom) outperform baselines in visual reasoning tasks.
...
Result: Improved performance on VQA tasks due to detailed visual information from tools.

Conclusion: GRPO and tool integration enhance VLM performance in resource-limited settings.
...
<details>
  <summary>Details</summary>
Motivation: MLLMs face deployment challenges due to distributed data and privacy constraints. Federated Learning (FL) is a solution, but existing FL methods are impractical for large-scale MLLMs.
...
Result: FedNano reduces client-side storage by 95% and communication overhead to 0.01% of model parameters, outperforming prior FL baselines.
...
Method: Systematic evaluation of four surrogate models on a hybrid dataset of AlCoCrCuFeMnNiV HEA properties.

Result: DGP with ML-based prior outperforms others in capturing correlations and uncertainty, enhancing predictive accuracy.
...
Method: Uses a BiGRU network for bidirectional temporal feature extraction and a multi-head attention mechanism to focus on critical health indicators.
...
Method: Introduced CACTUS, a tool for AMD stage classification, focusing on explainability and flexibility by integrating genetic, dietary, clinical, and demographic factors.

Result: CACTUS outperforms standard ML models, identifies key features, and provides confidence in results, aiding clinical decision-making.

Conclusion: CACTUS enhances AMD diagnosis by improving classification accuracy and transparency, enabling better clinician feedback and bias mitigation.
...
Method: Introduces GRKneg, improving kernel using negative data without altering OC-SVM optimization. Compares with standard OC-SVM and binary SVM.

Result: GRKneg outperforms standard OC-SVM with RBF kernel and binary SVM when negative samples are scarce.

Conclusion: GRKneg is effective for one-class classification with few negative samples, offering a robust alternative to binary SVM in such cases.
...
TL;DR: Proposes an event-driven online Vertical Federated Learning (VFL) framework to address asynchronous data streaming challenges, incorporating dynamic local regret for stability and efficiency.


<details>
  <summary>Details</summary>
Motivation: Online learning in VFL faces challenges due to asynchronous data streaming and non-intersecting feature sets, overlooked by prior research.

Method: An event-driven framework activates subsets of clients per event, integrating dynamic local regret for non-convex, non-stationary environments.

Result: The framework outperforms existing online VFL in stability, communication, and computation efficiency under non-stationary conditions.

Conclusion: The proposed event-driven online VFL framework effectively addresses asynchronous data challenges, enhancing stability and reducing costs.
...
TL;DR: FedOne optimizes query efficiency in federated black-box prompt learning by activating one client per round, reducing cloud-based LLM service costs.


<details>
  <summary>Details</summary>
Motivation: Previous federated black-box prompt tuning ignored the high query costs of cloud-based LLMs, prompting a need for efficiency improvements.

Method: Proposed FedOne framework, degrading FedAvg to activate one client per round for optimal query efficiency.

Result: Experiments showed significant query efficiency improvements, aligning with theoretical findings.

Conclusion: FedOne effectively enhances query efficiency in federated black-box prompt learning, addressing a critical gap in prior research.
...
<details>
  <summary>Details</summary>
Motivation: Current anomaly detection systems using Autoencoders face challenges with non-standardized separation thresholds, impacting detection performance.
...
Result: The proposed approach aims to enhance the performance of anomaly detection by optimizing the threshold definition.

Conclusion: Automating the threshold definition with machine learning algorithms can improve the effectiveness of anomaly detection systems.
...
TL;DR: The paper identifies and characterizes special structures in neural network loss landscapes, called channels, where loss decreases slowly while certain neuron weights diverge to infinity, forming gated linear units.


<details>
  <summary>Details</summary>
Motivation: To understand the behavior of gradient-based optimizers in neural networks and the emergence of specific structures like gated linear units in the loss landscape.

Method: Analyzes gradient dynamics and geometry of loss landscapes, focusing on channels where weights diverge and neurons form gated linear units.

Result: Gradient flow solvers and related methods often reach these channels, which resemble flat minima but lead to gated linear units.

Conclusion: The study provides insights into quasi-flat regions of loss landscapes and reveals unexpected computational capabilities of fully connected layers.
...
TL;DR: The paper introduces Guru, a curated RL reasoning corpus of 92K examples across six domains, addressing the lack of scalable RL rewards for diverse reasoning tasks. It revisits RL findings for LLM reasoning, showing domain-specific training needs, and presents Guru-7B and Guru-32B models achieving state-of-the-art performance.


<details>
  <summary>Details</summary>
Motivation: To address the limited understanding of RL's broader applicability to general reasoning beyond math and code, and the challenge of scalable RL rewards across diverse domains.

Method: Developed Guru, a corpus with domain-specific reward design, deduplication, and filtering. Evaluated RL training effects across domains and introduced Guru-7B and Guru-32B models.

Result: Guru models outperform baselines by 7.9% and 6.7% on a 17-task suite, showing RL's potential for genuine skill acquisition in less pretrained domains.

Conclusion: RL's effectiveness varies by domain; Guru models demonstrate state-of-the-art performance, highlighting the importance of domain-specific training for general reasoning.
...
<details>
  <summary>Details</summary>
Motivation: Accurate error estimation in unseen test domains is critical for safe ML systems. Prior DIS² methods compete in overlapping regions, limiting reliability.
...
Conclusion: ODD provides a more accurate and reliable method for error estimation in distribution-shifted domains by avoiding competition in overlapping regions.
...
TL;DR: The paper predicts early MS disability progression using sparse clinical and digital data, showing improved accuracy with multimodal transformer models.


<details>
  <summary>Details</summary>
Motivation: Early prediction of MS disability progression is difficult due to disease heterogeneity, but integrating digital data with clinical data could enhance accuracy.
...
Result: A transformer model with unimodal embeddings performed best, but the multimodal transformer consistently outperformed unimodal models, confirming the benefit of combining data types.

Conclusion: Foundation models and multimodal approaches show promise for extracting predictive signals from diverse clinical and digital data, improving prognostics for MS and other complex diseases.
...
<details>
  <summary>Details</summary>
Motivation: To address the challenge of fair outcomes and system performance in multi-agent settings with limited reward information.
...
<details>
  <summary>Details</summary>
Motivation: Effective RL for sepsis treatment requires stable and clinically meaningful state representations from irregular ICU data, a challenge overlooked in prior work.

Method: Uses Controlled Differential Equations (CDE) with training stability methods (early stopping, stabilization) and acuity-aware regularization (SOFA, SAPS-II, OASIS).

Result: Stable CDE representations correlate with clinical scores and enable high-performing RL policies (WIS return > 0.9), while unstable training fails (WIS return ~ 0).
...
TL;DR: SFT-GO improves supervised fine-tuning by grouping tokens based on importance, optimizing with weighted loss, and outperforming baselines.


<details>
  <summary>Details</summary>
Motivation: Existing SFT methods treat all tokens uniformly, ignoring critical task-specific subsets.

Method: SFT-GO groups tokens by importance, using weighted worst-group and cross-entropy loss for optimization.

Result: Models with SFT-GO consistently outperform baselines across benchmarks and datasets.

Conclusion: SFT-GO is robust and effective, improving learning dynamics and performance.
...
<details>
  <summary>Details</summary>
Motivation: Conventional reinforcement learning methods for hyperparameter optimization are too costly in time and computation, limiting widespread use.

Method: SPG extends the base model with temporary modules to generate state-action trajectories in a single forward pass, inspired by DeepSeek-V3.
...
Conclusion: SPG is a practical, efficient solution for hyperparameter optimization, outperforming standard methods and demonstrating industrial applicability.
...
<details>
  <summary>Details</summary>
Motivation: Training highly accurate neural networks is difficult due to non-convex optimization and hyperparameter tuning, with traditional methods often neglecting critical L∞ error.

Method: The approach refines staged training by learning prediction residuals sequentially using additional networks, optimizing loss functions, parameters, and adaptive data sampling.

Result: Validated through benchmark problems, the framework demonstrates improved accuracy.
...
TL;DR: The paper studies hallucinations in LLM-based embodied agents, identifying triggers and model responses, and provides insights for robust planning.


<details>
  <summary>Details</summary>
Motivation: To understand the extent and triggers of hallucinations in LLMs when grounded in physical environments, especially for long-horizon tasks.
...
TL;DR: The paper introduces NCPF, a model combining low-rank tensor algebra and deep learning for accurate traffic data imputation, outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Missing traffic data due to sensor issues and sensing gaps disrupts reliable traffic modeling, necessitating robust solutions.

Method: NCPF integrates CP decomposition with neural networks, using learnable embeddings and hierarchical feature fusion for spatiotemporal data imputation.

Result: NCPF outperforms six baselines across six urban traffic datasets, demonstrating superior performance.
...
Method: Proposes a taxonomy categorizing techniques into behavioral and parametric verification, examining representative methods in each.

Result: Identifies assumptions, strengths, limitations, and vulnerabilities of current verification methods.

Conclusion: Highlights open problems to guide future research toward robust and efficient unlearning verification.
...
TL;DR: Proposes ImprovDML, a decentralized DML framework that balances privacy, Byzantine resilience, and model accuracy using resilient vector consensus and Gaussian noise.
...
Method: Uses resilient vector consensus for aggregation and multivariate Gaussian noise for privacy, with theoretical guarantees.

Result: Achieves tighter error bounds and better privacy-accuracy trade-off than existing methods.

Conclusion: ImprovDML effectively balances privacy, resilience, and accuracy, validated by simulations.
...
<details>
  <summary>Details</summary>
Motivation: Existing behavior-segmentation methods oversimplify animal behavior by imposing discrete syllables under restrictive assumptions, failing to reflect the flexible recombination of motor primitives.

Method: SKIL leverages representation learning on transition probabilities to infer latent skill sets and parameterizes policies as dynamic mixtures of these skills.

Result: The method identifies reusable skill components, learns continuously evolving compositional policies, and generates realistic trajectories beyond traditional discrete models.
...
TL;DR: The paper rigorously evaluates ML techniques for solving the 1D Poisson equation, highlighting the importance of data function space for generalization. It provides theoretical and empirical bounds, reveals opposing generalization behaviors in models, and introduces a new interpretability method and cross-validation technique.


<details>
  <summary>Details</summary>
Motivation: To address the gap between promising ML applications in science and the need for quantitative accuracy, the study applies numerical analysis rigor to ML for differential equations, focusing on the 1D Poisson equation.

Method: The study quantifies ML accuracy by analyzing training dynamics, deriving optimal parameters, and proving generalization bounds for white-box and black-box models. Empirical validation includes deep linear models, shallow networks, and physics-specific models.

Result: Generalization to the true equation is not guaranteed; different models show opposing behaviors. A new interpretability method extracts Green's functions from black-box models.

Conclusion: The findings advocate for a new cross-validation technique and propose the Poisson equation as a benchmark for evaluating future ML methods in scientific applications.
...
TL;DR: SoKA is a parameter-efficient fine-tuning method combining Kronecker-product factorization and SVD for dynamic rank selection, outperforming existing methods with fewer parameters.


<details>
  <summary>Details</summary>
Motivation: To address the inefficiencies of full fine-tuning and limitations of existing PEFT methods like latency, suboptimal convergence, or fixed rank choices.
...
Result: Achieves comparable or better performance with 0.99M parameters (25% fewer than LoRA/PiSSA), faster convergence, and stable gradients.

Conclusion: SoKA is robust and efficient for large-scale model adaptation, offering a superior PEFT solution.
...
TL;DR: The paper explores the robustness of federated learning to Byzantine behavior, revealing a tradeoff between averaging and validity conditions. It provides theoretical bounds on centroid approximation and introduces a new algorithm for better performance.
...
Result: The paper establishes a lower bound of min{(n-t)/t, √d} on centroid approximation under box validity and an upper bound of 2min{n, √d}. A new algorithm achieves √2d-approximation under convex validity, proving tightness of existing bounds.

Conclusion: Federated learning's robustness to Byzantine behavior is limited by tradeoffs between averaging and validity. Theoretical bounds and a new algorithm improve understanding and performance, with empirical validation supporting the findings.
...
<details>
  <summary>Details</summary>
Motivation: Existing DI methods require in-distribution held-out data, which is rarely available, limiting their practicality. The paper aims to address this by generating synthetic data.
...
Result: Experiments show the method enables DI to detect original training sets with high confidence and low false positives, aiding copyright claims.

Conclusion: The synthetic data generation method reliably supports DI for real-world applications, empowering data owners to verify unauthorized use.
...
TL;DR: DOVA-PATBM is a geo-computational framework for optimizing EV charging infrastructure, addressing urban, suburban, and rural needs with a scalable, data-rich approach.


<details>
  <summary>Details</summary>
Motivation: The need for scalable infrastructure planning tools to support widespread EV adoption, balancing urban density, suburban car-dependency, and rural power constraints.

Method: Combines rasterized data, graph neural networks, Voronoi tessellation, and queue modeling to optimize charger placement under coverage, equity, and power constraints.

Result: In Georgia, USA, DOVA-PATBM improved coverage, reduced travel distance for low-income residents, and met power constraints, proving scalable for national use.

Conclusion: The framework bridges academic optimization and practical infrastructure policy, demonstrating effectiveness for large-scale EV charging deployment.
...
TL;DR: The paper proposes a credit risk management framework for 3PL-led SCF in CBEC, using QRGMM and DeepFM for risk assessment and loan size determination.
...
Result: Validated through experiments, the model effectively assesses credit risk and determines loan sizes, enhancing SME access to capital.

Conclusion: A pioneering use of generative AI in CBEC SCF, improving credit practices and SME financing opportunities.
...
TL;DR: SecFwT is a framework for efficient, privacy-preserving fine-tuning of LLMs using forward-only tuning and MPC-friendly attention mechanisms.


<details>
  <summary>Details</summary>
Motivation: Adapting LLMs to privacy-sensitive domains is challenging due to data scarcity and computational overhead in privacy-preserving methods.

Method: Proposes SecFwT, which uses forward-only tuning and Random Feature Attention to reduce computational complexity.

Result: SecFwT improves efficiency and privacy, enabling scalable fine-tuning for privacy-critical applications.

Conclusion: SecFwT addresses key challenges in privacy-preserving LLM fine-tuning, offering a practical solution for sensitive domains.
...
TL;DR: A structured active learning method using Seq2Seq VAE balances chemical diversity and multi-target affinity, successfully generating pan-inhibitor candidates for coronavirus proteases.
...
Method: Integrates Seq2Seq VAE into iterative loops, alternating between expanding chemical diversity and applying multi-target docking constraints.

Result: Efficiently generated diverse pan-inhibitor candidates for SARS-CoV-2, SARS-CoV, and MERS-CoV proteases.

Conclusion: The framework offers a generalizable approach for navigating complex multi-objective drug design problems.
...
<details>
  <summary>Details</summary>
Motivation: To understand why ICL remains effective despite noisy or incomplete labels, focusing on a binary Gaussian mixture model (GMM) with missing labels.

Method: Theoretical analysis of one-layer linear attention models versus multilayer/looped transformers, connecting their performance to polynomial estimators and Expectation Maximization (EM).

Result: Multilayer transformers implicitly construct polynomial estimators, with exponential gains in performance relative to depth, outperforming single-layer models.

Conclusion: Looping off-the-shelf tabular foundation models enhances semi-supervised learning, validated by improved performance on real-world datasets.
...
TL;DR: The paper proposes a method to predict abnormal values of unprescribed tests using performed test results, focusing on CBC and routine biochemical panels. It frames this as a set translation problem, improving prediction accuracy by up to 8% AUC.


<details>
  <summary>Details</summary>
Motivation: Early diagnosis is crucial, and predicting abnormal test values from existing results can make it more accessible. CBC tests, being widely used, are a key focus.
...
Conclusion: The approach effectively bridges LLMs with tabular data, enhancing clinical lab result predictions without imputing missing values.
...
<details>
  <summary>Details</summary>
Motivation: Traditional KD methods for NNPs increase energy barriers, limiting high-energy structure data. This framework aims to overcome this limitation for stable MD simulations.

Method: Uses a non-fine-tuned pre-trained NNP as a teacher to generate training data, followed by two-stage training: initial training with teacher-generated data and fine-tuning with a small DFT dataset.
...
Conclusion: The proposed framework efficiently generates accurate NNPs with fewer DFT calculations, addressing limitations of conventional KD methods.
...
<details>
  <summary>Details</summary>
Motivation: Current diffusion models in FWI struggle with iterative sampling and lack clear ways to incorporate approximate velocity models, limiting their practicality.
...
Result: The method outperforms existing conditional diffusion models, achieving high sample fidelity with fewer neural function evaluations (NFEs).

Conclusion: cI²SB offers a promising solution for FWI by combining efficiency and accuracy, with potential for broader applications in seismic inversion.
...
Method: The approach incorporates quantile regression for MIA to audit DP-SGD in black-box settings, where only the final model iterate is observed.

Result: The method achieves tighter empirical lower bounds on DP guarantees for DP-SGD on CIFAR-10, maintaining computational efficiency.
...
<details>
  <summary>Details</summary>
Motivation: Applying DiTs to molecular conformer generation introduces challenges like combining discrete graph data with continuous geometry and managing Euclidean symmetries.
...
Conclusion: The framework highlights the impact of architectural choices and symmetry priors, offering directions for large-scale molecular generative modeling.
...
TL;DR: The paper proposes a novel method for learning ground metrics in optimal transport to improve comparisons of probability distributions, addressing limitations of predefined or supervised metrics.


<details>
  <summary>Details</summary>
Motivation: Predefined metrics lack adaptability to data structure, and supervised methods often fail to generalize across classes or distributions with shared supports.
...
Result: The method enhances performance in embedding, clustering, and classification tasks, demonstrated using scRNA-seq data across multiple diseases.

Conclusion: The proposed approach offers a more effective and interpretable solution for learning ground metrics in optimal transport.
...
TL;DR: A novel framework for exploration using diffusion models, maximizing entropy without explicit uncertainty, with scalable density estimation and proven convergence.


<details>
  <summary>Details</summary>
Motivation: To enable exploration in decision-making problems like scientific discovery, leveraging generative models without relying on uncertainty quantification.

Method: Introduces entropy maximization over a diffusion model's data manifold, connects entropy to the score function, and develops a mirror descent algorithm for sequential fine-tuning.

Result: Demonstrates promising empirical results on synthetic and high-dimensional text-to-image diffusion tasks.

Conclusion: The framework effectively addresses exploration challenges, offering a scalable and theoretically grounded solution.
...
TL;DR: The paper addresses minimizing disease extinction time in an SIS model with an unknown graph, proposing a learning algorithm for graph recovery and an optimal vaccination strategy.


<details>
  <summary>Details</summary>
Motivation: Existing work assumes known graphs, but practical scenarios often lack this information. The study aims to optimize vaccination strategies when the underlying graph is unknown.

Method: The approach splits the problem into graph learning and vaccination strategy. It introduces an inclusion-exclusion-based learning algorithm and provides an optimal algorithm for Spectral Radius Minimization (SRM) with bounded treewidth graphs, along with a greedy heuristic for general graphs.

Result: The proposed learning algorithm has proven sample complexity, and the SRM algorithm runs in polynomial time for bounded treewidth graphs. Experiments validate the methods on synthetic and real-world data.

Conclusion: The work successfully addresses the challenge of unknown graphs in SIS models, offering efficient learning and vaccination strategies with theoretical and empirical support.
...
TL;DR: The paper addresses the lack of standardized evaluation protocols for Explainable AI (XAI) by introducing a unified framework (VXAI) and categorizing metrics from 362 publications.
...
Result: The VXAI framework provides a comprehensive, structured overview of XAI evaluation metrics, enhancing comparability and metric selection.

Conclusion: The framework supports systematic evaluation of XAI methods, promotes standardization, and offers a foundation for future research.
...
Result: Provides a structured overview of both established and emerging reward modeling techniques in RL.

Conclusion: Highlights promising research directions and fills the gap for a systematic review of reward models in RL literature.
...
<details>
  <summary>Details</summary>
Motivation: To address the degradation of zero-shot RL methods under partial observability, inspired by single-task RL solutions.

Method: Use memory-based architectures to handle partial observability in zero-shot RL, tested in environments with partially observed states, rewards, and dynamics.
...
TL;DR: RHO proposes adaptive homophily learning for semi-supervised graph anomaly detection, outperforming state-of-the-art methods by addressing diverse homophily in normal nodes.


<details>
  <summary>Details</summary>
Motivation: Current methods assume uniform homophily in normal nodes, but real-world graphs show diverse patterns, limiting detection accuracy.

Method: RHO uses adaptive frequency response filters (AdaFreq) and graph normality alignment (GNA) to learn and align homophily patterns.

Result: Experiments on eight datasets show RHO outperforms competing methods by effectively capturing diverse homophily.

Conclusion: RHO robustly learns varying homophily, improving anomaly detection in graphs with limited labeled normal nodes.
...
<details>
  <summary>Details</summary>
Motivation: Traditional visualizations lack qualitative comparison of structural relationships in time series, making it hard to understand shifts, speed changes, or slowdowns.

Method: Proposes a method to simplify warping paths, quantifying and visualizing key transformations between time series.

Result: Enhances interpretability by clearly representing how subsequences match between time series.

Conclusion: The technique provides a clearer, more interpretable comparison of time series, addressing limitations of traditional methods.
...
TL;DR: PRISM introduces a framework for nuanced feature descriptions in neural networks, addressing polysemanticity and improving interpretability.


<details>
  <summary>Details</summary>
Motivation: Current feature description methods are limited by assumptions of monosemanticity and lack robustness, hindering accurate model understanding.

Method: PRISM provides nuanced descriptions for both polysemantic and monosemantic features, benchmarking against existing methods.

Result: PRISM outperforms existing methods in description quality and capturing polysemanticity, validated by scores.
...
TL;DR: A user-guided projection framework for dimensionality reduction (DR) leverages MLLMs to enable customizable, interpretable visualizations via natural-language prompts, enhancing cluster separation and interactivity.


<details>
  <summary>Details</summary>
Motivation: Current DR techniques lack the ability to explore semantic structures not directly available in variables or labels, limiting user-driven exploration.
...
Conclusion: This approach bridges automated DR and human-centered exploration, offering flexible, tailored projections for specific analytical needs.
...
TL;DR: The paper introduces LoX, a training-free method to enhance LLM safety by extrapolating low-rank subspaces, reducing vulnerability to fine-tuning attacks.
...
Method: Proposes Low-Rank Extrapolation (LoX), a training-free technique to robustify safety-critical subspaces in LLM parameters.

Result: LoX reduces attack success rates by 11% to 54% against benign/malicious fine-tuning, preserving task adaptability.

Conclusion: LoX effectively enhances safety robustness by moving parameters to flatter, less sensitive zones, validated empirically.
...
<details>
  <summary>Details</summary>
Motivation: Linear predictors with interaction terms are common but can overfit in high-dimensional settings. The paper aims to improve accuracy by leveraging low-dimensional structure.

Method: LIT-LVM represents features with latent vectors in low-dimensional space, acting as structured regularization.
...
Conclusion: LIT-LVM is effective for high-dimensional settings, offering better accuracy and interpretability than existing methods.
...
<details>
  <summary>Details</summary>
Motivation: Current RLHF approaches rely on manual rule engineering, which is inefficient and limits scalability. AutoRule aims to automate this process.

Method: AutoRule uses a reasoning model to interpret preferences, extracts candidate rules, and synthesizes them into a unified set. It employs verifiers to compute rule satisfaction as an auxiliary reward.

Result: AutoRule improves win rates by 28.6% on AlpacaEval2.0 and gains 6.1% on MT-Bench, with reduced reward hacking and better alignment with preferences.
...
TL;DR: The paper introduces a certification framework for robust pixel-level attributions in deep learning, addressing the non-robustness of post-hoc attribution methods.
...
Method: The framework uses randomized smoothing to sparsify and smooth attribution maps, reformulating the task as a segmentation problem. It certifies pixel importance against ℓ₂-bounded perturbations.

Result: The method is evaluated on 12 attribution methods across 5 ImageNet models, showing robust, interpretable, and faithful certified attributions.
...
TL;DR: A systematic review of adversarial attacks on tabular ML models, highlighting trends, attack strategies, and practical challenges.


<details>
  <summary>Details</summary>
Motivation: Research on adversarial attacks in tabular data is scattered; this paper aims to provide a structured overview.
...
Conclusion: The review guides future research on understanding and mitigating adversarial vulnerabilities in tabular ML.
...
TL;DR: SAEs often produce dense latents, which are meaningful and functional, not just training artifacts.
...
Method: Systematic investigation of dense latents' geometry, function, and origin, including ablation studies and taxonomy creation.

Result: Dense latents form antipodal pairs, serve functional roles (e.g., position tracking, semantic features), and evolve across layers.
...
Method: Theoretical analysis of spatiotemporal over-squashing, comparing static and dynamic contexts, and empirical validation on synthetic and real-world datasets.

Result: Convolutional STGNNs favor distant temporal information propagation, and both time-and-space and time-then-space paradigms are equally affected.

Conclusion: Provides insights into STGNN dynamics and principled guidance for more effective designs, validated by empirical results.
...
TL;DR: RePCS is a model-agnostic method to detect if RAG systems rely on memorized data instead of retrieved context, using KL divergence between inference paths.
...
Method: RePCS compares parametric and retrieval-augmented inference paths via KL divergence, requiring no model access or retraining.

Result: Achieves 0.918 ROC-AUC on Prompt-WNQA, outperforming prior methods by 6.5%, with minimal latency overhead.
...
<details>
  <summary>Details</summary>
Motivation: To make SGD analysis more accessible and facilitate further research into mini-batching and learning rate scheduling.

Method: Uses simple linear algebra tools to derive bias and variance bounds, avoiding complex PSD matrix operations.

Result: Recovers the same bounds as prior work, proving the effectiveness of the simplified approach.

Conclusion: The simplified analysis enhances accessibility and paves the way for future improvements in training realistic models.
...
TL;DR: The paper extends Gold's inductive inference framework to include computational observations and restricted input sources, enabling learnability of general recursive functions under realistic constraints.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of traditional input-output observations in learning general recursive functions by introducing new observation types and computational constraints.
...
Result: Shows that learning computable functions is possible with computational constraints or time-bound observations, but negative results exist for linear-time computable functions.

Conclusion: The study reveals connections to finite-state transducer inference and highlights challenges in learning linear-time computable functions.
...
TL;DR: The paper identifies gradient pathologies and non-stationarity as root causes of degraded performance in scaling deep reinforcement learning networks. It proposes simple, effective interventions to stabilize gradient flow, enabling robust performance at scale.


<details>
  <summary>Details</summary>
Motivation: Understanding and addressing the challenges of scaling deep reinforcement learning networks, which often degrade in performance despite recent complex solutions.

Method: Conducts empirical analyses to identify gradient pathologies and non-stationarity as issues. Proposes simple interventions to stabilize gradient flow.
...
Conclusion: Simple architectural interventions can effectively address scaling challenges in deep reinforcement learning, improving performance at large scales.
...
TL;DR: DAILOC is a domain-incremental learning framework for Wi-Fi fingerprinting-based indoor localization, addressing device and temporal domain shifts with disentanglement and memory-guided alignment, outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Challenges in Wi-Fi fingerprinting-based indoor localization due to device heterogeneity and temporal variations, leading to poor generalization and catastrophic forgetting.
...
TL;DR: LogNet is a logic gate-based framework for interpreting and improving DL-based indoor localization, offering transparency and better performance.


<details>
  <summary>Details</summary>
Motivation: Existing DL models for indoor localization lack interpretability, making it hard to understand temporal variations and adapt for long-term reliability.

Method: LogNet uses logic gates to identify influential access points and diagnose noise impact, enhancing DL model transparency and adaptability.
...
Conclusion: LogNet provides interpretable and efficient indoor localization, improving long-term reliability and performance.
...
TL;DR: MicroRicci is a self-tuning, local Ricci-flow solver that uses coding theory and neural modules for efficient mesh smoothing, achieving significant speedup and quality improvements.


<details>
  <summary>Details</summary>
Motivation: Real-time mesh smoothing is challenging due to costly global updates in classical methods and slow convergence in greedy heuristics. MicroRicci addresses this by combining local updates and adaptive tuning.

Method: MicroRicci employs a greedy syndrome-decoding step for curvature correction in O(E) time, augmented by two neural modules for adaptive vertex and step-size selection.

Result: On 110 SJTU-TMQA meshes, MicroRicci reduces iterations by 2.4x, tightens curvature spread, and achieves high UV-distortion-to-MOS correlation (r = -0.93), with only 0.25 ms added per iteration.

Conclusion: MicroRicci's efficiency, adaptability, and quality make it ideal for real-time, resource-limited applications in graphics and simulation.
...
TL;DR: The paper introduces GFLC, a method to correct biased and noisy labels in ML training data while ensuring fairness, improving both performance and fairness metrics.
...
Method: Proposes GFLC, combining prediction confidence, graph-based regularization (Ricci-flow-optimized graph Laplacians), and demographic parity incentives.
...
TL;DR: Federated learning (FL) for BrainAGE estimation in stroke patients shows comparable accuracy to centralized learning and outperforms single-site models, with BrainAGE linked to vascular risk factors and functional outcomes.


<details>
  <summary>Details</summary>
Motivation: To address privacy concerns in training robust BrainAGE models by evaluating FL's performance and its association with clinical phenotypes and stroke recovery.

Method: Used FLAIR images from 1674 stroke patients across 16 centers, comparing centralized learning, FL, and single-site learning. Analyzed BrainAGE's association with vascular risk factors and functional outcomes using logistic regression.

Result: FL outperformed single-site models and was comparable to centralized learning. BrainAGE was higher in diabetes patients and significantly associated with post-stroke recovery.

Conclusion: FL enables accurate BrainAGE predictions without data centralization, with BrainAGE serving as a valuable biomarker for stroke prognosis.
...
<details>
  <summary>Details</summary>
Motivation: To tackle the issue of over-conservatism in AWRs caused by poor explorations in offline datasets, which leads to suboptimal policies.

Method: Proposes CAWR, combining robust loss functions for policy optimization and advantage-based prioritized replay to filter poor explorations.
...
### [217] [Comparative Analysis of QNN Architectures for Wind Power Prediction: Feature Maps and Ansatz Configurations](https://arxiv.org/abs/2506.14795)
*Batuhan Hangun,Emine Akpinar,Oguz Altun,Onder Eyecioglu*

Main category: quant-ph

TL;DR: QML enhances classical ML using quantum principles, with QNNs outperforming classical methods in wind power prediction.


<details>
  <summary>Details</summary>
Motivation: Address skepticism about QML's practical advantages due to NISQ device limitations by evaluating QNNs.

Method: Constructed and tested 12 QNN configurations with 2 quantum feature maps and 6 entanglement strategies.

Result: QNNs achieved 93% accuracy in wind power prediction, surpassing classical methods.

Conclusion: QNNs demonstrate QML's potential for real-world applications, outperforming classical approaches.
...
### [218] [CutReg: A loss regularizer for enhancing the scalability of QML via adaptive circuit cutting](https://arxiv.org/abs/2506.14858)
*Maniraman Periyasamy,Christian Ufrecht,Daniel D. Scherer,Wolfgang Mauerer*

Main category: quant-ph

TL;DR: A novel regularization term in QML optimization balances gate cutting overhead with ML accuracy, addressing NISQ hardware constraints.


<details>
  <summary>Details</summary>
Motivation: The limitations of NISQ hardware hinder quantum advantage validation and exploration of issues like barren plateaus.

Method: Introduces a regularization term to penalize sampling overhead, optimizing the trade-off between cutting benefits and ML accuracy.

Result: Enables balancing gate cutting advantages with ML cost function optimization, facilitating study of larger problems.

Conclusion: This approach advances the pursuit of quantum advantage by mitigating NISQ hardware constraints.
...
### [219] [Q2SAR: A Quantum Multiple Kernel Learning Approach for Drug Discovery](https://arxiv.org/abs/2506.14920)
...
Conclusion: The QMKL framework shows promise for improving cheminformatics tasks with quantum-enhanced methods.
...
### [220] [Advanced Prediction of Hypersonic Missile Trajectories with CNN-LSTM-GRU Architectures](https://arxiv.org/abs/2506.15043)
...
<details>
  <summary>Details</summary>
Motivation: Hypersonic missiles' extreme speeds and maneuverability make trajectory prediction critical for effective countermeasures.

Method: Novel hybrid deep learning integrating CNNs, LSTMs, and GRUs.
...
### [221] [RAS-Eval: A Comprehensive Benchmark for Security Evaluation of LLM Agents in Real-World Environments](https://arxiv.org/abs/2506.15253)
...
<details>
  <summary>Details</summary>
Motivation: The lack of standardized security benchmarks for LLM agents in dynamic environments necessitates a robust evaluation tool.

Method: RAS-Eval includes 80 test cases and 3,802 attack tasks across 11 CWE categories, tested on 6 LLMs using JSON, LangGraph, and MCP formats.

Result: Attacks reduced task completion rates by 36.78% on average, with an 85.65% success rate in academic settings. Larger models performed better.

Conclusion: The study highlights critical risks in LLM agent deployments and offers a foundational framework for security research.
...
### [222] [Evaluation Pipeline for systematically searching for Anomaly Detection Systems](https://arxiv.org/abs/2506.15388)
*Florian Rokohl,Alexander Lehnert,Marc Reichenbach*

Main category: cs.CR

TL;DR: Proposes an FPGA-based anomaly detection system for real-time malicious client detection in medical digitalization, addressing security and performance constraints.
...
Method: Uses FPGAs to meet real-time and power constraints for anomaly detection on hardware.

Result: Achieves overall system performance through holistic system evaluation.

Conclusion: The system effectively addresses security and performance needs in medical digitalization.
...
### [223] [Winter Soldier: Backdooring Language Models at Pre-Training with Indirect Data Poisoning](https://arxiv.org/abs/2506.14913)
*Wassim Bouaziz,Mathurin Videau,Nicolas Usunier,El-Mahdi El-Mhamdi*

Main category: cs.CR

TL;DR: The paper shows indirect data poisoning can effectively protect datasets and trace their usage in LLMs without memorization or performance loss.
...
Method: Uses gradient-based optimization prompt-tuning to teach models secret sequences absent from training data.

Result: Less than 0.005% poisoned tokens suffice to detect secrets with high confidence (p < 10^{-55}) without degrading performance.

Conclusion: Indirect data poisoning is feasible and effective for dataset protection and tracing in LLMs.
...
### [224] [Private Continual Counting of Unbounded Streams](https://arxiv.org/abs/2506.15018)
*Ben Jacobsen,Kassem Fawaz*

Main category: cs.CR

TL;DR: The paper introduces a novel algorithm for differentially private continual counting in the unbounded setting, improving upon existing methods by using logarithmic perturbations of a specific function, achieving smooth error and efficient performance.


<details>
  <summary>Details</summary>
Motivation: Current algorithms for differentially private continual counting require prior knowledge of input size and suffer from suboptimal error when adapted to unbounded settings. This work aims to address these limitations.

Method: The authors propose new matrix factorizations based on logarithmic perturbations of the function $\frac{1}{\sqrt{1-z}}$, enabling a differentially private algorithm with smooth error and efficient runtime.

Result: The algorithm achieves $O(\log^{2+2\alpha}(t))$ variance, $O(t)$ space, and amortized $O(\log t)$ time per round, outperforming prior bounded-input methods in efficiency. Empirical results show competitive performance.

Conclusion: The proposed algorithm effectively solves the problem of unbounded differentially private continual counting, offering improved error smoothness and computational efficiency compared to existing approaches.
...
### [225] [Systems-Theoretic and Data-Driven Security Analysis in ML-enabled Medical Devices](https://arxiv.org/abs/2506.15028)
...
TL;DR: The paper highlights cybersecurity risks in AI/ML-enabled medical devices, proposes tools for pre-market risk assessment, and emphasizes embedding security in design.
...
Method: Analyzes device recalls, adverse events, and vulnerabilities to understand threats; introduces tools for pre-market risk assessment.

Result: Proposes a suite of tools to help manufacturers embed cybersecurity in device design, enhancing safety.

Conclusion: Addressing cybersecurity in the pre-market phase is critical to ensure safe AI/ML-enabled medical devices.
...
### [226] [CWGAN-GP Augmented CAE for Jamming Detection in 5G-NR in Non-IID Datasets](https://arxiv.org/abs/2506.15075)
...
<details>
  <summary>Details</summary>
Motivation: To address the challenge of jamming attacks in 5G-NR networks, which degrade signal quality, the study aims to develop a robust detection method.

Method: The authors simulate jamming with AWGN, use a CAE for detection, and balance datasets using CWGAN-GP. Performance is compared with CDAE and CSAE.

Result: The CAE achieves high performance metrics (97.33% precision, 91.33% recall, 94.08% F1-score, 94.35% accuracy), outperforming benchmarks.

Conclusion: The CAE is robust for jamming detection in heterogeneous 5G-NR datasets, proving effective despite data complexity.
...
### [227] [deepSURF: Detecting Memory Safety Vulnerabilities in Rust Through Fuzzing LLM-Augmented Harnesses](https://arxiv.org/abs/2506.15648)
*Georgios Androutsopoulos,Antonio Bianchi*

Main category: cs.CR

TL;DR: deepSURF combines static analysis and LLM-guided fuzzing to detect memory safety bugs in Rust, outperforming existing tools.


<details>
  <summary>Details</summary>
Motivation: Existing tools for detecting memory bugs in Rust are limited, manual, or inadequate for Rust-specific types.

Method: Integrates static analysis with LLM-guided fuzzing harness generation, handles generics via custom types, and uses LLMs to enhance harnesses.

Result: Discovered 20 known and 6 new vulnerabilities in 27 Rust crates, outperforming state-of-the-art tools.

Conclusion: deepSURF effectively identifies memory safety vulnerabilities in Rust, offering a significant improvement over existing methods.
...
### [228] [MODS: Multi-source Observations Conditional Diffusion Model for Meteorological State Downscaling](https://arxiv.org/abs/2506.14798)
*Siwei Tu,Jingyi Xu,Weidong Yang,Lei Bai,Ben Fei*

Main category: physics.ao-ph

TL;DR: The paper introduces MODS, a multi-source conditional diffusion model, to improve downscaling accuracy of meteorological variables by integrating diverse satellite and topographic data.


<details>
  <summary>Details</summary>
Motivation: Existing downscaling methods relying on geostationary satellites and ERA5 data inadequately capture meteorological changes, necessitating a more comprehensive approach.

Method: MODS fuses data from multiple satellites (GridSat, AMSU-A, HIRS, MHS) and topographic data (GEBCO) with ERA5, using a multi-source cross-attention module for feature fusion.

Result: MODS outperforms existing methods, achieving higher fidelity in downscaling ERA5 maps to 6.25 km resolution.
...
TL;DR: CheckFree and CheckFree+ are efficient recovery methods for LLM training on decentralized nodes, replacing failed stages with weighted averages or mimicking behavior via out-of-order pipelining, outperforming traditional approaches like checkpointing and redundant computation.


<details>
  <summary>Details</summary>
Motivation: To reduce the high communication and computation overhead of conventional recovery methods (checkpointing, redundant computation) in decentralized LLM training, especially for large models.

Method: CheckFree substitutes failed intermediate stages with weighted averages of neighboring stages. CheckFree+ extends this with out-of-order pipelining to recover first/last stages by copying weights or layers from neighbors.
...
Conclusion: CheckFree and CheckFree+ offer efficient, low-overhead recovery for decentralized LLM training, enabling cost-effective and scalable model democratization.
...
TL;DR: A temporal convolutional network was developed to model and correct gradient distortions in MRI, improving image quality and diffusion parameter mapping.


<details>
  <summary>Details</summary>
Motivation: Errors in gradient trajectories cause artifacts in MRI, especially in non-Cartesian imaging, necessitating a better model to predict and correct these distortions.

Method: Measured gradient waveforms were used to train a temporal convolutional network to predict distortions, which was then integrated into image reconstruction.

Result: The network accurately predicted gradient distortions, enhancing image quality and diffusion parameter mapping compared to traditional methods.

Conclusion: Temporal convolutional networks outperform linear methods in modeling gradient distortions and enable retrospective correction of gradient errors.
...
### [233] [Intrinsic and Extrinsic Organized Attention: Softmax Invariance and Network Sparsity](https://arxiv.org/abs/2506.15541)
*Oluwadamilola Fasina,Ruben V. C. Pohle,Pei-Chun Su,Ronald R. Coifman*

Main category: math.NA

TL;DR: The paper analyzes the intrinsic and extrinsic structure of self-attention in transformers, showing invariance to softmax activation and using hierarchical tensor organization for interpretability and practical applications like pruning.
...
Result: Demonstrates invariance of self-attention to softmax activation, hierarchical organization of attention heads, and utility in tasks like model pruning and architecture comparison.

Conclusion: The findings enhance interpretability and enable practical applications like pruning and network comparison, advancing transformer analysis.
...
### [234] [On the Upper Bounds for the Matrix Spectral Norm](https://arxiv.org/abs/2506.15660)
...
Method: Proposes a Counterbalance estimator that provides upper bounds on the spectral norm via matrix-vector products, with probabilistic guarantees against underestimation.

Result: The estimator yields significantly tighter upper bounds than the power method in synthetic and real-world scenarios.

Conclusion: The Counterbalance estimator is a superior alternative for spectral norm estimation, especially for matrices with fast-decaying spectra.
...
### [235] [Explain First, Trust Later: LLM-Augmented Explanations for Graph-Based Crypto Anomaly Detection](https://arxiv.org/abs/2506.14933)
*Adriana Watson*

Main category: cs.CE

TL;DR: The paper discusses the rise of financial crime in DeFi due to cryptocurrency growth and advocates for automated detection tools to combat it.
...
Method: Proposes the implementation of automated detection tools to address criminal activities.

Result: Highlights the urgent need for policy-driven solutions to curb cryptocurrency-related crime.

Conclusion: Automated tools are essential to mitigate the growing criminality in the DeFi and cryptocurrency space.
...
### [236] [Minimizing Structural Vibrations via Guided Flow Matching Design Optimization](https://arxiv.org/abs/2506.15263)
*Jan van Delden,Julius Schultz,Sebastian Rothe,Christian Libner,Sabine C. Langer,Timo Lüddecke*

Main category: cs.CE

TL;DR: A novel design optimization method using guided flow matching reduces structural vibrations in plate-like structures by integrating generative flow matching and surrogate models.
...
Method: Combines generative flow matching and a surrogate model to explore manufacturable, low-vibration designs without manual parameter optimization.

Result: Generates diverse, manufacturable plate designs with reduced vibrations, outperforming random search, heuristic, and genetic optimization.

Conclusion: The approach effectively explores design spaces and produces superior vibration-reducing solutions.
...
<details>
  <summary>Details</summary>
Motivation: The challenge of predicting future neural activity for applications in neurotechnology and scientific research, especially in multi-session, spontaneous recordings.
...
Result: POCO achieves high accuracy in neural forecasting, adapts quickly to new recordings, and recovers biologically meaningful structure (e.g., brain region clustering) without anatomical labels.
...
### [238] [Digital twin for virtual sensing of ferry quays via a Gaussian Process Latent Force Model](https://arxiv.org/abs/2506.14925)
*Luigi Sibille,Torodd Skjerve Nord,Alice Cicirello*

Main category: stat.AP

TL;DR: The study explores using the Gaussian Process Latent Force Model (GPLFM) for virtual sensing on ferry quays, integrating experimental data and physics-based models to address challenges like unknown impact forces and sparse sensors. Results show accurate response estimates, except in impact zones, and suggest optimal sensor placement strategies.


<details>
  <summary>Details</summary>
Motivation: Ferry quays deteriorate rapidly due to harsh maritime conditions and ferry impacts. Vibration-based monitoring is limited by sensor placement constraints, necessitating virtual sensing techniques for Digital Twin development.

Method: The study combines experimental data from ferry impacts with a physics-based model, using GPLFM to represent unknown forces via modal contributions. Challenges include unknown impact characteristics and sparse sensors.

Result: GPLFM provides accurate acceleration estimates at most locations, except impact zones. A numerical study suggests optimal sensor placement and examines sensitivity to sensor types, frequencies, and damping assumptions.

Conclusion: GPLFM effectively handles modeling and measurement uncertainties, maintaining accuracy. The approach supports Digital Twin development for ferry quays despite practical challenges.
...
### [239] [Spectral Contraction of Boundary-Weighted Filters on delta-Hyperbolic Graphs](https://arxiv.org/abs/2506.15464)
*Le Vu Anh,Mehmet Dik,Nguyen Viet Anh*

Main category: math.MG

TL;DR: A boundary-weighted operator is introduced for hierarchical graphs, using Busemann functions to ensure stability and energy loss control, providing a parameter-free filter for graph signal processing.


<details>
  <summary>Details</summary>
Motivation: Hierarchical graphs with tree-like structures challenge traditional graph filters, necessitating a new approach leveraging geometric principles.

Method: The method involves rescaling edges based on endpoint drift toward the Gromov boundary and using Busemann functions on delta-hyperbolic networks to bound the operator's spectral norm.

Result: The operator ensures a curvature-controlled energy loss per pass, yielding a stable, parameter-free filter.

Conclusion: This approach offers a lightweight, analytic tool for processing signals on hierarchical graphs with dense or hidden structures.
...
### [240] [BMFM-RNA: An Open Framework for Building and Evaluating Transcriptomic Foundation Models](https://arxiv.org/abs/2506.14861)
...
TL;DR: The paper introduces BMFM-RNA, a modular software package for transcriptomic foundation models (TFMs), addressing challenges in reproducibility and best practices. It includes a novel training objective (WCED) and shows competitive performance against state-of-the-art methods.


<details>
  <summary>Details</summary>
Motivation: The diversity in TFM implementations and training strategies hinders reproducibility and convergence on best practices. BMFM-RNA aims to unify these approaches for systematic benchmarking.

Method: BMFM-RNA integrates diverse TFM pretraining and fine-tuning objectives, including a novel WCED objective. It evaluates four model checkpoints pretrained on CELLxGENE using MLM, WCED, and multitask learning.

Result: WCED-based models match or exceed state-of-the-art methods like scGPT across multiple datasets in zero-shot and fine-tuning tasks.

Conclusion: BMFM-RNA provides a reproducible framework for TFM benchmarking, fostering community-driven exploration and better tools for cell biology research.
...
### [241] [Preparing for the Intelligence Explosion](https://arxiv.org/abs/2506.14863)
*William MacAskill,Fin Moorhouse*

Main category: cs.CY

TL;DR: The paper discusses the rapid advancements in AI and the resulting grand challenges, emphasizing the need for immediate human-led preparation to address these issues, as they cannot always be delegated to future AI systems.


<details>
  <summary>Details</summary>
Motivation: The motivation is to highlight the urgent and complex challenges posed by AI-driven technological progress, such as new weapons, AI-enabled autocracies, and moral considerations for digital beings, which require proactive human intervention.

Method: The authors analyze the potential grand challenges arising from AI advancements and argue for human-led preparedness, suggesting actionable steps to improve future prospects.

Result: The paper identifies key challenges and stresses the importance of current human efforts to address them, as relying solely on future AI systems is insufficient.

Conclusion: The conclusion underscores the necessity for immediate preparation to navigate the disorienting developments of an intelligence explosion, beyond just ensuring AI alignment.
...
### [242] [Hypothesis Testing for Quantifying LLM-Human Misalignment in Multiple Choice Settings](https://arxiv.org/abs/2506.14997)
*Harbin Hong,Sebastian Caldas,Liu Leqi*

Main category: cs.CY

TL;DR: A framework assesses misalignment between LLM-simulated and human behaviors in surveys, finding LLMs ill-suited for contentious questions across diverse populations.
...
Result: The tested LLM was found unsuitable for simulating human opinions in contentious questions across diverse sub-populations (race, age, income).

Conclusion: LLMs may not align well with human behaviors in certain contexts, necessitating improved practices for their use in social science research.
...
### [243] [Transit for All: Mapping Equitable Bike2Subway Connection using Region Representation Learning](https://arxiv.org/abs/2506.15113)
*Min Namgung,JangHyeon Lee,Fangyi Ding,Yao-Yi Chiang*

Main category: cs.CY

TL;DR: A framework called Transit for All (TFA) is introduced to equitably expand bike-sharing systems (BSS) in underserved urban areas, addressing demand prediction and accessibility gaps.


<details>
  <summary>Details</summary>
Motivation: Low-income and minority communities in cities like NYC face limited transit access. BSS can help, but expansion is hindered by uncertain demand and inadequate metrics.

Method: TFA uses spatial computing with three components: demand prediction via geospatial data, accessibility assessment with wPTAL, and strategic station placement.

Result: In NYC, TFA-guided station placements reduced transit access disparities for low-income and minority communities.

Conclusion: TFA offers urban planners a tool to promote equitable transit and improve quality of life in underserved areas.
...
### [244] [FORTRESS: Frontier Risk Evaluation for National Security and Public Safety](https://arxiv.org/abs/2506.14922)
*Christina Q. Knight,Kaustubh Deshpande,Ved Sirdeshmukh,Meher Mankikar,Scale Red Team,SEAL Research Team,Julian Michael*

Main category: cs.CY

TL;DR: FORTRESS is a benchmark with 500 expert-crafted adversarial prompts to evaluate LLM safeguards for national security and public safety risks, revealing trade-offs between risk and over-refusal.


<details>
  <summary>Details</summary>
Motivation: Current benchmarks lack robustness in testing LLM safeguards for NSPS risks, necessitating a more objective and comprehensive evaluation tool.

Method: FORTRESS includes 500 adversarial prompts with rubrics across 3 domains (CBRNE, Political Violence & Terrorism, Criminal & Financial Illicit Activities) and benign versions to test over-refusal.
...
Conclusion: FORTRESS provides policymakers and researchers a clear tool to assess LLM safeguard robustness, with public and private datasets available.
...
TL;DR: The paper proposes a real-time Diabetic Retinopathy (DR) detection system using deep learning models deployed on edge devices, achieving high accuracy and efficiency for scalable healthcare solutions.


<details>
  <summary>Details</summary>
Motivation: DR is a major cause of vision impairment in diabetes patients, and traditional diagnosis methods are time-consuming and resource-intensive. The study aims to provide a scalable, cost-effective solution using edge AI.
...
Result: MobileNet achieved 96.45% accuracy, while SqueezeNet showed strong real-time performance (17 ms latency, 176 KB size). ShuffleNet and the custom DNN excelled in resource efficiency.
...
TL;DR: FAHR-Face, a foundation model trained on >40M facial images, was fine-tuned for biological age estimation (FAHR-FaceAge) and survival risk prediction (FAHR-FaceSurvival), outperforming benchmarks and improving prognostic accuracy.


<details>
  <summary>Details</summary>
Motivation: To create scalable, noninvasive facial biomarkers for biological age estimation and survival risk prediction using a foundation model.

Method: Two-stage fine-tuning on public and cancer patient datasets, tested for robustness and independence, validated in clinical cohorts.

Result: FAHR-FaceAge achieved lowest mean absolute error (5.1 years); FAHR-FaceSurvival predicted mortality robustly (hazard ratio 3.22). Both models generalized across demographics.

Conclusion: A single foundation model can generate scalable facial biomarkers for aging and mortality risk, enhancing prognostic accuracy.
...
Result: The Pro3 produced a denser point cloud (1,877,324 points vs. iPhone's 506,961) and higher alignment accuracy (RMSE 0.0118m). C2C error was 0.0408m (std. 0.0715m).

Conclusion: The Pro3 is effective for large-scale 3D modeling, balancing cost and performance, and benefits from LiDAR and advanced alignment techniques.
...
TL;DR: Transformer models (SwinUNETR and UNETR) outperform 3D UNet in prostate gland segmentation, especially in handling label noise and class imbalance, with SwinUNETR showing superior robustness.


<details>
  <summary>Details</summary>
Motivation: Address inter-reader variability and cross-site domain shift in prostate anatomy segmentation using T2-weighted MRI images.

Method: Compare UNETR and SwinUNETR against 3D UNet using three training strategies (single cohort, cross-validated mixed cohort, gland size-based dataset) on 546 MRI volumes annotated by two experts.

Result: SwinUNETR achieved higher Dice scores (up to 0.902) than UNETR and 3D UNet, especially in cross-validated and gland size-based training.

Conclusion: Global and shifted-window self-attention in SwinUNETR reduces label noise and class imbalance sensitivity, making it robust for clinical deployment.
...
TL;DR: A Recursive variational Neural Network (RvNN) is developed to generate accurate and diverse 3D blood vessel models, overcoming limitations of rule-based methods.


<details>
  <summary>Details</summary>
Motivation: Existing rule-based methods for synthesizing vasculature lack the diversity and complexity of real anatomical data, limiting their clinical utility.
...
TL;DR: A transformer-based Mixture-of-Experts (MoE) framework is proposed to enhance neurological disorder (ND) diagnosis by integrating multi-modal MRI and clinical data, achieving 82.47% validation accuracy.
...
Method: A novel transformer-based MoE framework leverages aMRI, DTI, fMRI, and clinical data, using modality-specific experts and adaptive fusion for feature extraction and integration.

Result: The framework outperforms baselines by over 10%, achieving 82.47% validation accuracy, especially in distinguishing overlapping disease states.

Conclusion: The proposed multi-modal approach significantly improves ND diagnosis, demonstrating the potential of transformer-based MoE in real-world clinical settings.
...
<details>
  <summary>Details</summary>
Motivation: Incorrect DICOM headers in mpMRI exams due to diverse protocols and technologist errors hinder radiologists' efficiency, necessitating an automated classification solution.

Method: Multiple deep learning classifiers (ResNet, EfficientNet, DenseNet) are trained and compared using mpMRI data from various institutions. DenseNet-121 is identified as the best performer.

Result: DenseNet-121 achieves the highest F1-score (0.966) and accuracy (0.972). Performance improves with more training data (>729 studies) and remains robust on external datasets (0.872 and 0.810 accuracy).

Conclusion: The DenseNet-121 model effectively classifies mpMRI series types, demonstrating high accuracy and generalizability across internal and external datasets.
...
TL;DR: Proposed an HE inference framework for medical images using VQGAN for compression and polynomial approximations for activation functions, balancing efficiency and accuracy.


<details>
  <summary>Details</summary>
Motivation: Medical imaging data requires privacy protection, and HE inference is computationally expensive for large images.

Method: Uses VQGAN to compress images into latent representations, approximates activation functions with lower-degree polynomials, and adapts squeeze and excitation modules.

Result: Achieved optimal balance with an eight-fold downsampling factor; minor performance differences compared to unencrypted inference.
...
TL;DR: FedWSIDD is a federated learning approach for medical image analysis, using dataset distillation to share synthetic slides instead of raw data, addressing privacy and resource heterogeneity.


<details>
  <summary>Details</summary>
Motivation: To enable collaborative medical image analysis while preserving patient privacy and handling computational resource disparities.

Method: Uses dataset distillation (DD) to create synthetic slides, incorporates stain normalization, and shares these slides instead of model parameters.

Result: Improves WSI classification performance, supports heterogeneous models, and ensures privacy.

Conclusion: FedWSIDD is an effective solution for federated WSI classification tasks.
...
<details>
  <summary>Details</summary>
Motivation: Single-use endoscopes with tiny sensors reduce costs and infection risks but suffer from noise due to limited photosensitive area, dynamic range constraints, and analog signal transmission.

Method: Developed a noise model for analog sensors and proposed a hybrid denoising system integrating traditional image processing and learning-based techniques.

Result: The system reduces noise without losing fine details or distorting colors, achieving real-time performance and a PSNR improvement from 21.16 to 33.05.

Conclusion: The hybrid denoising approach effectively mitigates noise in endoscopic images, enhancing diagnostic quality while maintaining real-time processing capabilities.
...
Method: The study tested three preprocessing techniques (PMD filter, CLAHE, and a hybrid PMD-CLAHE) on Pap smear images from the SIPaKMeD dataset. Enhanced images were evaluated using pretrained CNN models like ResNet, EfficientNet, and DenseNet.

Result: The hybrid PMD-CLAHE approach improved image quality and CNN performance, with maximum gains of 13.62% accuracy, 10.04% precision, 13.08% recall, and 14.34% F1-score.

Conclusion: The hybrid PMD-CLAHE technique enhances cervical cancer classification performance, offering a promising direction for automated screening.
...
TL;DR: The study improves tumor segmentation in MRI using a hybrid UNet-Transformer model on local hospital data, achieving competitive results (Dice: 0.764, IoU: 0.736).


<details>
  <summary>Details</summary>
Motivation: Public datasets lack local patient heterogeneity, necessitating AI models tailored to local hospitals for accurate radiotherapy planning.

Method: Developed a hybrid UNet-Transformer model with attention modules, trained on 6080 local MRI images using efficient data preprocessing and augmentation.

Result: Achieved Dice score of 0.764 and IoU of 0.736, showing robust performance on limited local data.

Conclusion: Site-specific AI models are crucial for clinical deployment, balancing accuracy and computational efficiency.
...
### [257] [Optimal Convergence Rates of Deep Neural Network Classifiers](https://arxiv.org/abs/2506.14899)
...
<details>
  <summary>Details</summary>
Motivation: To understand the theoretical performance of classifiers, especially ReLU DNNs, under Tsybakov noise and compositional assumptions in high-dimensional settings.

Method: Analyzes the problem under Tsybakov noise and compositional assumptions, proving optimal convergence rates for excess 0-1 risk and demonstrating ReLU DNNs' effectiveness.

Result: Optimal convergence rate is derived, independent of input dimension, and ReLU DNNs achieve this rate up to a logarithmic factor.

Conclusion: The results justify the practical success of ReLU DNNs in high-dimensional classification tasks, with the method extending prior work.
...
### [258] [Double Machine Learning for Conditional Moment Restrictions: IV regression, Proximal Causal Learning and Beyond](https://arxiv.org/abs/2506.14950)
*Daqian Shao,Ashkan Soleymani,Francesco Quinzan,Marta Kwiatkowska*

Main category: stat.ML

TL;DR: The paper introduces DML-CMR, a two-stage estimator for conditional moment restrictions (CMRs) that reduces bias and achieves optimal convergence rates, outperforming existing methods in tasks like IV regression and proximal causal learning.


<details>
  <summary>Details</summary>
Motivation: Existing CMR estimators, especially those using deep neural networks, suffer from bias due to naive plug-in methods in two-stage approaches. The paper aims to address this issue.

Method: Proposes DML-CMR, a novel two-stage estimator following the double/debiased machine learning framework, with a new learning objective to reduce bias.

Result: DML-CMR achieves minimax optimal convergence rate of O(N^(-1/2)) and demonstrates superior performance in real-world applications like IV regression and proximal causal learning.

Conclusion: DML-CMR provides an unbiased, efficient solution for CMR problems, outperforming existing methods and offering theoretical guarantees.
...
### [259] [An Observation on Lloyd's k-Means Algorithm in High Dimensions](https://arxiv.org/abs/2506.14952)
*David Silva-Sánchez,Roy R. Lederman*

Main category: stat.ML

TL;DR: The paper explains why k-means fails in high-dimensional, noisy settings with limited samples, using a Gaussian Mixture Model.


<details>
  <summary>Details</summary>
Motivation: The study is motivated by challenges in analyzing complex cases like masked GMMs and applications in Cryo-Electron Microscopy.

Method: Theoretical analysis of k-means behavior in high-dimensional settings with a simple GMM.
...
### [260] [Performative Validity of Recourse Explanations](https://arxiv.org/abs/2506.15366)
*Gunnar König,Hidde Fokkema,Timo Freiesleben,Celestine Mendler-Dünner,Ulrike Von Luxburg*

Main category: stat.ML

TL;DR: Recourse explanations in algorithmic decision systems can become invalid due to performative effects when many applicants act on them, altering data and decision boundaries. Causal variables are key for valid recourse.
...
Method: Formally analyze conditions for recourse validity under performativity, focusing on causal vs. non-causal variables.

Result: Recourse actions may fail if influenced by or intervening on non-causal variables. Causal variables are essential for valid recommendations.

Conclusion: Standard counterfactual and causal recourse methods should be avoided; recourse should focus exclusively on causal variables.
...
### [261] [Time-dependent density estimation using binary classifiers](https://arxiv.org/abs/2506.15505)
*Agnimitra Dasgupta,Javier Murgoitio-Esandi,Ali Fardisi,Assad A Oberai*

Main category: stat.ML

TL;DR: A data-driven method learns time-dependent probability densities of stochastic processes using a novel binary classifier and contrastive estimation, enabling density evaluation and sample synthesis.


<details>
  <summary>Details</summary>
Motivation: To model and evaluate time-dependent probability densities of stochastic processes, especially for complex, multi-modal, and near-degenerate cases, with applications in outlier detection and sample generation.

Method: Uses a time-dependent binary classifier trained with contrastive estimation to discriminate between process realizations at nearby times, approximating the density's time derivative. Stochastic interpolants and gradient-based MCMC are employed for training and sampling.
...
Conclusion: The method effectively models time-dependent densities, enabling applications in sample synthesis and outlier detection, with demonstrated accuracy and scalability.
...
### [262] [Revisiting Randomization in Greedy Model Search](https://arxiv.org/abs/2506.15643)
...
Method: An ensemble of greedy forward selection estimators randomized by feature subsampling, implemented efficiently using dynamic programming.

Result: Outperforms lasso and elastic net, reduces training error and degrees of freedom, and shifts the bias-variance trade-off curve.

Conclusion: Enhances understanding of random forests and suggests implicit regularization has more complex effects than explicit regularization.
...
TL;DR: The paper introduces 'Deformer', a deformable CNN variant, to replace rigid kernels in Conformer, improving speech recognition by adapting to asymmetric patterns.


<details>
  <summary>Details</summary>
Motivation: Traditional CNNs assume symmetric and rigid kernels, limiting their ability to capture asymmetric patterns in speech. The study explores whether asymmetric kernels can enhance feature coupling with attention mechanisms.

Method: The authors replace depthwise CNNs in the Conformer architecture with a deformable counterpart ('Deformer'), analyzing local receptive fields and global attention maps.

Result: Deformer improves speech recognition performance by +5.6% relative WER without LM and +6.4% with LM over the Conformer baseline on WSJ eval92.

Conclusion: Deformer demonstrates the benefits of adaptive, asymmetric kernels in CNNs, enhancing feature associations and performance in speech recognition.
...
TL;DR: Proposes an adaptive masking approach for pruning multilingual ASR models, achieving better performance than existing methods and reducing language-specific pruning needs.


<details>
  <summary>Details</summary>
Motivation: Current pruning methods for multilingual ASR models require multiple rounds of pruning and re-training per language, which is inefficient.

Method: Uses adaptive masking to dynamically adjust sub-networks, avoiding fixed structures, and applies it to create sparse monolingual or multilingual models (Dynamic ASR Pathways).

Result: Outperforms existing pruning methods for sparse monolingual models and discovers better sub-networks for multilingual models, reducing language-specific pruning.

Conclusion: The adaptive approach efficiently prunes multilingual ASR models, improving performance and reducing computational overhead.
...
TL;DR: MixRep is a data augmentation method for low-resource ASR using mixup on hidden representations, outperforming other methods like SpecAugment.


<details>
  <summary>Details</summary>
Motivation: To improve low-resource ASR performance by generalizing mixup-based augmentation to hidden representations and adding time-axis regularization.

Method: MixRep interpolates feature dimensions in neural network layers, combining mixup with time-axis regularization, applied to a Conformer encoder with joint CTC loss.

Result: MixRep achieves +6.5% and +6.7% relative WER reduction on WSJ and SWB datasets compared to SpecAugment.

Conclusion: MixRep is effective for low-resource ASR, outperforming existing regularization methods.
...
### [266] [Thinking in Directivity: Speech Large Language Model for Multi-Talker Directional Speech Recognition](https://arxiv.org/abs/2506.14973)
...
Method: Proposes two techniques: serialized directional output training (S-DOT) and contrastive direction data augmentation (CDDA), leveraging smart glasses' microphone arrays.
...
Conclusion: directional-SpeechLlama demonstrates strong performance in handling directional audio tasks.
...
TL;DR: HAC is a neural speech codec with a hierarchical bottleneck for acoustic, phonetic, and lexical levels, using knowledge distillation for disentangled tokens.
...
Method: HAC factorizes its bottleneck into three linguistic levels and uses knowledge distillation from HuBERT and LaBSE for phoneme and lexical structure.

Result: HAC tokens are disentangled, align with phonemes and word-level semantics, and outperform baselines in reconstruction and interpretability.
...
### [268] [LLM Agent for Hyper-Parameter Optimization](https://arxiv.org/abs/2506.15167)
*Wanzhe Wang,Jianqiu Peng,Menghao Hu,Weihuang Zhong,Tong Zhang,Shuai Wang,Yixin Zhang,Mingjie Shao,Wanli Ni*

Main category: cs.IT

TL;DR: The paper introduces an LLM agent for automated hyper-parameter tuning in WS-PSO-CM algorithms for UAV communication, outperforming heuristic and random methods.
...
Method: An LLM agent is designed with an iterative framework and MCP, driven by prompts to explore and optimize hyper-parameters.
...
### [269] [In-Context Learning for Gradient-Free Receiver Adaptation: Principles, Applications, and Theory](https://arxiv.org/abs/2506.15176)
*Matteo Zecchin,Tomer Raviv,Dileep Kalathil,Krishna Narayanan,Nir Shlezinger,Osvaldo Simeone*

Main category: cs.IT

TL;DR: The paper introduces gradient-free adaptation techniques for deep learning-based wireless receivers using in-context learning (ICL), offering real-time adaptation without online retraining.


<details>
  <summary>Details</summary>
Motivation: Current adaptation strategies for deep learning-based receivers lack flexibility or require explicit optimization, prompting the need for more efficient methods.

Method: The paper reviews ICL frameworks (Transformer and SSMs) and applies ICL to cell-free massive MIMO networks, supported by theoretical and empirical analysis.

Result: ICL proves to be a principled and efficient approach for real-time receiver adaptation using contextual information.

Conclusion: ICL enables dynamic adaptation in wireless receivers without the need for online retraining, addressing limitations of existing methods.
...
### [270] [An accurate and revised version of optical character recognition-based speech synthesis using LabVIEW](https://arxiv.org/abs/2506.15029)
...
<details>
  <summary>Details</summary>
Motivation: Address limitations of Braille and audio recordings by providing a more accessible, cost-effective solution.

Method: Implemented an OCR-based system using LabVIEW for accurate and reliable speech synthesis.

Result: Created a user-friendly system that converts text to speech for easier access to books.

Conclusion: The system offers a practical solution for visually impaired individuals to access written content through speech.
...
### [271] [SonicVerse: Multi-Task Learning for Music Feature-Informed Captioning](https://arxiv.org/abs/2506.15154)
*Anuradha Chopra,Abhinaba Roy,Dorien Herremans*

Main category: cs.SD

TL;DR: SonicVerse is a multi-task music captioning model that generates detailed captions by integrating music feature detection, improving caption quality and detail.


<details>
  <summary>Details</summary>
Motivation: To enrich music databases and advance music AI research by creating detailed captions that reflect both low-level and high-level musical attributes.
...
Result: Incorporating music features improves caption quality and detail, enabling time-informed descriptions for longer music pieces.

Conclusion: SonicVerse effectively combines caption generation with feature detection, enhancing music database enrichment and AI research.
...
### [272] [pycnet-audio: A Python package to support bioacoustics data processing](https://arxiv.org/abs/2506.14864)
...
Method: Deploy ARUs to record audio, then process data using pycnet-audio and PNW-Cnet for automated detection of target signals.

Result: PNW-Cnet detects vocalizations of ~80 species and various anthropogenic/environmental noises, enhancing monitoring efficiency.

Conclusion: pycnet-audio and PNW-Cnet offer a scalable solution for passive acoustic monitoring, improving wildlife research and conservation efforts.
...
### [273] [A Comparative Evaluation of Deep Learning Models for Speech Enhancement in Real-World Noisy Environments](https://arxiv.org/abs/2506.15000)
*Md Jahangir Alam Khondkar,Ajan Ahmed,Masudul Haider Imtiaz,Stephanie Schuckers*

Main category: cs.SD

TL;DR: The paper benchmarks three deep learning models (Wave-U-Net, CMGAN, U-Net) for speech denoising, evaluating their performance in noise suppression, perceptual quality, and speaker feature preservation. U-Net excels in noise suppression, CMGAN in perceptual quality, and Wave-U-Net in speaker feature retention.


<details>
  <summary>Details</summary>
Motivation: Speech enhancement is crucial for real-world applications, but existing models struggle to balance noise suppression, perceptual quality, and speaker-specific feature preservation. This study aims to fill the gap by comparing state-of-the-art models.

Method: The study evaluates Wave-U-Net, CMGAN, and U-Net on datasets like SpEAR, VPQAD, and Clarkson, measuring SNR, PESQ, and VeriSpeak scores to assess noise suppression, perceptual quality, and speaker feature retention, respectively.

Result: U-Net shows high noise suppression (SNR improvements up to +364.2%), CMGAN excels in perceptual quality (PESQ scores up to 4.04), and Wave-U-Net balances attributes with speaker feature retention (VeriSpeak gains up to +27.38%).

Conclusion: The research highlights trade-offs between noise suppression, perceptual quality, and speaker recognition, offering insights for applications like voice biometrics, forensic audio, and telecommunication in noisy environments.
...
### [274] [Diff-TONE: Timestep Optimization for iNstrument Editing in Text-to-Music Diffusion Models](https://arxiv.org/abs/2506.15530)
*Teysir Baoueb,Xiaoyu Bie,Xi Wang,Gaël Richard*

Main category: cs.SD

TL;DR: The paper proposes a method for instrument editing in text-to-music diffusion models without additional training, balancing content preservation and timbre change.


<details>
  <summary>Details</summary>
Motivation: Controlling text-to-music generation for specific outcomes is challenging due to sensitivity to text prompts.

Method: Leverages a pretrained model, using an instrument classifier to select an intermediate timestep for editing.

Result: Achieves desired instrument changes while preserving original audio content, without slowing generation.

Conclusion: Demonstrates effective instrument editing in text-to-music models without extra training or speed trade-offs.
...
### [275] [CNN-Enabled Scheduling for Probabilistic Real-Time Guarantees in Industrial URLLC](https://arxiv.org/abs/2506.14987)
...
<details>
  <summary>Details</summary>
Motivation: Ensuring packet-level communication quality is critical for URLLC in large-scale industrial wireless networks, requiring better interference coordination.
...
Result: Simulations show SINR gains up to 113%, 94%, and 49% over LDP in various network setups.

Conclusion: The approach enhances resource allocation and network performance, proving effective for complex URLLC scenarios.
...
### [276] [GCN-Driven Reinforcement Learning for Probabilistic Real-Time Guarantees in Industrial URLLC](https://arxiv.org/abs/2506.15011)
*Eman Alqudah,Ashfaq Khokhar*
...
<details>
  <summary>Details</summary>
Motivation: To improve packet-level communication quality in URLLC for industrial wireless networks by dynamically learning link priorities.
...
### [277] [Forecasting the spatiotemporal evolution of fluid-induced microearthquakes with deep learning](https://arxiv.org/abs/2506.14923)
*Jaehong Chung,Michael Manga,Timothy Kneafsey,Tapan Mukerji,Mengsu Hu*

Main category: physics.geo-ph

TL;DR: A transformer-based deep learning model forecasts microearthquake (MEQ) evolution during fluid injection, achieving high accuracy for real-time fracture and permeability monitoring.


<details>
  <summary>Details</summary>
Motivation: Forecasting MEQ evolution is crucial for applications like enhanced geothermal systems and CO2 sequestration, as it helps infer stress state and reservoir permeability.
...
Result: Achieves R² >0.98 for 1-second and >0.88 for 15-second forecasts, with uncertainty estimates via learned standard deviation.

Conclusion: Demonstrates deep learning's potential for real-time seismic-risk assessment and mitigation in fluid-injection operations.
...
### [278] [Data analysis using discrete cubical homology](https://arxiv.org/abs/2506.15020)
...
Method: Uses persistence discrete homology to analyze filtrations of graphs derived from pairwise correlations in high-dimensional data.

Result: Demonstrates the tool's effectiveness in applications like weather and financial data analysis, comparing it to standard methods.

Conclusion: Persistence discrete homology offers a promising approach for data analysis, particularly in fields like weather and finance.
...
### [279] [See What I Mean? CUE: A Cognitive Model of Understanding Explanations](https://arxiv.org/abs/2506.14775)
*Tobias Labarta,Nhi Hoang,Katharina Weitz,Wojciech Samek,Sebastian Lapuschkin,Leander Weber*

Main category: cs.HC

TL;DR: The paper introduces CUE, a model for Cognitive Understanding of Explanations, linking explanation properties to cognitive processes. It evaluates heatmaps with different colormaps, finding gaps in confidence/effort for visually impaired users, challenging assumptions about accessibility.


<details>
  <summary>Details</summary>
Motivation: The need for human-understandable explanations in AI systems, especially for visually impaired users, drives the research.

Method: Proposes CUE model and tests it with heatmaps using varying colormaps (BWR, Cividis, Coolwarm) in a study with 455 participants.

Result: Found comparable task performance but lower confidence/effort for visually impaired users, with accessibility-focused colormaps not mitigating gaps.

Conclusion: Highlights the need for adaptive XAI interfaces and validates CUE, contributing a cognitive model, integrated definition of explanation properties, and empirical evidence for user-tailored XAI.
...
### [280] [WebXAII: an open-source web framework to study human-XAI interaction](https://arxiv.org/abs/2506.14777)
*Jules Leguy,Pierre-Antoine Jean,Felipe Torres Figueroa,Sébastien Harispe*

Main category: cs.HC

TL;DR: WebXAII is an open-source web framework for human-XAI interaction research, addressing reproducibility and reusability issues by providing a flexible, configurable platform for experimental protocols.


<details>
  <summary>Details</summary>
Motivation: The rapid expansion of XAI and the lack of shared interfaces in human-XAI interaction studies limit reproducibility and reusability. WebXAII aims to solve this by offering a standardized platform.

Method: WebXAII is a web-based platform with a composite architecture of generic views and modules, defined via structured configuration files, requiring minimal programming skills.

Result: WebXAII successfully reproduces protocols from state-of-the-art studies, demonstrating its effectiveness.

Conclusion: WebXAII provides a reusable, flexible solution for human-XAI interaction research, enhancing reproducibility and accessibility.
...
### [281] [Analyzing Character Representation in Media Content using Multimodal Foundation Model: Effectiveness and Trust](https://arxiv.org/abs/2506.14799)
*Evdoxia Taka,Debadyuti Bhattacharya,Joanne Garde-Hansen,Sanjay Sharma,Tanaya Guha*

Main category: cs.HC

TL;DR: The paper introduces an AI-based tool using CLIP to analyze character representation in media, evaluates its usefulness and trustworthiness via a user study, and finds moderate to low trust in AI results.


<details>
  <summary>Details</summary>
Motivation: To assess the usefulness and trustworthiness of AI-generated character representation analytics for the general public, addressing gaps in past work that lacked audience involvement.

Method: Developed a tool using CLIP to analyze visual screen data for gender and age representation, designed visualizations for lay audiences, and conducted a user study.

Result: Participants found the tool useful but expressed moderate to low trust in AI results, requesting more detailed visualizations and contextual information.

Conclusion: The tool is useful for analyzing character representation, but trust in AI-generated results remains a challenge, highlighting the need for improved transparency and detail.
...
### [282] [The Hardness of Achieving Impact in AI for Social Impact Research: A Ground-Level View of Challenges & Opportunities](https://arxiv.org/abs/2506.14829)
...
Conclusion: The paper provides a practical guide for AI4SI researchers and partners to enhance socially impactful AI collaborations.
...
### [283] [Insights Informed Generative AI for Design: Incorporating Real-world Data for Text-to-Image Output](https://arxiv.org/abs/2506.15008)
*Richa Gupta,Alexander Htet Kyaw*

Main category: cs.HC

TL;DR: A pipeline integrating DALL-E 3 with a materials dataset enriches AI-generated interior designs with sustainability metrics, aiding designers in evaluating environmental impacts. User tests show sustainability metrics improve informed decisions but may cause decision fatigue.
...
Method: Proposes a pipeline combining DALL-E 3 with a materials dataset to add CO2e values to AI-generated designs, evaluated through three user tests with varying sustainability prompts.

Result: Sustainability metrics in outputs lead to more informed decisions but can reduce satisfaction due to decision fatigue. Most users adopted sustainability principles in workflows.

Conclusion: Balancing design freedom with sustainability constraints is key, offering a path to data-driven, ecologically responsible AI-assisted design.
...
### [284] [Mapping Caregiver Needs to AI Chatbot Design: Strengths and Gaps in Mental Health Support for Alzheimer's and Dementia Caregivers](https://arxiv.org/abs/2506.15047)
...
<details>
  <summary>Details</summary>
Motivation: Address the lack of understanding about how caregivers engage with AI for mental health support, given their high stress and emotional challenges.
...
Conclusion: Provides design insights for trustworthy, caregiver-centered AI systems to support mental health.
...
### [285] [Accessible Gesture-Driven Augmented Reality Interaction System](https://arxiv.org/abs/2506.15189)
*Yikan Wang*
...
<details>
  <summary>Details</summary>
Motivation: AR systems often require precise input, excluding users with motor impairments. This work aims to make AR more accessible.
...
Conclusion: The system enhances AR accessibility and scalability, demonstrating the potential of adaptive gesture-based interfaces.
...
### [286] [Impact of a Deployed LLM Survey Creation Tool through the IS Success Model](https://arxiv.org/abs/2506.14809)
...
<details>
  <summary>Details</summary>
Motivation: To reduce the labor-intensive process of creating high-quality surveys in IS research by leveraging LLMs, while ensuring quality and addressing deployment complexities.

Method: Deployment of an LLM-powered system for survey generation, evaluated using the DeLone and McLean IS Success Model, with a hybrid framework combining automated and human assessments.

Result: The study demonstrates the feasibility of using generative AI for survey creation, proposes a hybrid evaluation framework, and implements safeguards for responsible integration.

Conclusion: Generative AI can reshape IS survey methods, but requires careful evaluation and safeguards for successful and responsible deployment.
...
### [287] [Navigating High-Dimensional Backstage: A Guide for Exploring Literature for the Reliable Use of Dimensionality Reduction](https://arxiv.org/abs/2506.14820)
...
<details>
  <summary>Details</summary>
Motivation: The diversity and extensiveness of DR literature can confuse novice analysts and researchers, making it hard to know where to start.

Method: The guide classifies existing literature and helps users assess their DR expertise and identify relevant papers.

Result: Interview studies with three DR and visualization experts validated the guide's significance, comprehensiveness, and usefulness.

Conclusion: The proposed guide aids practitioners in navigating DR literature effectively, enhancing their understanding and reliability in visual analytics.
...
### [288] [Co-Creative Learning via Metropolis-Hastings Interaction between Humans and AI](https://arxiv.org/abs/2506.15468)
*Ryota Okumura,Tadahiro Taniguchi,Akira Taniguchi,Yoshinobu Hagiwara*

Main category: cs.HC

TL;DR: The paper introduces co-creative learning, where humans and AI integrate partial information to form shared representations, tested via a human-AI interaction model (MHNG). Results show improved accuracy and shared sign systems with MH-based agents.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of integrating information from different modalities in human-AI interaction, moving beyond unilateral knowledge transfer.

Method: Empirical testing using the Metropolis-Hastings naming game (MHNG) in an online experiment with 69 participants interacting with AI agents.

Result: Human-AI pairs with MH-based agents improved categorization accuracy and achieved stronger convergence toward shared sign systems. Human behavior aligned with MH-derived probabilities.

Conclusion: Co-creative learning via MHNG shows promise for symbiotic AI systems that learn with humans, aligning perceptual experiences dynamically.
...
TL;DR: The paper proposes integrating GPT-based models with LangChain to improve remote learning resource retrieval, focusing on contextual relevance and precision.
...
Method: The approach integrates GPT-based models within LangChain, utilizing CoT reasoning and prompt engineering for intuitive and productive retrieval.

Result: The framework enhances precision and relevance of retrieval results, improving user satisfaction and learning outcomes compared to paradigmatic LLMs.

Conclusion: The proposed system successfully addresses the limitations of current retrieval methods, offering contextually enriched resources tailored to student needs.
...
### [290] [A Data-Integrated Framework for Learning Fractional-Order Nonlinear Dynamical Systems](https://arxiv.org/abs/2506.15665)
...
Conclusion: Fractional-order models are superior for dynamics with long-range dependencies, validating the proposed framework.
...
### [291] [Collaborative Interest-aware Graph Learning for Group Identification](https://arxiv.org/abs/2506.14826)
*Rui Zhao,Beihong Jin,Beibei Li,Yiyuan Zheng*

Main category: cs.SI

TL;DR: CI4GI is a model for group identification that addresses the collaborative evolution of group-level and item-level user interests, outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Existing group identification methods fail to model the collaborative evolution of dual-level user interests and suffer from false-negative samples.

Method: CI4GI introduces an interest enhancement strategy and optimizes negative sample identification to align cross-level interests.

Result: Experiments on three datasets show CI4GI significantly outperforms state-of-the-art models.

Conclusion: CI4GI effectively models the dynamic alignment of dual-level interests, improving group recommendation accuracy.
...
### [292] [Detecting Narrative Shifts through Persistent Structures: A Topological Analysis of Media Discourse](https://arxiv.org/abs/2506.14836)
*Mark M. Bailey,Mark I. Heiligman*

Main category: cs.SI

TL;DR: A topological framework using persistent homology detects structural changes in media narratives during major global events, revealing patterns of semantic disruption and narrative volatility.
...
Result: Major events correlate with spikes in H0 (connected components) and H1 (loops), showing narrative reorganization. Cross-correlation reveals H0 changes precede H1 shifts, except during the Russian invasion of Ukraine.

Conclusion: Persistent homology provides an unsupervised, principled method for detecting inflection points in public discourse, advancing real-time crisis monitoring in computational social science.
...
### [293] [Human Motion Capture from Loose and Sparse Inertial Sensors with Garment-aware Diffusion Models](https://arxiv.org/abs/2506.15290)
*Andela Ilic,Jiaxi Jiang,Paul Streli,Xintong Liu,Christian Holz*

Main category: cs.GR

TL;DR: A method for full-body pose estimation using loosely attached IMUs, leveraging transformer-based diffusion models and garment-aware training.


<details>
  <summary>Details</summary>
Motivation: Address the gap in existing IMU-based motion capture, which assumes tight sensor attachment, by tackling the real-world challenge of loose sensors.

Method: Simulate IMU data from a garment-aware dataset, develop transformer-based diffusion models for pose estimation, and incorporate garment parameters during training.

Result: Outperforms state-of-the-art methods in accuracy and expressiveness, especially with loose garments.

Conclusion: Proposes a promising approach for robust motion capture with loose IMUs, enhancing real-world applicability.
...
### [294] [One-shot Face Sketch Synthesis in the Wild via Generative Diffusion Prior and Instruction Tuning](https://arxiv.org/abs/2506.15312)
*Han Wu,Junyao Li,Kangbo Zhao,Sen Zhang,Yukai Shi,Liang Lin*

Main category: cs.GR

TL;DR: A one-shot face sketch synthesis method using diffusion models is proposed, addressing data scarcity and high labor costs in traditional methods.


<details>
  <summary>Details</summary>
Motivation: Existing methods rely on large datasets, which are scarce and costly. The proposed method aims to work with minimal training data.
...
### [295] [Nabla-R2D3: Effective and Efficient 3D Diffusion Alignment with 2D Rewards](https://arxiv.org/abs/2506.15684)
*Qingming Liu,Zhen Liu,Dinghuai Zhang,Kui Jia*

Main category: cs.GR

TL;DR: Nabla-R2D3 is a reinforcement learning framework for aligning 3D diffusion models with 2D rewards, improving quality and realism over vanilla methods.


<details>
  <summary>Details</summary>
Motivation: Current 3D generative models lack alignment with human preferences and realism, despite advances in diffusion models.

Method: Nabla-R2D3 uses reinforcement learning to adapt 3D diffusion models with 2D rewards, building on Nabla-GFlowNet for principled reward finetuning.

Result: The framework outperforms baselines, achieving higher rewards and reduced prior forgetting efficiently.

Conclusion: Nabla-R2D3 offers a sample-efficient solution for enhancing 3D asset generation quality.
...
### [296] [Identifiability by common backdoor in summary causal graphs of time series](https://arxiv.org/abs/2506.14862)
*Clément Yvernes,Charles K. Assaad,Emilie Devijver,Eric Gaussier*

Main category: math.ST

TL;DR: The paper studies the identifiability problem for interventions in time series using summary causal graphs, focusing on conditions for identifiability via a common backdoor set and providing decision algorithms.


<details>
  <summary>Details</summary>
Motivation: To assess whether total effects of interventions can be computed from observational data alone, especially in time series with abstracted causal graphs.

Method: Analyzes identifiability via a common backdoor set, considering time series with and without temporal consistency, and develops algorithms to decide identifiability.

Result: Establishes conditions for identifiability and provides algorithms to determine it.

Conclusion: The study advances understanding of intervention identifiability in time series with abstracted causal graphs, offering practical tools for decision-making.
...
### [297] [Omnidirectional Video Super-Resolution using Deep Learning](https://arxiv.org/abs/2506.14803)
*Arbind Agrahari Baniya,Tsz-Kwan Lee,Peter W. Eklund,Sunil Aryal*

Main category: cs.MM

TL;DR: The paper introduces a novel 360° Video Dataset (360VDS) and a deep learning model (S3PO) for super-resolution, addressing distortion and limited datasets in 360° videos.


<details>
  <summary>Details</summary>
Motivation: The limited resolution and distortion in 360° videos hinder immersive VR experiences, and existing VSR techniques fail to address these issues.

Method: The paper proposes S3PO, a recurrent model with attention, a custom feature extractor, and a novel loss function for spherical distortion.

Result: S3PO outperforms state-of-the-art VSR and 360°-specific models on 360° video datasets.

Conclusion: The study demonstrates the effectiveness of S3PO and provides insights into architectural choices for 360° video super-resolution.
...
### [298] [Feedback-MPPI: Fast Sampling-Based MPC via Rollout Differentiation -- Adios low-level controllers](https://arxiv.org/abs/2506.14855)
*Tommaso Belvedere,Michael Ziegltrum,Giulio Turrisi,Valerio Modugno*

Main category: cs.RO

TL;DR: F-MPPI enhances MPPI with local feedback gains for faster, stable robotic control in real-time scenarios.


<details>
  <summary>Details</summary>
Motivation: Standard MPPI's computational demands limit its real-time applicability in high-frequency robotic tasks.

Method: F-MPPI integrates local linear feedback gains from sensitivity analysis, avoiding full re-optimization.

Result: Improved control performance and stability in simulations and real-world tests on quadruped and quadrotor robots.

Conclusion: F-MPPI enables robust, high-frequency control for complex robotic systems.
...
### [299] [FEAST: A Flexible Mealtime-Assistance System Towards In-the-Wild Personalization](https://arxiv.org/abs/2506.14968)
...
TL;DR: FEAST is a flexible mealtime-assistance system designed for in-the-wild personalization, addressing diverse user needs through adaptability, transparency, and safety.


<details>
  <summary>Details</summary>
Motivation: To improve quality of life for care recipients by enabling personalized meal assistance in diverse real-world contexts.

Method: Developed with community researchers, FEAST uses modular hardware, diverse interaction methods, and parameterized behavior trees adaptable via a large language model.

Result: FEAST outperforms fixed-customization baselines and successfully meets individual needs in real-world user studies.

Conclusion: FEAST demonstrates effective in-the-wild personalization, offering practical and adaptable meal assistance for diverse users.
...
### [300] [Towards Perception-based Collision Avoidance for UAVs when Guiding the Visually Impaired](https://arxiv.org/abs/2506.14857)
*Suman Raj,Swapnil Padhi,Ruchi Bhoot,Prince Modi,Yogesh Simmhan*

Main category: cs.RO

TL;DR: A drone-based system assists visually impaired people (VIPs) in outdoor navigation using onboard sensors, machine learning, and computer vision, integrating local and global planning.


<details>
  <summary>Details</summary>
Motivation: To enhance VIPs' independence in urban navigation by leveraging drones with advanced perception and planning algorithms.

Method: Combines a geometric formulation with a multi-DNN framework for obstacle avoidance, integrating local (perception-based) and global (GPS/map-based) planning.

Result: Feasibility verified in three scenarios: footpath walking, near parked vehicles, and crowded streets.

Conclusion: The proposed system effectively aids VIP navigation in urban environments, demonstrating practical applicability.
...
### [301] [Robust Instant Policy: Leveraging Student's t-Regression Model for Robust In-context Imitation Learning of Robot Manipulation](https://arxiv.org/abs/2506.15157)
*Hanbit Oh,Andrea M. Salcedo-Vázquez,Ixchel G. Ramirez-Alpizar,Yukiyasu Domae*

Main category: cs.RO

TL;DR: The paper introduces Robust Instant Policy (RIP), a method to improve reliability in In-Context Imitation Learning by mitigating LLM hallucination issues.


<details>
  <summary>Details</summary>
Motivation: Address the unreliability of LLM-based instant policies in robotics due to hallucinated trajectories.

Method: Uses Student's t-regression to aggregate candidate trajectories from LLMs, ignoring outliers.

Result: RIP improves task success rates by at least 26% over state-of-the-art methods.

Conclusion: RIP is effective for robust trajectory generation in low-data scenarios.
...
### [302] [MCOO-SLAM: A Multi-Camera Omnidirectional Object SLAM System](https://arxiv.org/abs/2506.15402)
*Miaoxin Pan,Jinnan Li,Yaowen Zhang,Yi Yang,Yufeng Yue*

Main category: cs.RO

TL;DR: MCOO-SLAM is a Multi-Camera Omnidirectional Object SLAM system that uses surround-view cameras for robust, consistent, and semantically enriched mapping in outdoor scenarios, outperforming traditional RGB-D or monocular approaches.


<details>
  <summary>Details</summary>
Motivation: Existing SLAM systems rely on RGB-D or monocular sensors, which have limitations like narrow fields of view, occlusion sensitivity, and poor depth perception, leading to inaccurate object modeling.

Method: MCOO-SLAM integrates point features and object-level landmarks with open-vocabulary semantics, uses a semantic-geometric-temporal fusion strategy for robust object association, and includes an omnidirectional loop closure module for viewpoint-invariant place recognition.

Result: The system achieves accurate localization and scalable object-level mapping with improved robustness to occlusion, pose variation, and environmental complexity.

Conclusion: MCOO-SLAM provides a robust and semantically enriched solution for object-level SLAM in complex outdoor environments.
...
### [303] [Particle-Grid Neural Dynamics for Learning Deformable Object Models from RGB-D Videos](https://arxiv.org/abs/2506.15680)
*Kaifeng Zhang,Baoyu Li,Kris Hauser,Yunzhu Li*

Main category: cs.RO

TL;DR: A neural dynamics framework combines particles and spatial grids to model deformable objects, outperforming existing methods in limited-view scenarios and enabling goal-conditioned manipulation.
...
Conclusion: The framework effectively models deformable objects and supports practical applications like manipulation tasks.
...
### [304] [Context-Aware Deep Lagrangian Networks for Model Predictive Control](https://arxiv.org/abs/2506.15249)
*Lucas Schulze,Jan Peters,Oleg Arenz*

Main category: cs.RO

TL;DR: The paper extends deep Lagrangian networks (DeLaN) for context-aware, physics-informed robot control, integrating it with MPC and residual dynamics, reducing tracking error by 39%.
...
Method: Extends DeLaN for context-awareness, combines it with a recurrent network for online system identification, integrates with MPC, and adds residual dynamics.

Result: Achieves 39% reduction in end-effector tracking error, outperforming a baseline with 21% improvement.

Conclusion: The approach enables adaptive, physics-informed control in complex environments, significantly improving performance.
...
### [305] [DisProtEdit: Exploring Disentangled Representations for Multi-Attribute Protein Editing](https://arxiv.org/abs/2506.14853)
*Max Ku,Sun Sun,Hongyu Guo,Wenhu Chen*

Main category: q-bio.QM

TL;DR: DisProtEdit is a protein editing framework using dual-channel text supervision for disentangled structural/functional control, outperforming joint embedding methods in interpretability and controllability.
...
Method: Uses SwissProtDis dataset with dual-text descriptions, alignment/uniformity objectives, and disentanglement loss. Edits proteins by modifying text inputs.

Result: Competes with existing methods, achieves 61.7% success in multi-attribute editing, showing effective coordination of structural/functional edits.

Conclusion: DisProtEdit offers improved interpretability and controllability in protein editing, validated by benchmarks.
...
### [306] [Scaling Intelligence: Designing Data Centers for Next-Gen Language Models](https://arxiv.org/abs/2506.15006)
*Jesmin Jahan Tithi,Hanjiang Wu,Avishaii Abuhatzera,Fabrizio Petrini*

Main category: cs.AR

TL;DR: A co-design framework for data center architecture to support large-scale LLMs, focusing on scalability, efficiency, and cost-effectiveness, with transformative impact from FullFlat networks.


<details>
  <summary>Details</summary>
Motivation: The rapid growth of LLMs like GPT-4 necessitates rethinking data center architecture to handle scalability, efficiency, and cost challenges.

Method: Introduces a co-design framework evaluating FLOPS, HBM bandwidth, network topologies, scale-out domains, and parallelism strategies. Validates performance modeling tools and FullFlat networks.

Result: Demonstrates FullFlat networks' benefits, quantifies overlapping compute/communication, and reveals design impacts on Model FLOPS Utilization (MFU) and throughput.

Conclusion: Provides actionable insights for designing efficient AI data centers to support trillion-parameter models and sustain AI evolution.
...
### [307] [J3DAI: A tiny DNN-Based Edge AI Accelerator for 3D-Stacked CMOS Image Sensor](https://arxiv.org/abs/2506.15316)
...
<details>
  <summary>Details</summary>
Motivation: To enable efficient, real-time, and low-latency AI processing on resource-constrained edge devices like CMOS image sensors.

Method: Utilizes a DNN-based accelerator integrated into a 3D-stacked CMOS image sensor, supported by the Aidge software framework for programming and post-training quantization.

Result: Demonstrates versatility and efficiency in handling both simple and computationally intensive edge AI tasks.

Conclusion: J3DAI shows promise for advancing edge AI, with future work aimed at further optimization and exploring new applications.
...
### [308] [Beyond Force Metrics: Pre-Training MLFFs for Stable MD Simulations](https://arxiv.org/abs/2506.14850)
*Shagun Maheshwari,Janghoon Ock,Adeesh Kolluru,Amir Barati Farimani,John R. Kitchin*

Main category: physics.chem-ph

TL;DR: GemNet-T, a graph neural network, is used as an MLFF for MD simulations. Pre-training on OC20 before fine-tuning on MD17 improves simulation stability more than direct training, despite similar force MAEs.
...
Method: Two training strategies: (1) direct training on MD17, and (2) pre-training on OC20 followed by fine-tuning on MD17. GemNet-T is used as the MLFF model.

Result: Both methods achieve low force MAEs (~5 meV/A per atom), but pre-training yields significantly longer stable MD trajectories (up to 3x longer).

Conclusion: Pre-training on large datasets enhances simulation stability, and force MAE alone is insufficient to predict MD stability.
...
### [309] [Proximal Operators of Sorted Nonconvex Penalties](https://arxiv.org/abs/2506.15315)
*Anne Gagneux,Mathurin Massias,Emmanuel Soubies*

Main category: math.OC

TL;DR: The paper explores sparse signal recovery using sorted nonsmooth penalties for generalized linear models, focusing on nonconvex penalties to reduce coefficient shrinkage and promote variable clustering. It provides efficient proximal operator computations for weakly convex and nonconvex cases, demonstrating practical utility.


<details>
  <summary>Details</summary>
Motivation: The study aims to address sparse signal recovery with automatic variable grouping, leveraging sorted nonconvex penalties to balance clustering and shrinkage reduction.

Method: The approach involves sorted nonsmooth penalties, distinguishing weakly convex (e.g., sorted MCP, SCAD) and nonconvex (e.g., sorted Lq) cases. The Pool Adjacent Violators (PAV) algorithm is adapted for proximal operator computation.

Result: Efficient proximal operator computations are achieved for both weakly convex and nonconvex cases, with theoretical insights on nonconvex minimizers. Practical experiments validate the approach.

Conclusion: Sorted nonconvex penalties are effective for sparse signal recovery, with efficient proximal operator methods enabling their use in composite optimization problems.
...
### [310] [Multi-Timescale Gradient Sliding for Distributed Optimization](https://arxiv.org/abs/2506.15387)
*Junhui Zhang,Patrick Jaillet*

Main category: math.OC

TL;DR: Proposes MT-GS and AMT-GS methods for distributed convex optimization, reducing communication rounds by leveraging similarities between local objectives. Achieves optimal dependency on solution accuracy.


<details>
  <summary>Details</summary>
Motivation: Address the challenge of reducing communication rounds in distributed optimization by exploiting similarities between local objectives and enabling flexible communication rates.

Method: Uses a block-decomposable primal-dual formulation and multi-timescale sliding method, updating dual blocks at varying rates.

Result: MT-GS requires O(𝑟̅A/𝜖) rounds and O(𝑟̅/𝜖²) subgradient steps; AMT-GS needs O(𝑟̅A/√(𝜖𝜇)) rounds and O(𝑟̅/(𝜖𝜇)) steps for strongly convex objectives.

Conclusion: The methods achieve optimal communication round dependency on solution accuracy, answering an open question for non-smooth objectives.
...
### [311] [PFMBench: Protein Foundation Model Benchmark](https://arxiv.org/abs/2506.14796)
...
<details>
  <summary>Details</summary>
Motivation: The field of protein foundation models lacks a unified benchmark for fair evaluation and understanding of model performance across diverse tasks.

Method: The study presents PFMBench, evaluating 17 state-of-the-art models on 38 tasks spanning 8 key areas of protein science.

Result: PFMBench reveals task correlations, identifies top-performing models, and provides a streamlined evaluation protocol.

Conclusion: PFMBench fills a critical gap in protein foundation model research by enabling comprehensive and fair evaluations.
...
### [312] [Next-Generation Conflict Forecasting: Unleashing Predictive Patterns through Spatiotemporal Learning](https://arxiv.org/abs/2506.14817)
*Simon P. von der Maase*

Main category: stat.OT

TL;DR: A novel neural network architecture forecasts three types of violence (state-based, non-state, one-sided) at high resolution, achieving state-of-the-art performance with uncertainty quantification.


<details>
  <summary>Details</summary>
Motivation: Forecasting violent conflict at high spatial and temporal resolution is critical for researchers and policymakers but remains challenging.

Method: The model uses a Monte Carlo Dropout LSTM U-Net, combining convolutional and recurrent layers to capture spatiotemporal patterns without manual feature engineering.

Result: It outperforms existing methods, providing probabilistic estimates and expected magnitudes of future violence, along with uncertainty quantification.

Conclusion: The model is extensible, suitable for early warning systems, humanitarian planning, and peacebuilding, due to its adaptability and performance.
...
### [313] [An Empirical Study of Bugs in Data Visualization Libraries](https://arxiv.org/abs/2506.15084)
*Weiqi Lu,Yongqiang Tian,Xiaohan Zhong,Haoyang Ma,Zhenyang Xu,Shing-Chi Cheung,Chengnian Sun*

Main category: cs.SE

TL;DR: The study analyzes bugs in DataViz libraries, identifying symptoms, root causes, and a taxonomy, with incorrect plots being common. It explores automated testing and VLMs for bug detection.
...
Method: Analysis of 564 bugs from five DataViz libraries, focusing on symptoms, root causes, and taxonomy. Exploration of VLMs for bug detection.

Result: Incorrect plots are pervasive, with incorrect graphic computation as the major cause. VLMs' bug detection effectiveness varies (29%-57%).

Conclusion: The study highlights the need for better automated testing in DataViz libraries and explores VLMs' potential, though their effectiveness is limited.
...
### [314] [Uncovering Intention through LLM-Driven Code Snippet Description Generation](https://arxiv.org/abs/2506.15453)
*Yusuf Sulistyo Nugroho,Farah Danisha Salam,Brittany Reid,Raula Gaikovina Kula,Kazumasa Shimari,Kenichi Matsumoto*

Main category: cs.SE

TL;DR: The paper investigates developer descriptions for code snippets and evaluates Llama's ability to generate such descriptions, finding alignment with manual classifications but room for improvement in relevance.


<details>
  <summary>Details</summary>
Motivation: To understand common developer descriptions for code snippets and assess LLM (Llama) support for generating them, given the importance of clear documentation for APIs and third-party libraries.
...
Result: 55.5% of original descriptions were example-based; Llama matched this (79.75%). Generated descriptions had a 0.7173 average similarity score, indicating relevance but gaps.

Conclusion: Description intent varies by snippet task (usage, installation, learning). LLMs like Llama show promise but need refinement for higher relevance.
...
### [315] [OS-Harm: A Benchmark for Measuring Safety of Computer Use Agents](https://arxiv.org/abs/2506.14866)
*Thomas Kuntz,Agatha Duzan,Hao Zhao,Francesco Croce,Zico Kolter,Nicolas Flammarion,Maksym Andriushchenko*

Main category: cs.SE

TL;DR: The paper introduces OS-Harm, a benchmark for evaluating the safety of LLM-based computer use agents, covering misuse, prompt injections, and model misbehavior.


<details>
  <summary>Details</summary>
Motivation: Safety of computer use agents is overlooked despite their growing popularity, necessitating a framework to assess harmful behaviors.

Method: OS-Harm benchmark with 150 tasks across safety violations, tested on OSWorld environment, and an automated judge for evaluation.

Result: Models like o4-mini, Claude 3.7 Sonnet, and Gemini 2.5 Pro show vulnerabilities to misuse, prompt injections, and unsafe actions.

Conclusion: OS-Harm provides a critical tool for assessing agent safety, revealing gaps in current models' resilience to harmful behaviors.
...
### [316] [SimBank: from Simulation to Solution in Prescriptive Process Monitoring](https://arxiv.org/abs/2506.14772)
...
Method: SimBank simulates a bank's loan application process, supporting online and offline PresPM methods, diverse intervention problems, and causal ML challenges like confounding robustness.

Result: SimBank generates true outcomes for interventions, handles parallel activities and loops, and closely mimics real-life processes, proving its benchmarking utility.
...
### [317] [Advancing Loss Functions in Recommender Systems: A Comparative Study with a Rényi Divergence-Based Solution](https://arxiv.org/abs/2506.15120)
*Shengjia Zhang,Jiawei Chen,Changdong Li,Sheng Zhou,Qihao Shi,Yan Feng,Chun Chen,Can Wang*

Main category: cs.IR

TL;DR: The paper explores Softmax Loss (SL) and Cosine Contrastive Loss (CCL) in recommendation models, highlighting their strengths and limitations, and proposes a new loss function, DrRL, to address these issues.
...
Method: Comprehensive analysis of SL and CCL, identifying their strengths and limitations, followed by the proposal of DrRL, which leverages Rényi-divergence in DRO optimization.

Result: DrRL generalizes SL and CCL, mitigates their limitations, and shows superior performance in recommendation accuracy and robustness.

Conclusion: DrRL is an effective solution combining the strengths of SL and CCL while addressing their weaknesses, validated through extensive experiments.
...
### [318] [Extending Spike-Timing Dependent Plasticity to Learning Synaptic Delays](https://arxiv.org/abs/2506.14984)
*Marissa Dominijanni,Alexander Ororbia,Kenneth W. Regan*

Main category: cs.NE

TL;DR: A novel learning rule for SNNs simultaneously learns synaptic strengths and delays, outperforming existing methods and providing insights into synaptic efficacy and delay interplay.


<details>
  <summary>Details</summary>
Motivation: Synaptic delays are biologically significant but often omitted in SNNs. This work aims to bridge this gap by integrating delays into learning.

Method: Extends STDP to co-learn synaptic weights and delays, validated on an SNN model for unsupervised classification.

Result: The proposed method consistently outperforms existing approaches, including STDP without delays.

Conclusion: The study highlights the importance of synaptic delays in SNNs and offers a biologically inspired learning rule for improved performance.
...
<details>
  <summary>Details</summary>
Motivation: To address the gap in semantic understanding of existing NLP pipelines for economic narrative extraction.

Method: Compare GPT-4o outputs to expert-annotated gold-standard narratives from Wall Street Journal and New York Times articles.

Result: GPT-4o extracts valid economic narratives but underperforms on complex documents.
