...
TL;DR: The paper proposes SemIRNet, a model for multimodal irony detection, introducing ConceptNet, cross-modal semantic similarity modules, and contrastive learning to improve accuracy and F1 scores.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of accurately identifying graphical implicit correlations in multimodal irony detection tasks.
...
Result: Achieves 88.87% accuracy and 86.33% F1 score, outperforming existing methods by 1.64% and 2.88%.

Conclusion: Knowledge fusion and semantic similarity detection significantly enhance model performance, as validated by ablation experiments.
...
<details>
  <summary>Details</summary>
Motivation: Despite progress in MLLMs, challenges remain in visual fine-grained perception and commonsense causal inference. This paper aims to address these gaps.

Method: Developed Argus Inspection (a multimodal benchmark) and the Eye of Panoptes framework, integrating a Sigmoid metric for holistic evaluation of MLLMs.

Result: Experiments on 26 MLLMs showed the highest performance in visual fine-grained reasoning was only 0.46, indicating substantial potential for improvement.

Conclusion: The research provides insights for refining MLLMs, highlighting the need for better visual and causal reasoning capabilities.
...
TL;DR: A hybrid AI model combining ConvNeXt and EfficientNet is proposed for classifying falcon diseases, outperforming traditional methods and individual models.


<details>
  <summary>Details</summary>
Motivation: Falconry requires precise health monitoring for falcons, especially in hunting scenarios, necessitating accurate disease detection.

Method: The study uses a hybrid of ConvNeXt and EfficientNet models to classify falcon diseases (Normal, Liver Disease, Aspergillosis) using a large dataset, evaluating performance via accuracy, precision, recall, and F1-score.

Result: The hybrid AI model outperforms traditional diagnostic methods and standalone models in disease classification.
...
Method: ViLLa integrates a visual detection module, a language parser, and a symbolic reasoning layer to ground visual detections into symbolic facts and apply logic-based inference for query answering.
...
Conclusion: ViLLa offers a modular and interpretable alternative to end-to-end models, effectively combining perception, understanding, and reasoning for animal monitoring.
...
Conclusion: GraphGSOcc effectively enhances semantic and geometric feature aggregation, improving accuracy and efficiency in 3D occupancy prediction.
...
TL;DR: DAVID-X introduces a dataset with detailed annotations for AI-generated videos, and DAVID-XR1 is a model providing interpretable reasoning for detection.


<details>
  <summary>Details</summary>
Motivation: The need for reliable, explainable detection of AI-generated videos due to their growing prevalence and the limitations of existing binary classification methods.

Method: Creation of DAVID-X dataset with defect-level annotations and DAVID-XR1 model for interpretable reasoning, including defect categorization and natural language explanations.
...
Conclusion: Explainable detection methods like DAVID-XR1 offer a transparent and trustworthy approach to identifying AI-generated videos.
...
TL;DR: A survey of recent deep learning-based multi-agent trajectory prediction methods (2020-2024), focusing on architectural designs, input representations, and prediction strategies, with insights from ETH/UCY benchmarks and future research directions.
...
Method: Review and categorization of recent studies based on architectural design, input representations, and prediction strategies, with emphasis on ETH/UCY benchmarks.

Result: Identified key advancements and trends in multi-agent trajectory prediction, along with challenges and future directions.

Conclusion: The survey provides a comprehensive overview of the field, highlighting progress and open questions in multi-agent HTP.
...
Method: Built ArchForms-4000 dataset and proposed ArchShapeNet, a 3D CNN with a saliency module, for classification and analysis.

Result: The model achieved 94.29% accuracy, 96.2% precision, and 98.51% recall, outperforming human experts.
...
Result: Achieves sub-50ms end-to-end latency, over 92% detection accuracy, and robustness to varying conditions (lighting, backgrounds, speeds). Validated through comparative and ablation experiments.
...
TL;DR: MonoVQD introduces a novel DETR-based framework for monocular 3D detection, addressing limitations with Mask Separated Self-Attention, Variational Query Denoising, and self-distillation, achieving superior performance on KITTI and nuScenes benchmarks.


<details>
  <summary>Details</summary>
Motivation: Direct application of DETR-like architectures in monocular 3D detection faces inherent limitations, prompting the need for a more advanced framework to improve performance.
...
Result: MonoVQD achieves superior performance on the KITTI benchmark and demonstrates robust generalization on the nuScenes dataset.

Conclusion: MonoVQD advances monocular 3D detection with its innovative techniques, showing broad applicability and significant performance gains.
...
<details>
  <summary>Details</summary>
Motivation: MLLMs struggle with chart-to-code generation due to the need for precise visual understanding and accurate code translation. Direct prompting yields suboptimal results.

Method: ChartIR decomposes the task into visual understanding (using description and difference instructions) and code translation, followed by iterative refinement.
...
Method: Systematically analyzes visual encoder types, pretraining objectives, and fine-tuning strategies.

Result: Outperforms existing ICL-based FSIC models on out-of-domain benchmarks while matching in-domain performance.
...
Method: BKSEF integrates information theory, signal processing, and learning theory to determine kernel sizes.

Result: Experiments show up to 3.1% accuracy improvement and 42.8% FLOPs reduction. Case studies confirm real-world applicability.

Conclusion: BKSEF offers a practical, theory-backed approach for CNN optimization, suitable for diverse applications.
...
<details>
  <summary>Details</summary>
Motivation: Manual video annotation in retail is time-consuming and costly, requiring a more efficient solution.

Method: Uses deep neural networks for key-frame identification and object detection tailored for retail environments.
...
TL;DR: A novel active view selection (AVS) method, UPNet, uses neural uncertainty maps to select the most informative viewpoints for 3D reconstruction, achieving high accuracy with fewer views and significant computational savings.


<details>
  <summary>Details</summary>
Motivation: The challenge of identifying the minimal set of views for accurate 3D reconstruction in computer vision, avoiding redundant viewpoints and reducing computational costs.

Method: UPNet, a lightweight neural network, predicts uncertainty maps from a single input image to guide viewpoint selection, leveraging heuristics from natural objects. Selected viewpoints are used to train 3D neural rendering models.

Result: Achieves comparable reconstruction accuracy with half the viewpoints, 400x speedup, and over 50% reductions in CPU, RAM, and GPU usage compared to baselines. Generalizes to novel object categories without additional training.

Conclusion: UPNet's efficient and generalizable approach to AVS improves 3D reconstruction accuracy while drastically reducing computational overhead.
...
<details>
  <summary>Details</summary>
Motivation: To improve alignment in T2I models for better user intent capture, safety, and fairness by extending DPO techniques from LLMs.

Method: Proposes DPO-Kernels with Hybrid Loss, Kernelized Representations, and Divergence Selection. Introduces DETONATE benchmark and AQI measure.

Result: DPO-Kernels show improved alignment and robustness, validated by DETONATE and AQI.

Conclusion: DPO-Kernels enhance T2I model alignment, with DETONATE and AQI providing tools for evaluating and improving fairness and safety.
...
TL;DR: The paper proposes PeRL, a reinforcement learning approach for interleaved multimodal tasks, improving learning efficiency and performance on multi-image benchmarks.


<details>
  <summary>Details</summary>
Motivation: Existing multimodal reinforcement learning struggles with complex multi-image positional reasoning, prompting the need for a more general approach.

Method: Introduces permutation of image sequences and a rollout filtering mechanism to enhance exploration-exploitation trade-off.

Result: PeRL outperforms baselines on multi-image benchmarks while maintaining performance on single-image tasks.

Conclusion: PeRL is effective for interleaved multimodal reasoning, achieving state-of-the-art results.
...
Method: Analyzes the reverse diffusion process, computes mid-frequency reconstruction error, and uses structural similarity index scores to determine membership by comparing to a threshold.
...
<details>
  <summary>Details</summary>
Motivation: Improving jet tagging in high-energy physics is crucial for new physics searches and precision measurements at the Large Hadron Collider.

Method: Uses simulated 2012 CMS Open Data to construct multi-channel jet-view images and evaluates ViT and hybrid models.
...
Conclusion: The study establishes a framework for using ViT architectures in jet classification and provides a dataset for future research.
...
TL;DR: The paper proposes two models (LRCNs and Transformer-based) using RGB tactile images from GelSight to improve compliance prediction accuracy, outperforming baselines and highlighting challenges with harder objects.


<details>
  <summary>Details</summary>
Motivation: Traditional compliance detection methods lack portability, scalability, and accuracy, while existing neural network approaches using tactile sensors still underperform.

Method: Two models—LRCNs and Transformer architectures—are developed, leveraging RGB tactile images and GelSight sensor data to predict compliance metrics.

Result: The models show significant performance improvement over baselines, with validation confirming their accuracy in compliance estimation. Harder objects pose greater challenges.

Conclusion: The proposed models enhance compliance prediction accuracy, though harder objects remain difficult to estimate, suggesting areas for future improvement.
...
<details>
  <summary>Details</summary>
Motivation: Historical maps contain valuable georeferenced text, but extraction is hindered by lack of effective methods and training data, especially for varied map styles.
...
Result: PALETTE with SynthMap+ outperforms SOTA text spotters on benchmark datasets, excelling in long and angled text extraction.

Conclusion: PALETTE successfully addresses historical map text extraction challenges, demonstrated by its performance and deployment on the David Rumsey collection.
...
Method: 1. Semantic-based style injection using BLIP and CLIP to align text descriptions with style images. 2. Data augmentation with human feedback for progressive learning. 3. Training-free triple diffusion process for feature manipulation.

Result: Achieves high-quality image-driven style transfer, text-driven stylization, and image color editing while preserving original content.

Conclusion: StyleWallfacer revolutionizes style transfer by unifying tasks, improving quality, and introducing novel capabilities like color editing.
...
<details>
  <summary>Details</summary>
Motivation: Existing vector quantization methods suffer from training instability and codebook collapse due to distribution mismatches, leading to unrepresentative code vectors and data loss.

Method: The authors employ Wasserstein distance to align feature and code vector distributions, ensuring better codebook utilization and reduced quantization error.

Result: The approach achieves near 100% codebook utilization and significantly lowers quantization error, validated empirically and theoretically.

Conclusion: The proposed method effectively mitigates key issues in vector quantization, improving model performance.
...
Method: The PDSA module leverages high-dimensional correlations to correct feature distribution during aggregation, using a lightweight cross-stage structural descriptor and a key point mechanism to optimize computational overhead.

Result: Experiments on semantic segmentation and classification tasks show significant performance improvements with fewer parameters, validated by ablation and visualization results.

Conclusion: PDSA effectively addresses limitations of existing methods, offering improved efficiency, robustness, and generalization, with publicly available code and training weights.
...
TL;DR: Echo-DND, a dual-noise diffusion model, improves left ventricle segmentation in noisy echocardiograms by combining Gaussian and Bernoulli noises, multi-scale fusion, and spatial coherence calibration, outperforming SOTA models.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods either focus on retrieval or localization, but not both. ReSeDis aims to solve this dual problem for robust multimodal search systems.

Method: Introduces the ReSeDis task, a benchmark with unique object-description mappings, and a joint metric for retrieval and localization. A zero-shot baseline using a frozen vision-language model is provided.

Result: ReSeDis offers a realistic testbed for evaluating multimodal search systems, with significant room for improvement.

Conclusion: ReSeDis bridges the gap between retrieval and localization, providing a foundation for future scalable and robust visual search engines.
...
TL;DR: The paper explores training generalist models for retinal OCT using visual in-context learning (VICL) to enable task flexibility without task-specific development, proposing an evaluation protocol and releasing code for further research.


<details>
  <summary>Details</summary>
Motivation: Specialized models for medical image analysis are limited to predefined tasks, requiring expertise and resources. Generalist models, trained with VICL, offer flexibility by allowing task definition on the fly.
...
Result: A state-of-the-art medical VICL approach is evaluated on multiple retinal OCT datasets, establishing a baseline and highlighting the potential and limitations of in-context learning for OCT.

Conclusion: The work demonstrates the promise of VICL for OCT, providing a foundation for future research and practical adoption, with openly released code to support further advancements.
...
<details>
  <summary>Details</summary>
Motivation: To safeguard user privacy by preventing misuse of publicly posted images by advanced vision-language models.

Method: Introduces PSIC, a flexible coding method with multiple decoding options, a CLTG module for bias generation, and UAEO optimization for leveraging VLP model uncertainty.

Result: PSIC effectively balances perceptual quality and privacy protection, demonstrated through extensive experiments.

Conclusion: The proposed scheme is versatile, plug-and-play, and integrates seamlessly with existing Learned Image Compression models.
...
TL;DR: A two-stage diffusion model (DM-FNet) is proposed for multimodal medical image fusion, enhancing feature interaction and fusion quality through detailed feature capture and adaptive processing.


<details>
  <summary>Details</summary>
Motivation: Existing MMIF methods lack detailed feature capture and cross-modal interaction, leading to suboptimal fused image quality.
...
Conclusion: DM-FNet improves MMIF quality and information density, validated by superior performance across medical image types.
...
TL;DR: Video-SALMONN 2 is an advanced audio-visual LLM with LoRA for video captioning, using MrDPO to improve accuracy, outperforming GPT-4o and Gemini-1.5-Pro.


<details>
  <summary>Details</summary>
Motivation: To enhance video understanding by generating detailed and accurate descriptions through advanced audio-visual modeling.

Method: Proposes MrDPO, a multi-round DPO approach with periodic updates, LoRA module merging, and ground-truth guidance.

Result: Reduces captioning error rates by 28%, surpassing GPT-4o and Gemini-1.5-Pro with 7B parameters.

Conclusion: Video-SALMONN 2 achieves state-of-the-art performance in video captioning and competitive results in video QA tasks.
...
TL;DR: The paper proposes C-AFBiFPN, a feature enhancement and fusion framework for SAR ship detection, addressing challenges like scale variations and noise. It combines Convolutional Feature Enhancement (CFE) and BiFormer attention in BiFPN, improving accuracy for small targets and multi-scale adaptability.


<details>
  <summary>Details</summary>
Motivation: SAR ship detection faces issues like scale variations, noise from small vessels, and complex backgrounds. Existing methods lack robust feature representation and global modeling for cross-scale fusion.

Method: C-AFBiFPN introduces a CFE module to enhance feature representation and integrates BiFormer attention into BiFPN (AFBiFPN) for adaptive focus on critical regions.

Result: Experiments on SSDD show improved detection accuracy for small targets, robustness against occlusions, and better multi-scale feature adaptability.

Conclusion: C-AFBiFPN effectively addresses SAR ship detection challenges, enhancing performance through feature enrichment and adaptive fusion.
...
TL;DR: RA-NeRF improves camera pose estimation for 3D reconstruction by combining NeRF with flow-driven pose regulation and an implicit pose filter, outperforming existing methods on complex trajectories.


<details>
  <summary>Details</summary>
Motivation: Existing methods for 3D reconstruction and SLAM rely on accurate camera pose priors but struggle with complex trajectories. RA-NeRF aims to address this limitation.

Method: RA-NeRF uses NeRF with photometric consistency, flow-driven pose regulation for robustness, and an implicit pose filter to refine camera movement patterns.
...
TL;DR: RetroMem introduces a recall-augmented COD architecture that dynamically integrates historical knowledge to improve camouflage detection, outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Existing COD methods lack mechanisms for leveraging historical context, limiting their effectiveness in complex camouflage scenes.
...
Result: Extensive experiments show RetroMem significantly outperforms state-of-the-art methods on multiple datasets.

Conclusion: RetroMem's dynamic integration of historical knowledge enhances camouflage detection, setting a new benchmark for COD.
...
TL;DR: The paper explores Domain Adaptation (DA) techniques in semiconductor defect classification, proposing the DBACS model to improve performance in semi-supervised and unsupervised settings.
...
Result: DBACS proves effective in advancing DA techniques for semiconductor applications, enhancing robustness and scalability.

Conclusion: The study validates DA's usefulness in semiconductor defect classification, with DBACS offering a promising approach for minimizing resource costs.
...
TL;DR: MSNeRV improves INR-based video compression by addressing detail-intensive and fast-changing content limitations through multi-scale feature fusion, temporal consistency, and adaptive loss functions, outperforming VTM-23.7 in dynamic scenarios.
...
Method: Proposes MSNeRV, a multi-scale feature fusion framework with temporal windows, GoP-level grids, a multi-scale spatial decoder, and a scale-adaptive loss function.

Result: MSNeRV outperforms VTM-23.7 (Random Access) in dynamic scenarios, demonstrating superior representation and compression efficiency.

Conclusion: MSNeRV advances INR-based video compression by integrating multi-scale and temporal features, setting a new benchmark for dynamic content representation.
...
Result: BCRNet achieves significant performance improvements on L3D and P2ILF datasets.

Conclusion: BCRNet is a promising solution for enhancing surgical navigation through improved landmark detection.
...
<details>
  <summary>Details</summary>
Motivation: Existing solutions require rigid setups or markers; ViMAT aims to overcome these limitations for flexible industrial monitoring.

Method: Combines a perception module (extracts visual data from multi-view streams) and a reasoning module (infers actions based on observed state and task knowledge).
...
TL;DR: The paper discusses advancements in facial micro-expression (ME) analysis, highlighting the limitations of traditional methods and introducing new tasks (ME-STR and ME-VQA) leveraging multimodal models for improved performance.


<details>
  <summary>Details</summary>
Motivation: Traditional ME analysis methods treat spotting and recognition separately, which is suboptimal for real-world scenarios. The emergence of multimodal models (MLLMs/LVLMs) offers new opportunities for enhanced ME analysis.

Method: The paper proposes two tasks: ME-STR (unified spotting and recognition pipeline) and ME-VQA (visual question answering using MLLMs/LVLMs).

Result: The MEGC 2025 challenge introduces these tasks, requiring algorithms to be tested on a standardized dataset and evaluated via a leaderboard.

Conclusion: The paper aims to advance ME analysis by integrating multimodal models and unifying spotting and recognition tasks, setting a benchmark for future research.
...
Method: MapFM incorporates a foundation model for encoding camera images and integrates auxiliary prediction heads for BEV semantic segmentation to enhance feature representation and prediction quality.

Result: The multi-task learning approach provides richer contextual supervision, leading to higher accuracy and improved quality of the predicted vectorized HD maps.

Conclusion: MapFM demonstrates superior performance in generating vectorized HD maps, with the source code made publicly available for further research and implementation.
...
<details>
  <summary>Details</summary>
Motivation: Traditional Active Learning (AL) methods assume a closed-set scenario, but real-world clinical data often includes Out-Of-Distribution (OOD) samples, reducing annotation efficiency. OpenPath addresses this by improving sample selection purity and informativeness.

Method: OpenPath uses task-specific prompts in the first query to select In-Distribution (ID) samples. Subsequent queries employ Diverse Informative ID Sampling (DIS), combining Prototype-based ID candidate Selection (PIS) and Entropy-Guided Stochastic Sampling (EGSS) to avoid OOD samples.

Result: Experiments on two public pathology datasets show OpenPath outperforms state-of-the-art open-set AL methods, enhancing model performance due to high sample purity.

Conclusion: OpenPath effectively addresses the challenges of open-set AL in pathology image classification, reducing labeling costs and improving efficiency.
...
TL;DR: The paper introduces CountVid, a model for open-world object counting in videos, addressing challenges like occlusions and reappearances. It also presents the VideoCount dataset for evaluation.
...
Result: CountVid outperforms baselines and provides accurate counts, as demonstrated on the VideoCount dataset.

Conclusion: The paper presents a novel solution for open-world object counting in videos, supported by a new dataset and open-source code.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods struggle with deformable animal fur/skin patterns due to geometric distortions from movement and posture changes.
...
Conclusion: The framework enhances re-identification accuracy without requiring ground truth UV annotations, demonstrating effectiveness in self-supervised training.
...
TL;DR: DDIS introduces a diffusion-assisted method for data-free image synthesis, leveraging a text-to-image diffusion model to improve synthetic image quality and alignment with the training data distribution.


<details>
  <summary>Details</summary>
Motivation: The utility of pre-trained models declines without access to original training data, and existing DFIS methods produce samples deviating from the true distribution due to lack of natural image priors.

Method: DDIS uses a diffusion model as an image prior, introduces Domain Alignment Guidance (DAG) for domain alignment, and optimizes a Class Alignment Token (CAT) for class-specific attributes.

Result: DDIS outperforms prior DFIS methods, generating samples that better reflect the training data distribution, achieving SOTA performance on PACS and ImageNet.

Conclusion: DDIS effectively addresses the limitations of DFIS by leveraging diffusion models and alignment techniques, improving synthetic image quality and utility.
...
TL;DR: The paper introduces NERO, a novel OOD scoring mechanism for medical imaging, leveraging neuron-level relevance to improve OOD detection by clustering ID class centroids and using a relevance distance metric.
...
Method: NERO clusters neuron-level relevance for ID classes into centroids, uses a relevance distance metric, and refines performance with scaled relevance and feature norms.
...
Conclusion: NERO enhances OOD detection in medical imaging by leveraging neuron-level relevance, offering improved reliability and explainability.
...
<details>
  <summary>Details</summary>
Motivation: To make 3D AIGC more accessible by simplifying the complex processes of data handling and model training.

Method: Step-by-step guide using Hunyuan3D 2.1, which includes shape generation (Hunyuan3D-DiT) and texture synthesis (Hunyuan3D-Paint).

Result: Participants gain the ability to develop or finetune 3D generative models for applications like gaming and VR.

Conclusion: The tutorial equips users with practical knowledge to create high-resolution, textured 3D assets efficiently.
...
Method: MRG-LLM uses a frozen LLM with a learnable visual encoder and dynamic prompt customization via conditional affine transformations. Two implementations (prompt-wise and promptbook-wise) are proposed.

Result: MRG-LLM achieves state-of-the-art performance on IU X-ray and MIMIC-CXR datasets.

Conclusion: The model effectively integrates LLMs with medical imaging, offering precise report generation, with code to be made public.
...
<details>
  <summary>Details</summary>
Motivation: Limited large-scale 4D HOI datasets hinder progress in text-driven human motion synthesis for human-object interactions.

Method: GenHOI uses Object-AnchorNet for sparse 3D HOI keyframe reconstruction and ContactDM with Contact-Aware Encoder and Attention for dense 4D sequence interpolation.

Result: Achieves state-of-the-art results on OMOMO and 3D-FUTURE datasets, showing strong generalization and high-fidelity generation.

Conclusion: GenHOI effectively synthesizes 4D HOI sequences for unseen objects, reducing reliance on large 4D datasets.
...
<details>
  <summary>Details</summary>
Motivation: To assess and advance shadow removal techniques by evaluating solutions from diverse participants on a standardized dataset.

Method: Two tracks: reconstruction fidelity and visual perception (user study), using the WSRD+ dataset with varied objects, textures, and materials.

Result: 17 teams submitted solutions, evaluated on fidelity and perception, showcasing diverse approaches.

Conclusion: The challenge highlights progress in shadow removal, with standardized evaluation fostering innovation.
...
TL;DR: CLAIM introduces a framework for realistic myocardial scar synthesis and segmentation using clinically guided augmentation and joint training, improving scar realism and segmentation accuracy.
...
Method: CLAIM uses the SMILE module (diffusion-based generator conditioned on the AHA 17-segment model) and joint training of the generator and segmentation network.
...
TL;DR: RaCalNet is a framework for dense metric depth estimation using millimeter-wave radar and sparse LiDAR supervision, eliminating the need for costly dense supervision while outperforming dense-supervised methods.


<details>
  <summary>Details</summary>
Motivation: Current methods for dense metric depth estimation rely on dense LiDAR supervision, which is costly and data-intensive. RaCalNet aims to reduce this dependency.

Method: RaCalNet recalibrates and refines sparse radar points to create accurate depth priors, which guide monocular depth prediction without dense supervision.

Result: RaCalNet outperforms dense-supervised methods, achieving better structural consistency and fine details, with RMSE reductions of 35.30% and 34.89%.

Conclusion: RaCalNet demonstrates that sparse supervision can achieve superior results compared to dense-supervised methods, offering a cost-effective and efficient solution for depth estimation.
...
Method: Proposes Non-local Attention Energy Function to redistribute attention scores and Adaptive Update (Langevin dynamics-based) to prevent domain deviations.

Result: WinWinLay outperforms state-of-the-art methods in precise element placement and photorealistic fidelity.

Conclusion: WinWinLay effectively addresses localization and artifact issues, enhancing Layout-to-Image generation.
...
TL;DR: Show-o2 introduces improved unified multimodal models using autoregressive modeling and flow matching, enabling scalable understanding and generation across text, images, and videos.


<details>
  <summary>Details</summary>
Motivation: To create a versatile model capable of handling diverse multimodal tasks (text, images, videos) with scalability and efficiency.

Method: Leverages a 3D causal variational autoencoder with dual-path spatial-temporal fusion, applying autoregressive modeling for text and flow matching for image/video generation. Uses a two-stage training approach.

Result: Show-o2 models excel in multimodal understanding and generation tasks across various modalities.

Conclusion: Show-o2 is a scalable and effective solution for unified multimodal tasks, with released code and models for broader use.
...
<details>
  <summary>Details</summary>
Motivation: High-resolution land cover classification is challenging due to costly annotations, scale variation, and limited adaptability of large-scale models. Existing methods focus on lower resolutions and rely on annotated data, while practical needs demand higher resolutions under weak supervision.

Method: Proposes a semi-supervised segmentation framework for 0.3m imagery, integrating SAM2 knowledge and a FreqWeaver Adapter for fine-grained detail modeling with only 5.96% of total model parameters.

Result: Achieves 1.78% improvement over parameter-efficient tuning strategies and 3.44% gain over state-of-the-art high-resolution segmentation methods, with robust structural consistency.

Conclusion: The framework effectively addresses high-resolution land cover classification challenges by leveraging unlabeled data and maintaining efficiency, offering superior performance with minimal parameter overhead.
...
TL;DR: A novel graph-based framework for end-to-end processing of large-scale point clouds improves non-destructive AGB estimation, reducing reliance on high-quality TLS data and pre-processing steps.
...
Method: The study introduces a unified framework using graph-based operations for tree segmentation, leaf-wood separation, and 3D skeletal reconstruction.
...
Conclusion: The method advances QSM-based AGB estimation, making it feasible for large-scale applications and reducing dependency on specialized tools.
...
TL;DR: The paper proposes a Dual LoRA Learning (DLoRAL) paradigm for Real-VSR, combining Cross-Frame Retrieval (CFR) and Consistency-LoRA (C-LoRA) to maintain temporal consistency while enhancing spatial details.
...
Method: DLoRAL uses CFR to aggregate frame information and trains C-LoRA for temporal consistency. It then trains D-LoRA for detail enhancement while aligning with C-LoRA's temporal space.

Result: DLoRAL achieves strong performance in accuracy and speed, producing consistent and detail-rich outputs.

Conclusion: The proposed method effectively balances temporal consistency and spatial detail enhancement in Real-VSR, outperforming existing approaches.
...
TL;DR: M2M-Reg is a novel framework for multi-modal deformable image registration (DIR) that uses mono-modal similarity to train models, addressing challenges in aligning highly disparate imaging modalities like PET and FA with structural references like MRI.


<details>
  <summary>Details</summary>
Motivation: Conventional unsupervised DIR methods struggle with highly heterogeneous modalities, often distorting images due to unreliable spatial mappings and failing similarity metrics.

Method: Proposes M2M-Reg, which trains multi-modal DIR models using mono-modal similarity, and introduces GradCyCon, a regularizer for diffeomorphism. The framework also extends to semi-supervised settings.
...
TL;DR: A reconstruction-free online framework for efficient, real-time 3D object detection using pre-trained models and multi-view fusion.


<details>
  <summary>Details</summary>
Motivation: Overcome computational and memory constraints of dense point cloud reconstruction in existing 3D detection methods.
...
Conclusion: The proposed method offers a memory-efficient, real-time solution with strong generalization for open-vocabulary 3D object detection.
...
Method: HOIDiNi uses Diffusion Noise Optimization (DNO) in two phases: object-centric (contact choices) and human-centric (motion refinement).
...
Conclusion: HOIDiNi successfully balances realism and physical correctness, advancing controllable HOI generation.
...
TL;DR: A new benchmark for long-range embodied tasks in the Habitat simulator is introduced to evaluate memory-based capabilities in robotics, addressing limitations of current VLMs in handling long-term memory.


<details>
  <summary>Details</summary>
Motivation: Current vision-language models (VLMs) struggle with long-term memory in embodied settings, limiting their application in robotics. Existing benchmarks lack focus on embodied challenges like object manipulation and navigation.

Method: A benchmark with 60 memory-intensive tasks in the Habitat simulator is developed, procedurally extendable for scalable evaluation. Baselines integrate state-of-the-art VLMs with navigation policies.

Result: The benchmark assesses VLMs' performance on memory-intensive tasks, identifying areas for improvement in long-term reasoning and action execution.
...
TL;DR: Higher visual quality doesn't always improve MLLM performance; controlled degradations can help. VQ-TTT, a lightweight adaptation module, dynamically adjusts images to align with model preferences, boosting accuracy.


<details>
  <summary>Details</summary>
Motivation: To understand how visual quality affects MLLM responses and reconcile the paradox where degraded images sometimes improve performance.

Method: Introduces VQ-TTT, a module with a learnable kernel and fine-tuned shallow vision-encoder layers via LoRA, to dynamically adjust images.

Result: VQ-TTT improves accuracy across MLLMs and datasets without extra data or models, showing adaptive imagery is better than universally clean inputs.

Conclusion: MLLMs benefit from adaptive visual inputs, challenging the notion that higher fidelity always improves understanding.
...
TL;DR: ViMaR is a two-stage inference framework for vision-language models that improves efficiency and output fidelity by combining a value model with margin-based reward adjustments, achieving faster and more reliable caption generation.
...
Result: ViMaR generates more reliable, accurate, and detailed captions with a 4× speedup, and generalizes to unseen models, improving caption quality.

Conclusion: ViMaR is scalable, transferable, and enhances model performance when used for self-training, offering a fast and accurate VLM pipeline.
...
<details>
  <summary>Details</summary>
Motivation: Overcome limitations of existing relighting methods, which struggle with data scarcity, error accumulation, and realism under complex lighting.
...
Result: Achieves superior visual fidelity, temporal consistency, and generalization across diverse scenes.

Conclusion: The proposed method outperforms prior techniques by leveraging joint estimation and diffusion models for realistic relighting.
...
<details>
  <summary>Details</summary>
Motivation: Existing video datasets are limited for world exploration due to constraints like short duration, static scenes, and lack of annotations.

Method: Sekai includes 5,000+ hours of FPV and drone videos from 100+ countries, with rich annotations. A toolbox was developed for collection and annotation.

Result: Experiments confirm dataset quality. A subset trained YUME, an interactive video world exploration model.

Conclusion: Sekai is expected to advance video generation and world exploration, enabling valuable applications.
...
TL;DR: ECAD uses a genetic algorithm to optimize caching schedules for diffusion models, improving speed and quality without modifying model parameters.


<details>
  <summary>Details</summary>
Motivation: Diffusion models are slow and computationally expensive during inference; existing caching methods are rigid and lack generalization.

Method: ECAD employs a genetic algorithm to learn efficient, per-model caching schedules using calibration prompts, forming a Pareto frontier.

Result: ECAD achieves significant speedups (e.g., 2.58x on PixArt-alpha) and better quality (4.47 COCO FID improvement) while generalizing to unseen resolutions/variants.
...
TL;DR: CALM integrates symbolic reasoning with neural generation for context-sensitive decisions in multi-modal environments, outperforming classical logic and LLMs.


<details>
  <summary>Details</summary>
Motivation: Classic logic systems lack nuance and grounding in multi-modal data, while neural networks lack interpretable reasoning structures. CALM bridges this gap.

Method: CALM uses domain trees for predicates, refining analog truth values via neural networks and symbolic reasoning to ensure constraint satisfaction.
...
TL;DR: MEAL is the first benchmark for continual multi-agent reinforcement learning (CMARL), addressing gaps in existing benchmarks by enabling GPU acceleration for longer task sequences.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks for continual learning (CL) in multi-agent settings are limited by CPU-based computation, restricting task sequence length and scalability.

Method: MEAL leverages JAX for GPU acceleration, allowing continual learning across 100 tasks on a standard desktop PC. Performance of combined CL and MARL methods is evaluated.

Result: Naive combinations of CL and MARL methods perform well in simple environments but fail in complex settings requiring coordination and adaptation. Ablation studies identify key features for CMARL.

Conclusion: MEAL provides a scalable benchmark for CMARL, highlighting the need for specialized methods to address challenges in continual multi-agent learning.
...
<details>
  <summary>Details</summary>
Motivation: PPO's inefficiency in long-response generation due to on-policy nature and low hardware utilization motivates the need for a more efficient method like T-PPO.

Method: T-PPO introduces Extended Generalized Advantage Estimation (EGAE) for incomplete responses and a mechanism for independent policy and value model optimization.

Result: T-PPO achieves up to 2.5x training efficiency improvement on AIME 2024 with a 32B model, outperforming competitors.
...
<details>
  <summary>Details</summary>
Motivation: Traditional heuristic designs rely on manual expertise and lack generalization across diverse combinatorial optimization problems.

Method: HeurAgenix uses LLMs to evolve heuristics by comparing seed solutions and extracting strategies, then dynamically selects heuristics for problem states. It includes a dual-reward mechanism for fine-tuning.
...
Conclusion: The framework demonstrates the potential of LLMs in automating heuristic design and selection for combinatorial optimization.
...
<details>
  <summary>Details</summary>
Motivation: The rapid growth of LEO satellites has improved EO missions, but autonomous coordination remains a challenge due to real-time decision-making demands.
...
Conclusion: The findings offer practical guidelines for autonomous satellite operations, advancing policy learning in decentralized EO missions.
...
<details>
  <summary>Details</summary>
Motivation: The rapid growth of maritime IoT demands and the inefficiency in computation offloading and resource allocation due to uncertain tasks motivate this work.

Method: A cooperative MEC framework is introduced, leveraging Lyapunov optimization for task unpredictability and a Markov game approach with a heterogeneous-agent soft actor-critic for solving the problem.

Result: Simulations confirm the framework's effectiveness in optimizing computation offloading and resource allocation.

Conclusion: The proposed solution efficiently addresses maritime IoT challenges by combining UAV-vessel cooperation, Lyapunov optimization, and reinforcement learning.
...
<details>
  <summary>Details</summary>
Motivation: Existing navigation methods process historical observations simultaneously, ignoring internal data associations, which limits performance. The paper aims to address this by incorporating causality.

Method: The proposed CAN framework includes a Causal Understanding Module to enhance environmental understanding, leveraging causality to improve sequential data modeling.

Result: Empirical evaluations show CAN consistently outperforms baselines in various tasks and environments, with gains attributed to the Causal Understanding Module.

Conclusion: The CAN framework effectively generalizes in Reinforcement and Supervised Learning settings without added computational cost, demonstrating the value of causal modeling in navigation tasks.
...
TL;DR: The paper proposes a Large Language Model (LLM)-based Planning Agent (LPA) to automate and streamline Failure Analysis (FA) tasks by integrating AI components into cohesive workflows.


<details>
  <summary>Details</summary>
Motivation: The complexity of FA processes and the increasing use of AI models necessitate efficient orchestration to enhance automation and integration.

Method: The LPA combines LLMs with advanced planning and external tool utilization to autonomously process queries, retrieve data, and generate responses.

Result: The LPA demonstrates operational effectiveness and reliability in supporting FA tasks.

Conclusion: The LPA successfully addresses the challenge of integrating AI components into FA workflows, improving efficiency and automation.
...
TL;DR: The paper introduces a framework for constructing natural language state representations for LLM agents in multi-agent games, highlighting the impact of state representation on behavior and comparability.


<details>
  <summary>Details</summary>
Motivation: To address the ad hoc and inconsistent approaches in encoding game history for LLM agents, which obscure behavior impact and limit study comparability.

Method: A unifying framework categorizing state representation methods along three axes: action informativeness, reward informativeness, and prompting style. Applied to a dynamic selfish routing game.

Result: LLM agent behavior depends on state representation. Summarized history, regret-based rewards, and limited action info lead to behavior closer to game theory equilibrium.

Conclusion: State representation significantly influences LLM agent behavior, with specific representations yielding more stable and equilibrium-aligned outcomes.
...
TL;DR: The paper introduces an AI Policy Module for CS students to bridge the gap between AI ethics and technical practice, showing improved student engagement and understanding post-module.
...
Method: Developed an AI Policy Module, piloted in 2024, and expanded it with a technical assignment on AI regulation. Evaluated student attitudes via pre- and post-module surveys.

Result: Students reported heightened ethical concerns and greater confidence in discussing AI regulation after completing the module.
...
<details>
  <summary>Details</summary>
Motivation: LRMs often produce verbose and redundant content, increasing inefficiency and costs. The study aims to uncover and mitigate these inefficiencies by leveraging the models' inherent capacity for concise reasoning.

Method: Two methods are introduced: (1) Efficiency Steering, a training-free technique to modulate reasoning behavior, and (2) Self-Rewarded Efficiency RL, a reinforcement learning framework to balance accuracy and brevity.
...
Conclusion: The study demonstrates that LRMs' reasoning efficiency can be enhanced by guiding their intrinsic capabilities, offering practical solutions for optimizing model performance.
...
<details>
  <summary>Details</summary>
Motivation: Existing agentic systems lack full autonomy, limiting adaptability and scalability.

Method: SwarmAgentic uses language-driven exploration and PSO-inspired evolution to optimize agent functionality and collaboration.

Result: Achieves significant improvements in real-world tasks, demonstrating effectiveness in unconstrained scenarios.

Conclusion: SwarmAgentic advances scalable, autonomous agentic system design by integrating swarm intelligence.
...
TL;DR: The paper introduces Embodied Web Agents, a paradigm integrating physical embodiment and web-scale reasoning, addressing tasks like cooking and navigation. It includes a simulation platform and benchmark, revealing gaps between AI and human performance.
...
Method: Developed a unified simulation platform (Embodied Web Agents task environments) and benchmark for tasks like cooking and navigation, requiring cross-domain reasoning.

Result: Experimental results show significant performance gaps between state-of-the-art AI systems and humans, highlighting challenges and opportunities.

Conclusion: The work establishes a foundation for AI agents that combine embodiment and web-scale reasoning, with publicly available resources for further research.
...
Method: A manually annotated dataset with 14 clinically significant AEs and contextual attributes is created. Multiple models, including transformer-based ones, are evaluated across three annotation granularities.

Result: Transformer models excel in coarse-grained extraction (F1 = 0.943) but perform poorly on fine-grained tasks (F1 = 0.675), especially for rare events and complex attributes.

Conclusion: Despite high-level performance, challenges persist in detecting underrepresented AEs and nuanced clinical language. The dataset serves as a benchmark for future AE extraction research.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods for structured NLP tasks rely on implicit constraints during training, leading to low-quality outputs during constrained decoding. BoostCD addresses this by leveraging complementary errors from constrained and unconstrained decoding.

Method: BoostCD uses a two-phase approach: Phase 1 generates weak predictions from constrained and unconstrained decoding of a base model. Phase 2 combines these predictions using a learned boosted model.
...
Conclusion: BoostCD effectively improves structured NLP task performance by exploiting complementary errors from constrained and unconstrained decoding, demonstrating success in closed information extraction.
...
Method: CrEst uses inter-document semantic coherence for automated credibility estimation, with black-box and white-box integration strategies for LLMs.
...
Conclusion: CrEst effectively enhances LLM performance by integrating credibility assessment, proving robust and scalable.
...
TL;DR: MDBench is a new synthetic dataset for evaluating multi-document reasoning in LLMs, created using a novel knowledge-guided generation technique.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks lack rigorous evaluation of multi-document reasoning, a critical area given LLMs' capabilities, and manual annotation is costly.

Method: MDBench is generated synthetically by modifying structured seed knowledge via LLM-assisted edits, converting it into natural text and QA examples.

Result: MDBench challenges current LLMs and prompting techniques, even with short documents, and enables targeted analysis of reasoning capabilities.

Conclusion: The synthetic generation method is efficient, adaptable, and useful for future benchmarking as LLMs evolve.
...
TL;DR: The study explores LLMs for diabetes prediction using PIDD, comparing six LLMs (including open-source and proprietary) with traditional ML models. Proprietary LLMs like GPT-4o and Gemma-2-27B outperform others, but challenges like prompting strategy variations remain.


<details>
  <summary>Details</summary>
Motivation: To test the effectiveness of LLMs in predicting diabetes using structured numerical data, an area not well explored, and compare their performance with traditional ML models.

Method: Empirical analysis using PIDD, evaluating six LLMs (Gemma-2-27B, Mistral-7B, Llama-3.1-8B, Llama-3.2-2B, GPT-4o, Gemini Flash 2.0) with zero-shot, one-shot, and three-shot prompting. Traditional ML models (Random Forest, Logistic Regression, SVM) are also compared.
...
Method: Introduce a memory token whose embedding is optimized through training on a fixed sequence. The model reconstructs the sequence when prompted with this embedding.

Result: Successful reconstruction across English and Spanish datasets, sequences up to ~240 tokens, and model scales from 100M to 8B parameters. Llama 3.1 8B achieved perfect reconstruction.
...
TL;DR: The paper uses NLP and topic modeling to identify social isolation and loneliness in suicide narratives, revealing demographic predictors and improving surveillance.


<details>
  <summary>Details</summary>
Motivation: Social isolation and loneliness are rising and linked to suicide, but not tracked in NVDRS. NLP can uncover these factors in narratives.
...
Conclusion: The method enhances surveillance and prevention of social isolation and loneliness in the US.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods for evaluating long-form generation often miss key aspects like coherence and relevance, or are biased by pretraining data.
...
Result: PrefBERT aligns well with human preferences and outperforms traditional metrics in evaluations, including LLM-as-a-judge and human ratings.

Conclusion: PrefBERT is a reliable and effective tool for evaluating and training long-form generation models, improving alignment with human preferences.
...
TL;DR: The paper explores how learning-time choices in knowledge encoding affect unlearning effectiveness in LLMs, finding paraphrased descriptions improve unlearning and highlighting challenges in unlearning specific knowledge from text chunks.


<details>
  <summary>Details</summary>
Motivation: To address the need for unlearning in LLMs due to privacy, regulations, and content correction, the study investigates how knowledge encoding during learning impacts unlearning performance.

Method: Empirical investigation of learning-time choices (e.g., paraphrased descriptions) and their impact on unlearning factual knowledge in LLMs.

Result: Paraphrased descriptions enhance unlearning performance, but unlearning specific knowledge from text chunks remains difficult.

Conclusion: Learning-time knowledge encoding is crucial for enabling reliable post-hoc unlearning in LLMs.
...
<details>
  <summary>Details</summary>
Motivation: Linguistic features in dialogues introduce ambiguities that obscure discourse relations, challenging parsers.

Method: Proposes DCM with clarification type and discourse goal reasoning, and CPO to mitigate erroneous clarifications.
...
TL;DR: The CKD-EHR framework improves disease prediction using knowledge distillation, enhancing accuracy and efficiency in clinical settings.


<details>
  <summary>Details</summary>
Motivation: Address challenges of insufficient medical knowledge representation and low efficiency in clinical deployment of EHR-based models.

Method: Uses knowledge distillation: fine-tunes Qwen2.5-7B as a teacher model, generates soft labels, and transfers knowledge to a lightweight BERT student model.

Result: Outperforms baseline with 9% higher accuracy, 27% better F1-score, and 22.2x faster inference on MIMIC-III.

Conclusion: CKD-EHR enhances diagnosis accuracy and efficiency, offering a practical solution for clinical resource optimization.
...
<details>
  <summary>Details</summary>
Motivation: Most LLM-based dialogue agents ignore the o2m property, which limits response diversity. This work aims to explicitly model o2m to enhance diversity and coherence.

Method: Decomposes OD into MRG (generating diverse responses) and PS (selecting based on preference). Uses o2mDial corpus, in-context learning, instruction-tuning, and novel metrics for MRG and PS.

Result: Smaller LLMs achieve up to 90% improvement in response quality and diversity, matching larger models' performance.

Conclusion: The two-stage framework effectively captures the o2m property, improving OD generation in smaller LLMs without sacrificing coherence.
...
Conclusion: The linguistically informed approach of Thunder-Tok is effective and practical for efficient tokenizer design in language models.
...
TL;DR: The paper investigates memory mechanisms in state-space language models, identifying primacy and recency effects through structured recall tasks in the Mamba architecture. Three key mechanisms are uncovered: long-term memory via sparse channels, short-term memory via delta-modulated recurrence, and dynamic memory allocation based on semantic regularity. Findings are validated on large-scale Mamba models.


<details>
  <summary>Details</summary>
Motivation: To understand how state-space language models retain and forget information over time, using primacy and recency effects as behavioral tools.

Method: Structured recall tasks applied to the Mamba architecture, with analysis of long-term memory (sparse channels), short-term memory (delta-modulated recurrence), and dynamic memory allocation (semantic regularity). Validated via ablations and perturbations on 1.4B and 7B parameter models.

Result: A U-shaped accuracy profile (strong performance at sequence start and end) is observed. Long-term memory relies on sparse channels, short-term memory on delta-modulated recurrence, and memory allocation is dynamically influenced by semantic regularity.

Conclusion: The study reveals distinct mechanisms for memory retention and forgetting in state-space models, with implications for understanding and improving language model architectures.
...
TL;DR: The study evaluates proprietary and open-source LLMs for SDG-focused text classification, comparing task adaptation techniques like Zero-Shot, Few-Shot Learning, and Fine-Tuning. Smaller models with prompt engineering match larger models like GPT.


<details>
  <summary>Details</summary>
Motivation: Tracking progress toward the UN's 17 SDGs is challenging due to data complexity. Text classification models, especially LLMs, are crucial for automating analysis.

Method: Analyzed various LLMs for SDG text classification, testing Zero-Shot, Few-Shot Learning, and Fine-Tuning techniques.

Result: Smaller models optimized via prompt engineering perform as well as larger models like GPT.

Conclusion: Efficient prompt engineering can make smaller LLMs competitive in SDG-related text classification, reducing reliance on larger models.
...
Method: Introduces ProtoReasoning, a framework with automated prototype construction, verification via Prolog/PDDL, and scalability for problem synthesis.
...
TL;DR: MinosEval is a novel method for evaluating open-ended QA, distinguishing factoid and non-factoid questions and using adaptive strategies for each, outperforming traditional metrics.
...
Method: MinosEval classifies questions into factoid and non-factoid types, applying key-point scoring for factoid questions and instance-aware listwise ranking for non-factoid ones.
...
Conclusion: MinosEval addresses the limitations of current evaluation methods, offering a more refined and interpretable approach for open-ended QA.
...
<details>
  <summary>Details</summary>
Motivation: To assess how well current language technologies handle linguistic variation in Basque and Spanish.

Method: Uses Natural Language Inference (NLI) with a new parallel dataset and tests encoder-only and decoder-based LLMs.
...
Conclusion: Linguistic variation, not lexical overlap, causes performance drops, aligning with linguistic theory. Data and code are publicly available.
...
TL;DR: The paper introduces Graph RAG, a framework combining chain-of-thought prompting and knowledge graphs to enhance historical text analysis, reducing manual effort and improving model performance.
...
Method: Proposes Graph RAG, integrating chain-of-thought prompting, self-instruction generation, and process supervision to create a character relationship dataset with minimal annotation. Uses collaborative mechanisms between knowledge graphs and retrieval-augmented generation.

Result: The domain-specific model Xunzi-Qwen1.5-14B achieves F1=0.68 in relation extraction. GraphRAG improves F1 by 11% on C-CLUE, surpassing Xunzi-Qwen1.5-14B and reducing hallucinations.
...
TL;DR: TopClustRAG is a hybrid RAG system combining sparse/dense retrieval with K-Means clustering for diverse, relevant answers, ranking 2nd in faithfulness and 7th in correctness.
...
Method: Uses hybrid retrieval (sparse/dense indices), K-Means clustering, cluster-specific prompts for an LLM, and multi-stage filtering/reranking.
...
TL;DR: The paper introduces Thunder-DeID, a framework for de-identifying court judgments in South Korea, addressing legal and technical challenges with a DNN-based pipeline.
...
TL;DR: The paper surveys the use of LLMs in clinical trial recruitment, highlighting their potential but noting limitations like proprietary models and weak benchmarks.
...
Method: Analyzes trial-patient matching, evaluates LLM-based approaches, benchmarks, and frameworks in clinical research.

Result: Identifies challenges in adopting LLMs for clinical trials and suggests future directions.
...
TL;DR: DeVisE evaluates LLMs in clinical decision support, revealing zero-shot models reason better with counterfactuals, while fine-tuned models are stable but less responsive. Demographic biases subtly influence outputs.
...
Method: DeVisE uses ICU discharge notes from MIMIC-IV, creating real-world and synthetic versions with controlled counterfactuals. It evaluates five LLMs via input-level sensitivity and downstream reasoning.

Result: Zero-shot models show coherent counterfactual reasoning, while fine-tuned models are stable but less responsive to clinical changes. Demographic factors subtly affect outputs.
...
<details>
  <summary>Details</summary>
Motivation: Language models lack local socio-cultural context, especially for diverse regions like India.

Method: Created SANSKRITI, a dataset with 21,853 question-answer pairs covering 16 cultural attributes across India's states and union territories.
...
TL;DR: COSMMIC introduces a comment-sensitive multimodal, multilingual dataset for Indian languages, enhancing summaries with reader feedback and images, evaluated using advanced models like LLama3 and GPT-4.


<details>
  <summary>Details</summary>
Motivation: To address the lack of research in Indian languages for comment-aware multimodal and multilingual summarization.

Method: Developed COSMMIC dataset with article-image pairs and reader comments, tested summarization across four configurations (text, comments, images, combined), and used models like LLama3 and GPT-4 for evaluation.

Result: Identified effective configurations for NLG tasks by integrating text, comments, and images, with noise filtering and insight extraction.
...
Method: TLI uses Low-Rank Adaptation (LoRA) and contrastive learning to fine-tune embeddings from an optimal early layer (Layer 2) identified in the model.

Result: TLI increased average cosine similarity for trained word pairs by 28.08% and for unseen pairs by 28.32%, demonstrating strong generalization.

Conclusion: TLI is a parameter-efficient strategy to enhance lexical alignment in LLMs for low-resource languages, leveraging early-layer knowledge.
...
<details>
  <summary>Details</summary>
Motivation: MLLMs for GUI agents often suffer from systematic localization errors (hallucinations), reducing reliability. The paper aims to better understand and mitigate these issues.

Method: Proposes a fine-grained evaluation framework, the Peak Sharpness Score (PSS) for uncertainty quantification, and Context-Aware Cropping to refine input context.

Result: The framework reveals nuanced failure modes, and the proposed methods improve model performance and interpretability.

Conclusion: The paper provides actionable insights to enhance the robustness and reliability of GUI agent behavior in MLLMs.
...
TL;DR: AgentGroupChat-V2 is a novel framework for multi-agent systems, addressing challenges in architecture, generalizability, and performance with innovations like parallel task decomposition, adaptive collaboration, and optimization strategies, achieving superior results in complex tasks.
...
Method: Introduces AgentGroupChat-V2 with three innovations: (1) parallel task decomposition, (2) adaptive collaboration engine, (3) agent organization optimization.

Result: Achieves 91.50% accuracy on GSM8K, 30.4% on AIME, and 79.20% pass@1 on HumanEval, with notable improvements in high-difficulty tasks.

Conclusion: AgentGroupChat-V2 offers an efficient, general-purpose solution for complex reasoning in LLM multi-agent systems, outperforming baselines, especially in challenging scenarios.
...
<details>
  <summary>Details</summary>
Motivation: To clarify whether LLMs' high accuracy on reasoning benchmarks stems from true reasoning or memorization.
...
Conclusion: RE-IMAGINE highlights LLMs' limitations in true reasoning, encouraging further research on reasoning hierarchy.
...
TL;DR: CINGS is a post-training method that improves grounding in LLMs by training with context prepended to responses, masking context in loss, and outperforms other methods.


<details>
  <summary>Details</summary>
Motivation: To ensure LLMs generate responses grounded in external context, addressing the limitation of simple context appending.

Method: Proposes CINGS: trains models with context prepended to responses, masking context in loss calculation.

Result: CINGS improves grounding in text and visual domains, reduces hallucinations, and maintains downstream performance.

Conclusion: CINGS effectively shifts model behavior to rely more on external context, enhancing grounding without performance loss.
...
Result: Improves reasoning performance in offline RL and reward model training, with 2.6x efficiency over tree search-based methods.

Conclusion: SPARE is effective and efficient for process supervision, with potential for broader application and reproducibility.
...
<details>
  <summary>Details</summary>
Motivation: Hyperbole and metaphor detection is challenging due to semantic obscurity and expressive diversity, with existing methods lacking focus on emotional associations and domain mapping.

Method: EmoBi includes an emotion analysis module, emotion-based domain mapping, and bidirectional dynamic interaction, with a verification mechanism for accuracy.

Result: EmoBi achieves significant improvements, with F1 scores increasing by 28.1% for hyperbole and 23.1% for metaphor detection compared to SoTA.
...
<details>
  <summary>Details</summary>
Motivation: To address the challenge of generating grounded and trustworthy responses in LLMs, particularly issues like missing answers, incorrect citations, or unnecessary refusals.

Method: Uses GRPO (Group Relative Policy Optimization) with verifiable outcome-based rewards for training, focusing on answer correctness, citation sufficiency, and refusal quality. A two-stage training setup is employed, and GPT-4 distillation is revisited for instruction tuning.

Result: Reasoning-augmented models outperform instruction-only variants, especially in handling unanswerable queries and generating well-cited responses. Combining GRPO with GPT-4 distillation improves performance on long-form QA tasks.
...
TL;DR: RATTENTION improves local-global attention models by integrating linear attention to capture out-of-window tokens, achieving better efficiency-performance tradeoffs without sacrificing training speed.


<details>
  <summary>Details</summary>
Motivation: Address the limitation of local attention ignoring tokens outside the window, aiming to enhance efficiency in short-context scenarios.

Method: Introduces RATTENTION, combining local attention with a specialized linear attention mechanism to handle out-of-window tokens.

Result: RATTENTION with a 512 window size matches full-attention performance and improves long-context performance on the RULER benchmark.

Conclusion: RATTENTION shifts the Pareto frontier, offering efficiency gains without performance loss, even in short-context settings.
...
TL;DR: A method to approximate training data from model weights using gradient-based selection from a public corpus, improving model performance significantly.
...
Result: Performance improved from 65% to 80% on AG News, and perplexity reduced from 3.3 to 2.3 on MSMARCO, nearing expert benchmarks.

Conclusion: The method effectively recovers useful training data from weights, achieving near-original model performance without access to true training data.
...
<details>
  <summary>Details</summary>
Motivation: LLMs in voice chat cause noticeable latency, especially on consumer hardware, due to slow first-sentence generation for TTS.
...
Conclusion: PredGen effectively mitigates LLM-TTS latency, enhancing real-time voice chat experiences.
...
<details>
  <summary>Details</summary>
Motivation: To address the lack of comprehensive metrics for evaluating gender inclusivity in LLMs, especially for non-binary genders.

Method: Develops GIFI, a multi-level metric, and evaluates 22 LLMs using it to assess biases and inclusivity.

Result: Significant variations in gender inclusivity across LLMs were found, highlighting existing biases.

Conclusion: The study underscores the need for improving LLM inclusivity and provides a benchmark for future gender fairness advancements.
...
<details>
  <summary>Details</summary>
Motivation: To assess and improve the ability of foundation models to verify claims in multimodal scientific literature.

Method: SciVer includes 3,000 expert-annotated examples from 1,113 papers, covering four reasoning types, and evaluates 21 state-of-the-art models.

Result: A significant performance gap exists between models and human experts. Error analysis highlights limitations in current models.

Conclusion: SciVer provides insights to enhance multimodal scientific claim verification, identifying areas for model improvement.
...
TL;DR: The paper introduces DiscoSG, a task for discourse-level text scene graph parsing, and a dataset (DiscoSG-DS) to address limitations in existing methods. It proposes DiscoSG-Refiner, a cost-effective solution using smaller PLMs, improving performance and speed.
...
Method: The paper introduces DiscoSG-DS, a dataset for discourse-level parsing, and DiscoSG-Refiner, a two-stage approach using smaller PLMs to draft and refine graphs iteratively.
...
Conclusion: DiscoSG-Refiner offers a scalable, efficient solution for discourse-level scene graph parsing, balancing performance and cost.
...
TL;DR: WikiMixQA is a new benchmark with 1,000 MCQs for evaluating cross-modal reasoning over tables and charts from Wikipedia. It highlights challenges in long-context, multi-modal reasoning, with GPT-4-o performing best among 12 tested models.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks lack emphasis on complex reasoning over multi-modal data in long documents, necessitating a new benchmark like WikiMixQA.

Method: The paper introduces WikiMixQA, a dataset of 1,000 MCQs derived from 4,000 Wikipedia pages, and evaluates 12 vision-language models on it.

Result: Proprietary models achieve ~70% accuracy with direct context but drop significantly in retrieval tasks. GPT-4-o leads with >50% accuracy, while open-source models max at 27%.
...
TL;DR: The paper explores using generative AI to automate MCQ creation in Portuguese, evaluating quality and reliability, and identifying challenges in semantic clarity and distractor design.
...
Method: Generative models produce Portuguese MCQs aligned with curriculum and difficulty levels, evaluated via expert review and student response psychometrics.

Result: AI-generated MCQs match human quality but face issues in semantic clarity, answerability, and distractor design.

Conclusion: Generative models show promise for MCQ automation in Portuguese, but improvements are needed in clarity and distractor quality for real-world use.
...
TL;DR: The paper explores regret mechanisms in Large Language Models (LLMs), proposing methods to identify and analyze regret expressions and neurons, addressing key challenges with new metrics and workflows.


<details>
  <summary>Details</summary>
Motivation: Understanding regret in LLMs is crucial for enhancing model reliability and uncovering cognitive coding in neural networks.

Method: The study involves constructing a regret dataset, introducing the S-CDI metric for optimal regret layer identification, and the RDS and GIC metrics for neuron analysis.

Result: The S-CDI metric successfully identified the optimal regret layer, and neuron categorization revealed distinct functional groups (regret, non-regret, dual).

Conclusion: The proposed methods effectively address challenges in studying regret mechanisms, providing insights into LLM cognition and reliability.
...
TL;DR: The paper explores cross-cultural differences in interpreting intensifiers like 'quite' and 'very' between British and American English, attributing them to a mix of literal meanings and utterance cost weights.
...
Method: Three experiments and a computational cognitive model analyzing how British and American English speakers interpret intensifiers, incorporating informativity, politeness, and utterance cost.

Result: Cross-cultural differences arise from both literal meaning variations and differing weights on utterance cost, not just semantics or politeness norms.

Conclusion: Interpretation differences are due to an interplay between literal meanings and pragmatic factors, challenging purely semantic or politeness-based explanations.
...
<details>
  <summary>Details</summary>
Motivation: To address the gap in evaluating LLMs' ability to follow concept order instructions and generalize compositionally, which is crucial for tasks like CommonGen.

Method: Proposed Ordered CommonGen benchmark, measuring ordered coverage of concepts in generated sentences. Evaluated 36 LLMs using this benchmark.

Result: LLMs show biases in concept order, leading to low-diversity outputs. The best-performing LLM achieved ~75% ordered coverage.

Conclusion: LLMs need improvement in instruction-following and compositional generalization, as current models struggle with ordered concept generation.
...
TL;DR: The study evaluates six ML techniques for Romanian authorship attribution using character n-grams, with ANN achieving the highest performance.


<details>
  <summary>Details</summary>
Motivation: To address authorship attribution for Romanian texts using the ROST corpus, a standard benchmark.

Method: Systematic evaluation of SVM, LR, k-NN, DT, RF, and ANN with character n-gram features.
...
Method: CC-Learn uses reinforcement learning with a composite objective (cohort accuracy, retrieval bonus, rejection penalty) to enforce uniform reasoning across similar questions.

Result: Experiments on benchmarks like ARC-Challenge and StrategyQA show improved accuracy and reasoning stability over pretrained and SFT baselines.
...
TL;DR: Privacy leakage in reasoning traces of large models is significant, as they often contain sensitive data, amplified by test-time compute approaches.
...
Method: Probing and agentic evaluations to assess leakage in reasoning traces, focusing on test-time compute approaches.

Result: Increased reasoning steps amplify privacy leakage, despite making models more cautious in final answers.

Conclusion: Safety efforts must address internal reasoning traces, not just outputs, due to the tension between utility and privacy.
...
TL;DR: The paper evaluates 21 MT systems for their ability to handle gender ambiguity, finding most fail but a few use specific strategies for gender-neutral translations.
...
Conclusion: Current MT systems largely fail to handle gender ambiguity, though some show promise with targeted strategies.
...
TL;DR: GenRecal is a novel distillation framework for VLMs that addresses architectural diversity, enabling efficient knowledge transfer and outperforming large-scale models.
...
Result: GenRecal significantly improves baseline performances and outperforms large-scale open- and closed-source VLMs.

Conclusion: GenRecal provides a general-purpose solution for efficient VLM deployment, overcoming architectural diversity challenges.
...
TL;DR: PhantomHunter is a new detector for text from privately-tuned LLMs, outperforming existing methods with 96% F1 scores by focusing on family-level traits.


<details>
  <summary>Details</summary>
Motivation: The rise of privately-tuned LLMs has reduced the effectiveness of current detectors, necessitating a specialized solution.
...
Result: It achieves over 96% F1 scores, surpassing 7 baselines and 3 industrial services.

Conclusion: PhantomHunter effectively addresses the challenge of detecting text from unseen, privately-tuned LLMs.
...
TL;DR: MedSyn is a hybrid human-AI framework for clinical decision-making, enabling dynamic physician-LLM dialogues to refine diagnoses and treatments. Open-source LLMs show promise as physician assistants.


<details>
  <summary>Details</summary>
Motivation: Clinical decision-making is complex and influenced by biases and incomplete information. Current LLM usage lacks interaction depth, missing real-world medical complexities.

Method: Proposed MedSyn framework involves multi-step, interactive dialogues between physicians and LLMs, allowing dynamic exchanges and challenge of suggestions.

Result: Open-source LLMs demonstrate potential as effective physician assistants in simulated interactions.

Conclusion: MedSyn shows promise; future work includes real physician interactions to validate its impact on diagnostic accuracy and patient outcomes.
...
TL;DR: A 2D parallel tempering algorithm (2D-PT) is introduced to improve mixing in constrained Ising problems by interpolating penalty strengths, eliminating the need for manual tuning.
...
Result: 2D-PT achieves near-ideal mixing (KL divergence decays as O(1/t)) and significant speedup over conventional PT in tests.

Conclusion: 2D-PT broadly improves constrained Ising problem solutions and is compatible with existing Ising machines.
...
TL;DR: The paper compares two AI approaches: DeepSeek-V3, a large-scale LLM, and NetraAI, a framework for stability and interpretability in small clinical datasets. NetraAI uses dynamical systems, information geometry, and evolutionary algorithms to identify predictive patient subgroups, aided by an LLM Strategist for meta-evolutionary guidance. Case studies show significant improvements in classification accuracy.


<details>
  <summary>Details</summary>
Motivation: To address the need for interpretable and stable AI models in clinical settings, especially for small datasets, by combining dynamical systems, information geometry, and evolutionary learning.

Method: NetraAI employs contraction mappings, information geometry, and evolutionary algorithms to identify patient subgroups. An LLM Strategist acts as a meta-evolutionary layer to guide discovery.
...
<details>
  <summary>Details</summary>
Motivation: Traditional EEG methods struggle with noise and variability in open-vocabulary scenarios, prompting the need for improved solutions.

Method: ETS integrates EEG with synchronized eye-tracking data for text generation and sentiment classification.

Result: Superior performance in BLEU/Rouge scores for text decoding and 10% F1 score improvement in sentiment classification.
...
Method: Train a ConvNet offline, freeze most weights, and retrain selected layers for transfer learning. Tested on CFD data for domain and task adaptation.
...
Conclusion: The transfer learning approach shows promise for real-time prediction of onflow parameters, though noisy data remains a challenge.
...
<details>
  <summary>Details</summary>
Motivation: Existing multimodal approaches neglect visual data in time series forecasting and struggle to capture physical information like geospatial context in satellite imagery.
...
<details>
  <summary>Details</summary>
Motivation: The rise of fast delivery services demands efficient, dense storage systems, but multi-deep AVS/RS face retrieval challenges due to lane blockages.
...
Result: The framework outperforms heuristic methods, effectively reducing retrieval tardiness in diverse warehouse layouts.

Conclusion: The proposed approach enhances flexibility and efficiency in multi-deep storage systems, addressing retrieval challenges in heterogeneous environments.
...
<details>
  <summary>Details</summary>
Motivation: The lack of publicly available, detailed datasets for T1D management limits progress in personalized therapy and glucose prediction.

Method: AZT1D includes data from 25 T1D patients on AID systems, covering CGM, insulin pump data, carbohydrate intake, and device modes over 6-8 weeks.

Result: The dataset provides granular details on bolus insulin delivery, rarely available in existing datasets.

Conclusion: AZT1D enables AI/ML applications to enhance clinical decision-making and individualized T1D care.
...
Method: CEP stores forecasters for different concepts, selects the nearest forecaster for a test sample, and retrieves features from neighbors. If neighbors are insufficient, a new model evolves to store the concept. Outdated knowledge is cleared.

Result: CEP effectively retains knowledge of different concepts and significantly improves prediction accuracy in online forecasting with recurring concepts.

Conclusion: CEP is a robust solution for recurring concept drift, enhancing prediction performance by retaining and utilizing past knowledge.
...
<details>
  <summary>Details</summary>
Motivation: Improve zero-shot prediction of protein properties using PLMs without additional training.
...
TL;DR: The paper introduces 'Assembly-of-Experts' (AoE), a method to efficiently create capable child models from Mixture-of-Experts parents by interpolating weights, reducing computational costs while maintaining functionality.


<details>
  <summary>Details</summary>
Motivation: The high computational cost (10^13-10^15 FLOPs) for pretraining LLMs motivates the development of AoE to leverage existing models more efficiently.

Method: AoE interpolates individual weight tensors from parent models, enabling gradual or sharp trait adjustments in child models without fine-tuning.

Result: The DeepSeek R1T 'Chimera' model, created using AoE, achieves R1-level intelligence with 40% fewer output tokens and V3 speed, showcasing compact reasoning.

Conclusion: AoE enables efficient, functional child model creation from existing parents, demonstrating practical benefits like reduced computational costs and improved reasoning.
...
<details>
  <summary>Details</summary>
Motivation: To understand the fundamental constraints on how intelligent systems balance generalization and identification in their internal representations.

Method: Derived closed-form expressions for generalization and identification probabilities, validated in minimal ReLU networks, CNNs, and vision-language models.

Result: Found a universal Pareto front for the tradeoff, a sharp collapse in multi-input capacity, and non-monotonic generalization optima. Limits persist in complex models.
...
TL;DR: ss-Mamba is a foundation model for time series forecasting, combining semantic-aware embeddings and adaptive spline-based temporal encoding with selective state-space modeling for efficiency and accuracy.
...
TL;DR: The paper presents a continuous time approximation for the discrete Heavy-Ball momentum method, focusing on discretization error and providing theoretical tools for deeper analysis.


<details>
  <summary>Details</summary>
Motivation: To bridge the gap between discrete optimization methods and their continuous approximations, particularly for the Heavy-Ball momentum method, by explicitly accounting for discretization error.

Method: Designs a first-order piece-wise continuous differential equation with counter terms to control discretization error to arbitrary order of step size.

Result: Provides a continuous time model for the HB method with controlled discretization error and applies it to study implicit regularization and bias in deep learning.

Conclusion: The work offers new theoretical insights and tools for analyzing momentum methods, supported by numerical experiments.
...
TL;DR: PARC is a framework to analyze prompt sensitivity in Vision Language Models (VLMs), revealing their instability to prompt variations and identifying robust models like InternVL2.


<details>
  <summary>Details</summary>
Motivation: VLMs, like LLMs, are prompt-sensitive, but their sensitivity in the vision domain is understudied. PARC aims to systematically evaluate this.

Method: PARC uses plausible prompt variations, a novel reliability score, and calibration to analyze VLM sensitivity across datasets and prompts.

Result: VLMs show language-like prompt sensitivity in vision, with destructive variations altering expected answers. InternVL2 models are notably robust.

Conclusion: PARC highlights VLM prompt sensitivity, links it to training data, and identifies robust models, aiding future VLM development.
...
TL;DR: A Model-Router framework dynamically selects the best forecasting model for sparse/intermittent demand, improving accuracy and efficiency in supply chains.


<details>
  <summary>Details</summary>
Motivation: Traditional forecasting models struggle with sparse/intermittent demand, impacting inventory management.

Method: Proposes a Model-Router framework using rule-based, LightGBM, and InceptionTime routers to assign optimal forecasting strategies.
...
Method: Introduces a modular neural network where modules selectively combine previous policies with internal policies, enabling linear parameter growth with task numbers.

Result: Outperforms alternatives in benchmark continuous control and visual tasks, showing better knowledge transfer and performance.

Conclusion: The proposed architecture effectively balances plasticity and scalability, achieving superior performance in continual reinforcement learning.
...
TL;DR: TRAINCHECK is a framework for detecting and diagnosing silent errors in deep learning training by inferring and using tailored invariants.
...
Method: TRAINCHECK automatically infers invariants for DL training and uses them to proactively detect errors, offering debugging assistance.

Result: It detected 18 out of 20 real-world silent errors in one iteration and found 6 unknown bugs in training libraries.

Conclusion: TRAINCHECK effectively addresses silent training errors, improving DL model training reliability.
...
TL;DR: The paper proposes a semi-supervised $p$-Laplacian regression model to predict body composition variables (ALM, BFP, BMD) using 3D optical images, achieving competitive accuracy despite limited training data.


<details>
  <summary>Details</summary>
Motivation: DXA scans for body composition measurement are costly and time-consuming, necessitating a cheaper, efficient alternative using 3D optical images and machine learning.

Method: A $p$-Laplacian regression model is introduced for semi-supervised learning, alongside supervised methods like SVR, tested on a dataset of 847 patients.

Result: The $p$-Laplacian model achieved errors of ~13% (ALM), ~10% (BMD), and ~20% (BFP) with 10% training data; SVR performed best (~8% error for ALM/BMD, ~11% for BFP) with 80% data.

Conclusion: The $p$-Laplacian model is a viable alternative in data-constrained healthcare settings, offering competitive performance with limited training data.
...
TL;DR: Smaller VLMs trained with GRPO and external tools like zoom outperform baselines in VQA tasks by leveraging detailed visual information.
...
Method: Training smaller models with GRPO, a simple reward structure, simplified tool-calling, and over-representing visually difficult examples in data.

Result: Improved performance on VQA tasks compared to similarly-sized baseline models.

Conclusion: GRPO and tool integration enhance VLM performance in resource-constrained settings.
...
<details>
  <summary>Details</summary>
Motivation: Deploying MLLMs in real-world scenarios is challenging due to distributed data and privacy constraints. Federated Learning (FL) is a solution, but existing methods fail for large-scale MLLMs due to high computational and communication demands.

Method: FedNano centralizes the LLM on the server and introduces NanoEdge, a lightweight client module with modality-specific encoders, connectors, and NanoAdapters using low-rank adaptation. This avoids deploying the full LLM on clients.

Result: FedNano reduces client storage by 95% and communication overhead to 0.01% of model parameters. It outperforms prior FL baselines, enabling scalable, decentralized MLLM deployment.

Conclusion: FedNano bridges the gap between MLLM scale and FL feasibility, offering a practical solution for privacy-preserving, resource-efficient multimodal AI systems.
...
TL;DR: The study evaluates four surrogate models (cGP, DGP, encoder-decoder neural networks, XGBoost) for predicting material properties in HEAs, finding DGP with ML-based prior superior in handling complex data and correlations.


<details>
  <summary>Details</summary>
Motivation: Accelerating HEA discovery and optimization by integrating computational predictions with sparse experimental data.
...
Conclusion: Advanced surrogate models like DGP enhance predictive accuracy, enabling robust and data-efficient materials design.
...
TL;DR: A hybrid BiGRU-MHA model is proposed for SSD health prediction, combining temporal feature extraction and dynamic feature weighting for high accuracy and stability.


<details>
  <summary>Details</summary>
Motivation: To enhance data reliability by improving SSD health state prediction accuracy and addressing generalization issues in traditional models.

Method: Uses a BiGRU network for bidirectional timing modeling and a multi-head attention mechanism for dynamic feature weighting.

Result: Achieves 92.70% training and 92.44% test accuracy, with a 0.94 AUC, showing strong generalization and binary classification performance.

Conclusion: The model reduces data loss risks, optimizes maintenance costs, and supports intelligent decision-making for reliable storage systems.
...
<details>
  <summary>Details</summary>
Motivation: Healthcare data is often incomplete, and ML models lack transparency, hindering their effectiveness in critical tasks like AMD diagnosis.

Method: CACTUS integrates genetic, dietary, clinical, and demographic factors for AMD classification, offering explainability and flexibility.

Result: CACTUS outperforms standard ML models, identifies key features, and reduces bias, aiding clinician decision-making.

Conclusion: CACTUS enhances AMD diagnosis by providing transparent, reliable, and actionable insights, improving trust and clinical outcomes.
...
<details>
  <summary>Details</summary>
Motivation: To enhance one-class classification by leveraging available negative samples without altering the original OC-SVM optimization.

Method: Proposes GRKneg, a kernel improvement for OC-SVM using negative samples, and evaluates its performance against standard OC-SVM and binary SVM.

Result: GRKneg outperforms standard OC-SVM with RBF kernel and binary SVM when negative samples are scarce.

Conclusion: GRKneg is effective for small-scale one-class classification with few negative samples, offering a robust alternative to standard methods.
...
<details>
  <summary>Details</summary>
Motivation: Online learning in VFL faces challenges due to asynchronous data streaming and non-intersecting feature sets among clients, which previous research overlooked.

Method: Proposed an event-driven online VFL framework where only a subset of clients are activated per event, and incorporated dynamic local regret (DLR) for non-convex models.
...
Conclusion: The event-driven approach with DLR effectively addresses online VFL challenges, offering practical benefits in real-world scenarios.
...
<details>
  <summary>Details</summary>
Motivation: Address the overlooked query cost in federated black-box prompt tuning for cloud-based LLMs.

Method: Proposed FedOne framework, optimizing query efficiency by degrading FedAvg to activate one client per round.

Result: Significant improvement in query efficiency, aligning with theoretical analysis.

Conclusion: FedOne is an effective method for federated black-box prompt learning with cloud-based LLMs.
...
TL;DR: Proposes automatic threshold definition for AE-based anomaly detection using ML algorithms (KNN, K-Means, SVM) to improve performance.


<details>
  <summary>Details</summary>
Motivation: Addresses the challenge of non-standardized threshold definition in AE-based anomaly detection, which impacts performance.

Method: Evaluates three ML algorithms (KNN, K-Means, SVM) to automatically define the threshold for reconstruction error classification.

Result: Not explicitly stated in the abstract, but implies improved anomaly detection performance.

Conclusion: Automating threshold definition with ML algorithms can enhance AE-based anomaly detection systems.
...
Method: Characterization of channels in the loss landscape where weights diverge to infinity, forming gated linear units, using gradient dynamics and geometric analysis.

Result: Gradient flow and optimization methods often reach these channels, which appear as flat minima but lead to gated linear units.

Conclusion: The study reveals unexpected computational capabilities of fully connected layers through the emergence of gated linear units in quasi-flat regions.
...
TL;DR: The paper introduces Guru, a curated RL reasoning corpus for diverse domains, and demonstrates its effectiveness in improving LLM reasoning through RL training, revealing nuanced performance variations across domains.


<details>
  <summary>Details</summary>
Motivation: To address the lack of reliable, scalable RL reward signals for diverse reasoning domains and expand the understanding of RL's applicability beyond math and code.

Method: Developed Guru, a corpus of 92K verifiable examples across six reasoning domains, with domain-specific reward design, deduplication, and filtering. Evaluated RL training effects across domains and introduced Guru-7B and Guru-32B models.

Result: Guru-7B and Guru-32B achieved state-of-the-art performance, outperforming baselines by 7.9% and 6.7% on a 17-task evaluation suite. RL training showed varied effectiveness, with in-domain training required for less pretrained domains.

Conclusion: RL can facilitate genuine skill acquisition in LLMs, especially for domains with limited pretraining exposure. The release of data and models aims to advance general-purpose reasoning.
...
<details>
  <summary>Details</summary>
Motivation: Accurate error estimation in unseen domains is crucial for safe ML systems. Prior DIS² methods compete in overlapping regions, limiting reliability.
...
<details>
  <summary>Details</summary>
Motivation: Early prediction of MS disability progression is difficult due to disease heterogeneity, motivating the use of advanced models to integrate clinical and digital data.
...
Result: Integration of digital data improved prediction performance, with the multimodal transformer outperforming unimodal models (best AUROC 0.63).

Conclusion: Multimodal approaches and foundation models show promise for extracting predictive signals from diverse clinical and digital data, aiding MS and other complex disease prognostics.
...
TL;DR: A multi-agent multi-armed bandit (MA-MAB) framework is proposed to balance fairness and performance, using strategic probing and algorithms for offline and online settings.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of fair decision-making under limited information about arm rewards in multi-agent systems.
...
TL;DR: The paper shows that stable Controlled Differential Equations (CDE) state representations improve RL policies for sepsis treatment by ensuring training stability and acuity-aware representations.


<details>
  <summary>Details</summary>
Motivation: The study addresses the overlooked challenge of training instability in sequential representations for sepsis treatment, which harms policy performance.

Method: The authors use CDE state representations with early stopping or stabilization methods and enforce acuity-aware representations via correlation regularization with clinical scores.

Result: Stable CDE representations correlate strongly with acuity scores and enable superior RL policies (WIS return > 0.9), while unstable ones fail (WIS return ~ 0).
...
TL;DR: SFT-GO introduces a novel supervised fine-tuning method for LLMs by grouping tokens based on importance, optimizing with weighted loss, and outperforming baselines.
...
Method: SFT-GO groups tokens by importance, using a weighted combination of worst-group loss and cross-entropy loss to optimize LLMs.

Result: SFT-GO consistently outperforms baselines across benchmarks, datasets, and base models.

Conclusion: SFT-GO is robust and effective, improving learning dynamics and model performance.
...
TL;DR: SPG introduces a lightweight online hyperparameter optimization method using sequential policy gradient modeling, reducing computational costs while improving performance.


<details>
  <summary>Details</summary>
Motivation: Conventional reinforcement learning methods for hyperparameter optimization are too costly, limiting widespread use.
...
Conclusion: SPG is a practical, efficient solution for hyperparameter optimization, outperforming standard methods and enabling broader adoption.
...
Method: Uses staged training to refine residuals with additional networks, optimizing loss functions, parameters, and adaptive data sampling.

Result: Validated effectiveness through benchmark problems, showing improved accuracy.

Conclusion: HiPreNets offer a structured approach to enhance neural network precision, addressing key limitations of traditional methods.
...
TL;DR: The paper studies hallucinations in LLM-based embodied agents during long-horizon tasks, revealing high hallucination rates under scene-task inconsistencies and proposing insights for robust planning.


<details>
  <summary>Details</summary>
Motivation: To understand the extent and triggers of hallucinations in LLM-based embodied agents, addressing navigation errors caused by grounding failures.
...
Result: Models showed reasoning but failed to resolve scene-task inconsistencies, with hallucination rates up to 40x higher than base prompts.

Conclusion: Highlights limitations in handling infeasible tasks and offers actionable insights for developing more reliable planning strategies.
...
TL;DR: The paper proposes a Neural Canonical Polyadic Factorization (NCPF) model for robust traffic data imputation, combining low-rank tensor algebra and deep learning to address missing data issues in traffic analysis.


<details>
  <summary>Details</summary>
Motivation: Missing data in traffic systems due to sensor failures and sensing gaps hinders reliable modeling, necessitating robust imputation methods.

Method: NCPF integrates CP decomposition into neural networks via learnable embeddings and uses hierarchical feature fusion with Hadamard products and MLPs to model spatiotemporal interactions.
...
TL;DR: This paper surveys machine unlearning verification methods, proposing a taxonomy (behavioral and parametric verification) and highlighting gaps in current research.


<details>
  <summary>Details</summary>
Motivation: Address the lack of unified taxonomy and systematic evaluation framework for verifying machine unlearning operations.

Method: Proposes a taxonomy categorizing verification methods into behavioral and parametric, analyzing their assumptions, strengths, and limitations.

Result: Identifies vulnerabilities in current methods and provides a foundation for future research.

Conclusion: Highlights open problems and calls for more robust and efficient verification mechanisms.
...
TL;DR: Proposes ImprovDML, a decentralized DML framework for high model accuracy, privacy preservation, and Byzantine resilience, using resilient vector consensus and Gaussian noise.


<details>
  <summary>Details</summary>
Motivation: Addressing the trade-off between Byzantine resilience, privacy, and model accuracy in DML.

Method: Uses resilient vector consensus for aggregation and multivariate Gaussian noise for privacy.

Result: Achieves tighter error bounds and better privacy-accuracy trade-off than existing methods.

Conclusion: ImprovDML effectively balances resilience, privacy, and accuracy, validated by simulations.
...
Result: Validated on grid worlds, labyrinths, and animal videos, SKIL identifies reusable skills, learns compositional policies, and generates realistic trajectories.

Conclusion: SKIL provides a principled account of how complex behaviors emerge from dynamic combinations of motor primitives, outperforming traditional models.
...
TL;DR: The paper evaluates ML techniques for solving the 1D Poisson equation, emphasizing quantitative accuracy and generalization. It identifies critical factors like data function space and proves generalization bounds. Empirical results confirm theoretical findings, revealing inconsistent generalization across models. A new interpretability method and cross-validation technique are proposed.


<details>
  <summary>Details</summary>
Motivation: To rigorously assess ML's accuracy in scientific applications, focusing on the 1D Poisson equation, as visuals can mislead and quantitative precision is essential.

Method: Analyzes training dynamics, derives optimal parameters, and proves generalization bounds for white-box and black-box models. Tests deep linear models, shallow networks, and physics-specific models empirically.

Result: Generalization to the true equation isn't guaranteed; models show opposing behaviors. Green's function representations are extracted from black-box models.

Conclusion: Proposes a new cross-validation technique for evaluating generalization in physical systems, suggesting the Poisson equation as a benchmark for future methods.
...
TL;DR: SoKA is a parameter-efficient fine-tuning method combining Kronecker-product factorization and SVD-driven initialization, outperforming existing PEFT methods with fewer parameters and faster convergence.


<details>
  <summary>Details</summary>
Motivation: Full fine-tuning of large Transformer models is costly in storage, memory, and computation. Existing PEFT methods have drawbacks like latency, suboptimal convergence, or inflexible rank choices.
...
Result: On LLaMA2-7B, SoKA achieves comparable or better performance with 0.99M parameters (25% fewer than LoRA/PiSSA) and faster convergence.

Conclusion: SoKA is a robust and efficient PEFT method for large-scale model adaptation, offering stability and reduced computational costs.
...
TL;DR: The paper investigates the robustness of federated learning to Byzantine behavior, focusing on the tradeoff between averaging and validity conditions. It provides theoretical bounds on centroid approximation and introduces a new algorithm for convex validity.


<details>
  <summary>Details</summary>
Motivation: To understand whether federated learning is robust to Byzantine behavior and explore the tradeoff between averaging and validity conditions in distributed computing.

Method: The study uses theoretical analysis to derive lower and upper bounds on centroid approximation under box validity and introduces a new algorithm for convex validity. Empirical evaluations in federated learning settings complement the analysis.

Result: The paper establishes a lower bound of min{(n-t)/t, √d} and an upper bound of 2min{n, √d} on centroid approximation. A new algorithm achieves a √(2d)-approximation under convex validity, proving tightness of existing bounds.

Conclusion: The findings highlight limitations in current validity conditions and provide new theoretical and algorithmic insights for robust federated learning, with empirical validation.
...
<details>
  <summary>Details</summary>
Motivation: Existing DI methods need in-distribution held-out data, which is rarely available, limiting their practicality. The work aims to overcome this by synthetically generating such data.

Method: The approach involves (1) training a data generator on a suffix-based completion task to create diverse synthetic data and (2) post-hoc calibration to align synthetic and real data likelihoods.
...
Conclusion: The method reliably addresses the held-out data challenge, making DI practical for real-world use in verifying unauthorized data usage.
...
TL;DR: DOVA-PATBM is a geo-computational framework for optimizing EV charging infrastructure, balancing urban, suburban, and rural needs, and improving coverage and equity efficiently.


<details>
  <summary>Details</summary>
Motivation: The need for scalable, data-rich infrastructure planning tools to address the conflicting requirements of diverse geographic areas (urban, suburban, rural) for EV charging networks.

Method: Uses a hierarchical H3 grid to rasterize data, a graph neural network for intersection importance, Voronoi tessellation for charger placement, and a queue model for sizing ports. A greedy heuristic selects sites for coverage and equity.

Result: In Georgia, USA, DOVA-PATBM improved 30 km coverage by 12%, halved travel distance for low-income residents, and met power constraints, remaining scalable for national use.

Conclusion: The framework bridges academic optimization and practical infrastructure policy, proving effective for large-scale EV charging deployment.
...
Method: Combines QRGMM for sales distribution modeling and DeepFM for covariate interactions, creating a unified framework for risk estimation and loan size determination.

Result: Validated efficacy through synthetic and real-world data, improving risk assessment and SME access to capital.

Conclusion: Pioneers generative AI in CBEC SCF risk management, enhancing credit practices and SME financing opportunities.
...
TL;DR: SecFwT is a novel MPC-based framework for efficient, privacy-preserving fine-tuning of LLMs, addressing computational overhead and inefficiency in MPC settings.


<details>
  <summary>Details</summary>
Motivation: The adaptation of LLMs to privacy-sensitive domains is hindered by data scarcity and computational challenges in MPC-based fine-tuning.

Method: SecFwT introduces forward-only tuning and MPC-friendly Random Feature Attention to reduce computational complexity.

Result: SecFwT significantly improves efficiency and privacy preservation in LLM fine-tuning.

Conclusion: SecFwT enables scalable and secure fine-tuning of LLMs for privacy-critical applications.
...
TL;DR: A structured active learning method integrates Seq2Seq VAE to optimize multi-target drug design, balancing diversity, quality, and affinity, demonstrated on coronavirus proteases.
...
Method: Combines Seq2Seq VAE with iterative loops for chemical diversity and multi-target affinity, using strategic filters.

Result: Generated diverse pan-inhibitor candidates for coronavirus proteases, improving exploration of chemical space.

Conclusion: Provides a generalizable framework for efficient multi-objective drug design in polypharmacology.
...
<details>
  <summary>Details</summary>
Motivation: To understand why ICL works despite imperfect labels and to improve semi-supervised learning in tabular data.

Method: Theoretical analysis using binary Gaussian mixture models (GMM) and experiments with looping transformers to exploit unlabeled data.

Result: Multilayer transformers outperform single-layer models by constructing polynomial estimators, with performance improving exponentially with depth.

Conclusion: Looping transformers enhances semi-supervised learning, validated by real-world dataset evaluations.
...
TL;DR: The paper proposes a method to predict abnormal lab test values using a set translation approach, improving AUC by up to 8% for certain conditions.


<details>
  <summary>Details</summary>
Motivation: Early diagnosis via predicting abnormal lab values from performed tests, leveraging the widely used CBC test and routine biochemical panels.
...
Conclusion: The approach effectively bridges LLMs with tabular data, enhancing clinical lab predictions without imputing missing values.
...
TL;DR: A novel knowledge distillation framework uses an off-the-shelf pre-trained NNP as a teacher to generate training data, reducing DFT calculations by 10x while maintaining accuracy.
...
Method: A two-stage training process: first, train the student NNP with data from an off-the-shelf teacher; then fine-tune with a smaller DFT dataset.

Result: Achieves comparable or superior accuracy in reproducing physical properties for organic and inorganic materials, with 10x fewer DFT calculations.

Conclusion: The proposed framework efficiently generates accurate NNPs for MD simulations, reducing computational costs without sacrificing performance.
...
<details>
  <summary>Details</summary>
Motivation: Current diffusion models in FWI struggle with iterative sampling and lack clear methods to incorporate approximate velocity models, limiting their practicality.

Method: The authors propose cI²SB, extending the Image-to-Image Schrödinger Bridge to conditional sampling, enabling efficient interpolation between ground truth and smoothed velocity models.
...
<details>
  <summary>Details</summary>
Motivation: Existing one-run DP auditing methods in black-box settings show a gap between empirical lower bounds and theoretical upper bounds. The study aims to bridge this gap.

Method: Incorporates stronger MIA techniques, specifically quantile regression, into one-run auditing for DP-SGD in black-box settings.

Result: The proposed approach achieves tighter empirical lower bounds while maintaining computational efficiency, as demonstrated on CIFAR-10 image classification models.

Conclusion: Using quantile regression for MIA in one-run auditing improves black-box DP auditing, closing the gap between empirical and theoretical bounds efficiently.
...
<details>
  <summary>Details</summary>
Motivation: Applying DiTs to molecules introduces challenges like combining discrete graph data with continuous 3D geometry and managing Euclidean symmetries.

Method: DiTMC uses a modular architecture to separate 3D coordinate processing from atomic connectivity conditioning, with graph-based conditioning strategies and flexible attention mechanisms.

Result: DiTMC achieves state-of-the-art precision and physical validity on benchmarks (GEOM-QM9, -DRUGS, -XL).

Conclusion: The framework highlights the impact of architectural choices and symmetry priors, suggesting directions for large-scale molecular structure modeling.
...
TL;DR: A novel method for learning ground metrics in optimal transport improves performance in tasks like embedding, clustering, and classification by using class labels on a distribution-level.


<details>
  <summary>Details</summary>
Motivation: Predefined or supervised ground metrics in optimal transport often fail to generalize or account for data structure.

Method: Proposes a global ground metric learning approach using distribution-level class labels for arbitrary distributions over a shared metric space.

Result: The learned metric enhances optimal transport distances, improving performance in embedding, clustering, and classification.

Conclusion: The method is effective and interpretable, demonstrated on patient-level scRNA-seq data across multiple diseases.
...
<details>
  <summary>Details</summary>
Motivation: To enable exploration in generative models without explicit uncertainty quantification, particularly for novel design generation.

Method: Uses entropy maximization over a diffusion model's data manifold, connects entropy to the score function, and employs mirror descent for sequential fine-tuning.

Result: Convergence to the optimal exploratory diffusion model is proven, and empirical results show promise in synthetic and text-to-image tasks.

Conclusion: The framework effectively addresses exploration challenges in generative models, offering scalability and theoretical guarantees.
...
<details>
  <summary>Details</summary>
Motivation: To tackle the challenge of optimal vaccination when the underlying graph is unknown, focusing on minimizing disease spread time.

Method: Splits the problem into graph learning (using an inclusion-exclusion-based algorithm) and vaccination strategy (optimal and greedy algorithms for SRM).

Result: Establishes sample complexity for graph recovery, proves polynomial runtime for bounded treewidth graphs, and validates algorithms with experiments.

Conclusion: The proposed methods effectively learn graphs and optimize vaccination, with practical validation on synthetic and real-world data.
...
TL;DR: The paper addresses the lack of standardized evaluation protocols for Explainable AI (XAI) methods by introducing a unified framework (VXAI) and categorizing metrics from 362 publications.
...
Method: A systematic literature review following PRISMA guidelines, aggregating 362 publications into 41 metric groups and proposing a three-dimensional categorization scheme.

Result: The VXAI framework provides a comprehensive, structured overview of XAI evaluation metrics, enhancing comparability and systematic selection.

Conclusion: The framework supports future XAI research by offering a flexible, standardized approach to evaluating explanation methods.
...
TL;DR: A survey on reward modeling techniques in deep RL, covering background, recent approaches, applications, evaluation methods, and future directions.


<details>
  <summary>Details</summary>
Motivation: To systematically review and categorize reward modeling techniques in RL, addressing the gap in current literature.
...
Result: Provides a comprehensive overview of reward modeling, including established and emerging methods.
...
<details>
  <summary>Details</summary>
Motivation: To address the degradation of zero-shot RL methods in partially observable environments.

Method: Memory-based architectures are introduced to handle partial observability in zero-shot RL.

Result: Improved performance over memory-free baselines in partially observable domains.

Conclusion: Memory-based methods are effective for zero-shot RL under partial observability.
...
TL;DR: RHO proposes adaptive homophily learning for semi-supervised graph anomaly detection, outperforming existing methods by capturing diverse homophily patterns in normal nodes.
...
Method: RHO uses adaptive frequency response filters (AdaFreq) to learn spectral filters for varying homophily and graph normality alignment (GNA) for consistency.
...
Conclusion: RHO robustly captures varying homophily in normal nodes, improving anomaly detection performance.
...
<details>
  <summary>Details</summary>
Motivation: Existing elastic distance measures lack qualitative comparison, and traditional visualizations fail to convey broader structural relationships, making it hard to understand shifts or speed changes.

Method: The proposed technique simplifies the warping path to quantify and visualize key transformations like shift, compression, and amplitude differences.

Result: The method provides a clearer representation of how subsequences match, enhancing interpretability in time series comparison.

Conclusion: The technique improves qualitative understanding of time series comparisons by highlighting key transformations, addressing limitations of existing methods.
...
<details>
  <summary>Details</summary>
Motivation: Current DR techniques lack the ability to explore semantic structures not directly available in variables or labels.
...
TL;DR: PRISM is a new framework for interpreting neural network features, addressing limitations of current methods by handling polysemanticity and improving description accuracy.


<details>
  <summary>Details</summary>
Motivation: Current feature description methods are limited by assumptions of monosemanticity and lack robustness, restricting their ability to fully capture neural network behaviors.
...
Result: PRISM outperforms existing methods in description quality and capturing polysemanticity, as shown in benchmarks.

Conclusion: PRISM enhances interpretability by better reflecting the complexity of neural network features, offering more accurate and faithful descriptions.
...
TL;DR: LIT-LVM introduces a low-dimensional latent vector representation for features to estimate interaction term coefficients in linear predictors, outperforming elastic net and factorization machines in high-dimensional settings.
...
Method: LIT-LVM represents features with low-dimensional latent vectors, leveraging structured regularization to mitigate overfitting.

Result: LIT-LVM achieves superior prediction accuracy, especially with many interaction terms, and provides interpretable latent representations.

Conclusion: LIT-LVM is an effective method for estimating interaction terms, offering better accuracy and interpretability than existing approaches.
...
TL;DR: The paper introduces LoX, a training-free method to enhance safety robustness in LLMs by extrapolating safety-critical low-rank subspaces, reducing attack success rates significantly.


<details>
  <summary>Details</summary>
Motivation: Addressing the vulnerability of aligned LLMs to safety protection undermining during fine-tuning, even with benign data.

Method: Proposes Low-Rank Extrapolation (LoX) to extrapolate safety subspaces in LLM parameters, making them less sensitive to perturbations.

Result: LoX reduces attack success rates by 11% to 54% against benign or malicious fine-tuning attacks while maintaining task adaptability.

Conclusion: LoX effectively improves safety robustness in LLMs by moving parameters to flatter zones, mitigating fine-tuning vulnerabilities.
...
<details>
  <summary>Details</summary>
Motivation: Post-hoc attribution methods are non-robust to small input perturbations, undermining their trustworthiness, necessitating rigorous robustness guarantees.
...
Conclusion: The proposed framework enables reliable use of attribution methods in downstream tasks by providing certified robustness.
...
Method: AutoRule uses a reasoning model to interpret preferences, extracts candidate rules, and synthesizes them into a unified set. It employs language-model verifiers to compute rule satisfaction as an auxiliary reward.

Result: Training with AutoRule improves win rates by 28.6% on AlpacaEval2.0 and gains 6.1% on MT-Bench compared to GRPO. Rules align well with dataset preferences.

Conclusion: AutoRule effectively automates rule extraction, enhances performance, and reduces reward hacking, capturing unique dataset qualities.
...
<details>
  <summary>Details</summary>
Motivation: Research on adversarial attacks in tabular data is scattered, unlike in computer vision and NLP, necessitating a structured review.

Method: Conducted a systematic literature review to categorize attack strategies and analyze their real-world applicability.

Result: Identified key trends, attack categories, and practical considerations, along with current challenges and open questions.

Conclusion: The review provides a structured overview to guide future research on adversarial vulnerabilities in tabular ML.
...
TL;DR: The paper formalizes spatiotemporal over-squashing in STGNNs, showing its unique challenges compared to static GNNs. It reveals counterintuitive propagation biases and validates findings on synthetic and real-world datasets.


<details>
  <summary>Details</summary>
Motivation: To address the unexplored issue of over-squashing in STGNNs, where temporal dimensions exacerbate information propagation limitations.

Method: Theoretical analysis of spatiotemporal over-squashing, comparing static and dynamic contexts, and empirical validation on datasets.

Result: Convolutional STGNNs favor distant temporal information propagation, and time-and-space or time-then-space paradigms are equally affected.

Conclusion: Provides insights into STGNN dynamics and guidance for more effective designs, validated empirically.
...
TL;DR: The paper investigates dense latents in sparse autoencoders (SAEs), showing they are meaningful and persistent, not just training artifacts. It analyzes their geometry, function, and evolution across layers.


<details>
  <summary>Details</summary>
Motivation: To understand whether dense latents in SAEs are undesirable artifacts or meaningful representations in language models.

Method: Systematic study of dense latents' geometry and function, including ablation experiments and a taxonomy of their roles. Analysis of their evolution across model layers.

Result: Dense latents form antipodal pairs, reconstruct specific directions, and serve functional roles (e.g., position tracking, semantic features). They evolve from structural to semantic to output-oriented signals.

Conclusion: Dense latents are intrinsic to language models and serve functional purposes, not just noise.
...
TL;DR: RePCS is a model-agnostic method to detect if LLMs bypass retrieved evidence in RAG systems by comparing output distributions of parametric and retrieval-augmented paths using KL divergence.


<details>
  <summary>Details</summary>
Motivation: To address the issue of LLMs relying on memorized data instead of retrieved evidence in RAG systems, which can lead to contaminated outputs.

Method: RePCS compares two inference paths (parametric and retrieval-augmented) using KL divergence to measure the impact of retrieved context. It requires no model access or retraining.

Result: RePCS achieves a ROC-AUC of 0.918 on Prompt-WNQA, outperforming prior methods by 6.5 percentage points with minimal latency overhead.

Conclusion: RePCS provides a lightweight, black-box solution to verify meaningful retrieval use in RAG systems, crucial for safety-critical applications.
...
<details>
  <summary>Details</summary>
Motivation: To make the analysis of SGD in overparameterized models more accessible and facilitate further improvements in training realistic models.

Method: Uses simple linear algebra tools to derive bias and variance bounds for SGD, avoiding complex PSD matrix manipulations.
...
Conclusion: The simplified analysis enhances accessibility and could aid in advancing SGD techniques like mini-batching and learning rate scheduling.
...
Result: Shows that learning computable functions from policy trajectories reduces to learning rational functions, but computable or polynomial-mass characteristic sets do not exist for linear-time computable functions.

Conclusion: The study reveals new learnability insights and connections to finite-state transducer inference, while highlighting limitations for certain function classes.
...
TL;DR: The paper investigates scaling challenges in deep reinforcement learning, attributing them to non-stationarity and gradient pathologies, and proposes simple interventions to stabilize gradient flow for robust performance.


<details>
  <summary>Details</summary>
Motivation: Understanding and addressing the root causes of degraded performance when scaling deep reinforcement learning networks.

Method: Conducts empirical analyses to identify issues (non-stationarity and gradient pathologies) and proposes simple interventions to stabilize gradient flow.
...
Conclusion: Simple, compatible interventions effectively address scaling challenges, enabling strong performance at large scales.
...
TL;DR: DAILOC is a domain-incremental learning framework for Wi-Fi fingerprinting-based indoor localization, addressing device heterogeneity and temporal variations. It outperforms existing methods with lower errors.


<details>
  <summary>Details</summary>
Motivation: Challenges in real-world Wi-Fi fingerprinting due to domain shifts from device heterogeneity and temporal variations, leading to poor generalization and catastrophic forgetting.

Method: Proposes DAILOC, using a multi-level variational autoencoder for disentangling domain shifts and a memory-guided class latent alignment mechanism.

Result: Achieves up to 2.74x lower average error and 4.6x lower worst-case error compared to state-of-the-art methods.

Conclusion: DAILOC effectively addresses domain shifts and catastrophic forgetting, significantly improving indoor localization accuracy.
...
Method: LogNet uses logic gates to transparently reason about influential access points and noise impact on localization decisions.
...
Conclusion: LogNet improves interpretability and long-term reliability of DL-based indoor localization, outperforming existing methods.
...
TL;DR: A compositional approach using expert models achieves higher accuracy and efficiency than baseline methods.
...
Conclusion: The Expert Composition method is effective and efficient for compositional tasks.
...
TL;DR: MicroRicci is a self-tuning, local Ricci-flow solver using coding theory and neural modules for efficient mesh smoothing, achieving faster convergence and better quality than state-of-the-art methods.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenges of real-time mesh smoothing, where classical methods are costly and greedy heuristics are slow or brittle.

Method: Uses a greedy syndrome-decoding step for curvature correction and two neural modules for adaptive vertex and step-size selection.

Result: Reduces iteration counts by 2.4x, tightens curvature spread, and improves UV-distortion correlation, with minimal runtime overhead.

Conclusion: MicroRicci is efficient and high-quality, ideal for real-time applications in graphics and simulation.
...
<details>
  <summary>Details</summary>
Motivation: Standard DP methods like DP-Adam have high memory overhead, limiting scalability. DP-GRAPE aims to address this issue.
...
Result: DP-GRAPE reduces memory usage by over 63% for Vision Transformers and 70% for RoBERTa-Large, with similar performance to DP-Adam.

Conclusion: DP-GRAPE offers a scalable, memory-efficient DP training method without sacrificing accuracy or utility.
...
TL;DR: The paper introduces GFLC, a method to correct biased and noisy labels in ML datasets while maintaining fairness, improving both performance and fairness metrics.


<details>
  <summary>Details</summary>
Motivation: Fairness in ML is crucial as AI impacts society, but biased training data undermines fairness. Existing methods struggle with label noise and bias.
...
Conclusion: GFLC effectively addresses label bias and noise while preserving fairness, offering a robust solution for fairness-aware ML.
...
Method: Used FLAIR images from 1674 patients across 16 centers, comparing centralized learning, FL, and single-site learning. Examined associations with vascular risk factors and functional outcomes using logistic regression.

Result: FL outperformed single-site models, and BrainAGE was significantly higher in diabetic patients. BrainAGE also strongly correlated with post-stroke recovery.

Conclusion: FL enables accurate BrainAGE predictions without data centralization, demonstrating its potential for prognostic modeling in stroke care.
...
<details>
  <summary>Details</summary>
Motivation: To mitigate the over-conservatism in AWRs caused by poor explorations in offline data, which leads to suboptimal policies.

Method: Introduces CAWR, combining robust loss functions for policy optimization and advantage-based prioritized experience replay to filter poor explorations.

Result: CAWR outperforms on the D4RL benchmark, learning superior policies from suboptimal data.

Conclusion: CAWR effectively reduces over-conservatism and enhances policy optimization in offline RL.
...
### [217] [Identifying economic narratives in large text corpora -- An integrated approach using Large Language Models](https://arxiv.org/abs/2506.15041)
*Tobias Schmidt,Kai-Robin Lange,Matthias Reccius,Henrik Müller,Michael Roos,Carsten Jentsch*

Main category: econ.GN

TL;DR: The paper evaluates GPT-4o's ability to extract economic narratives from news articles, finding it effective but not expert-level.
...
Method: Analyzed Wall Street Journal and New York Times articles on inflation, comparing GPT-4o outputs to expert-annotated gold standards.

Result: GPT-4o extracts valid economic narratives but struggles with complex documents and narratives compared to experts.

Conclusion: LLMs like GPT-4o show promise for economic research but require further refinement and guidance for complex tasks.
...
### [218] [CNN-Enabled Scheduling for Probabilistic Real-Time Guarantees in Industrial URLLC](https://arxiv.org/abs/2506.14987)
*Eman Alqudah,Ashfaq Khokhar*

Main category: cs.NI

TL;DR: Enhanced LDP algorithm with CNN-based dynamic priority prediction improves interference coordination in URLLC networks, achieving significant SINR gains.


<details>
  <summary>Details</summary>
Motivation: Ensuring packet-level communication quality is critical for URLLC in large-scale industrial wireless networks.

Method: Combines CNN and graph coloring to dynamically assign link priorities based on real-time traffic and network conditions.

Result: Simulations show SINR gains of up to 113%, 94%, and 49% over LDP in various network configurations.

Conclusion: The approach efficiently boosts network capacity, SINR, and schedulability for complex URLLC scenarios.
...
### [219] [GCN-Driven Reinforcement Learning for Probabilistic Real-Time Guarantees in Industrial URLLC](https://arxiv.org/abs/2506.15011)
*Eman Alqudah,Ashfaq Khokhar*
...
Method: Combines Graph Convolutional Network (GCN) with Deep Q-Network (DQN) to dynamically adjust link priorities based on real-time factors like traffic demand and interference.
...
### [220] [An accurate and revised version of optical character recognition-based speech synthesis using LabVIEW](https://arxiv.org/abs/2506.15029)
*Prateek Mehta,Anasuya Patil*

Main category: cs.SD

TL;DR: A cost-effective OCR-based speech synthesis system for visually impaired individuals, developed using LabVIEW, to improve access to books.


<details>
  <summary>Details</summary>
Motivation: Visually impaired individuals face limited access to books due to reliance on Braille and audio recordings. Speech is a more effective communication mode for them.

Method: Development of an OCR-based speech synthesis system using LabVIEW for accuracy, reliability, and cost-effectiveness.

Result: An OCR-based system was successfully implemented to convert text to speech, aiding visually impaired users.

Conclusion: The system provides a user-friendly, reliable solution for visually impaired individuals to access books of their choice.
...
### [221] [SonicVerse: Multi-Task Learning for Music Feature-Informed Captioning](https://arxiv.org/abs/2506.15154)
...
<details>
  <summary>Details</summary>
Motivation: To enrich music databases and advance music AI research by creating accurate, descriptive captions for music pieces.

Method: Uses a projection-based architecture to transform audio into language tokens and detect music features via auxiliary heads, integrating these into caption generation.

Result: Incorporating music features enhances caption quality and detail, enabling rich descriptions for both short and long music pieces.

Conclusion: SonicVerse effectively combines feature detection and captioning, offering a robust tool for music AI applications.
...
### [222] [pycnet-audio: A Python package to support bioacoustics data processing](https://arxiv.org/abs/2506.14864)
*Zachary J. Ruff,Damon B. Lesmeister*

Main category: cs.SD

TL;DR: Passive acoustic monitoring uses ARUs to record wildlife sounds, requiring automated processing for large datasets. pycnet-audio provides a workflow using PNW-Cnet to detect vocalizations of 80+ species and noise.
...
Method: Deploy ARUs for extended recording, then use pycnet-audio with PNW-Cnet for automated signal detection.

Result: PNW-Cnet detects vocalizations of ~80 species and various noise types, aiding wildlife research.

Conclusion: pycnet-audio offers a practical solution for automated acoustic data processing in wildlife monitoring.
...
### [223] [A Comparative Evaluation of Deep Learning Models for Speech Enhancement in Real-World Noisy Environments](https://arxiv.org/abs/2506.15000)
*Md Jahangir Alam Khondkar,Ajan Ahmed,Masudul Haider Imtiaz,Stephanie Schuckers*

Main category: cs.SD

TL;DR: The paper benchmarks Wave-U-Net, CMGAN, and U-Net for speech denoising, highlighting their strengths in noise suppression, perceptual quality, and speaker feature retention.
...
Method: Benchmarking three models (Wave-U-Net, CMGAN, U-Net) on datasets like SpEAR, VPQAD, and Clarkson, evaluating SNR, PESQ, and VeriSpeak scores.

Result: U-Net excels in noise suppression, CMGAN in perceptual quality, and Wave-U-Net in speaker feature retention.

Conclusion: The study demonstrates how advanced methods can optimize trade-offs in speech enhancement, benefiting applications like voice biometrics and telecommunication.
...
### [224] [Diff-TONE: Timestep Optimization for iNstrument Editing in Text-to-Music Diffusion Models](https://arxiv.org/abs/2506.15530)
*Teysir Baoueb,Xiaoyu Bie,Xi Wang,Gaël Richard*

Main category: cs.SD

TL;DR: The paper explores using text-to-music diffusion models for instrument editing without additional training, preserving content while altering timbre.


<details>
  <summary>Details</summary>
Motivation: Controlling text-to-music generation for specific outcomes is challenging; the paper aims to edit instruments in existing tracks while maintaining content.

Method: Leverages a pretrained text-to-music diffusion model, using an intermediate timestep identified via an instrument classifier to balance content preservation and timbre change.

Result: Achieves instrument editing without extra training or speed compromise, balancing content and timbre.

Conclusion: The method effectively edits instruments in audio tracks using existing models, offering practical utility for musicians.
...
### [225] [Advanced Prediction of Hypersonic Missile Trajectories with CNN-LSTM-GRU Architectures](https://arxiv.org/abs/2506.15043)
*Amir Hossein Baradaran*

Main category: cs.CR

TL;DR: A hybrid deep learning approach (CNNs, LSTMs, GRUs) accurately predicts hypersonic missile trajectories, enhancing defense strategies.


<details>
  <summary>Details</summary>
Motivation: Hypersonic missiles' extreme speeds and maneuverability challenge defense systems, necessitating accurate trajectory prediction.
...
Conclusion: Advanced machine learning significantly improves defense system predictive capabilities.
...
### [226] [RAS-Eval: A Comprehensive Benchmark for Security Evaluation of LLM Agents in Real-World Environments](https://arxiv.org/abs/2506.15253)
...
<details>
  <summary>Details</summary>
Motivation: Address the lack of standardized security benchmarks for LLM agents in dynamic environments.

Method: Introduce RAS-Eval with 80 test cases and 3,802 attack tasks across 11 CWE categories, evaluating 6 LLMs.

Result: Attacks reduced TCR by 36.78% on average, with an 85.65% success rate in academic settings. Larger models performed better.

Conclusion: RAS-Eval exposes critical risks in LLM agent deployments and offers a foundation for security research.
...
### [227] [Evaluation Pipeline for systematically searching for Anomaly Detection Systems](https://arxiv.org/abs/2506.15388)
*Florian Rokohl,Alexander Lehnert,Marc Reichenbach*

Main category: cs.CR

TL;DR: Anomaly detection system on hardware for real-time malicious client detection in medical digitalization, using FPGAs to meet real-time and power constraints.
...
Method: Proposes an anomaly detection system on hardware, utilizing FPGAs to address real-time and power constraints.

Result: Achieves overall system performance through holistic system evaluation.

Conclusion: The system effectively detects malicious clients in real-time while meeting hardware constraints.
...
### [228] [Winter Soldier: Backdooring Language Models at Pre-Training with Indirect Data Poisoning](https://arxiv.org/abs/2506.14913)
*Wassim Bouaziz,Mathurin Videau,Nicolas Usunier,El-Mahdi El-Mhamdi*

Main category: cs.CR

TL;DR: The paper demonstrates indirect data poisoning to protect datasets and trace their usage in LLMs, using gradient-based prompt-tuning to teach secret sequences without performance loss.
...
Method: Uses gradient-based optimization prompt-tuning to teach secret sequences (absent from training data) to models.

Result: Shows feasibility with <0.005% poisoned tokens, achieving high-confidence detection (p < 10^-55) without performance degradation.

Conclusion: Indirect data poisoning is effective for dataset protection and tracing, even without secrets in the training set.
...
### [229] [Private Continual Counting of Unbounded Streams](https://arxiv.org/abs/2506.15018)
...
<details>
  <summary>Details</summary>
Motivation: Existing algorithms for differentially private continual counting require prior knowledge of input size, leading to suboptimal performance when the size is unknown. This work addresses this limitation.

Method: The authors propose new matrix factorizations based on logarithmic perturbations of a specific function, enabling efficient and smooth error estimation without prior knowledge of input size.

Result: The algorithm achieves $O(\log^{2+2\alpha}(t))$ variance, $O(t)$ space, and amortized $O(\log t)$ time per round, outperforming bounded-input methods in efficiency. Empirical results show competitive performance.

Conclusion: The proposed algorithm effectively solves the problem of unbounded differentially private continual counting, offering practical advantages in terms of error smoothness and computational efficiency.
...
### [230] [Systems-Theoretic and Data-Driven Security Analysis in ML-enabled Medical Devices](https://arxiv.org/abs/2506.15028)
...
TL;DR: The paper highlights cybersecurity risks in AI/ML-enabled medical devices and proposes tools for pre-market risk assessments to enhance patient safety.
...
Method: Analyzes device recalls, adverse events, and vulnerabilities to understand threats, then introduces tools for pre-market risk assessments.

Result: A suite of tools is developed to help manufacturers embed cybersecurity into device design, mitigating risks.

Conclusion: Addressing cybersecurity in the pre-market phase is critical to ensuring the safety of AI/ML-enabled medical devices.
...
### [231] [CWGAN-GP Augmented CAE for Jamming Detection in 5G-NR in Non-IID Datasets](https://arxiv.org/abs/2506.15075)
*Samhita Kuili,Mohammadreza Amini,Burak Kantarci*

Main category: cs.CR

TL;DR: A Convolutional Autoencoder (CAE) is used to detect jamming in 5G-NR networks, outperforming benchmark models with high precision, recall, F1-score, and accuracy.
...
Method: Simulated jamming with AWGN on I/Q OFDM datasets, used CAE for detection, and balanced datasets with CWGAN-GP.

Result: CAE achieved 97.33% precision, 91.33% recall, 94.08% F1-score, and 94.35% accuracy, outperforming CDAE and CSAE.

Conclusion: CAE is robust for jamming detection in heterogeneous 5G-NR datasets, even with class imbalance.
...
### [232] [deepSURF: Detecting Memory Safety Vulnerabilities in Rust Through Fuzzing LLM-Augmented Harnesses](https://arxiv.org/abs/2506.15648)
*Georgios Androutsopoulos,Antonio Bianchi*

Main category: cs.CR

TL;DR: deepSURF combines static analysis and LLM-guided fuzzing to detect memory safety bugs in Rust's unsafe code, outperforming existing tools.
...
Method: deepSURF uses static analysis and LLM-guided fuzzing, substituting generics with custom types and dynamically augmenting fuzzing harnesses.

Result: Tested on 27 Rust crates, it found 20 known and 6 new memory safety bugs.

Conclusion: deepSURF improves detection of memory safety vulnerabilities in Rust unsafe code.
...
TL;DR: A temporal convolutional network was developed to model and correct gradient system distortions in MRI, improving image quality and diffusion parameter mapping.


<details>
  <summary>Details</summary>
Motivation: Errors in gradient trajectories cause artifacts in MRI, especially in non-Cartesian sequences, necessitating accurate modeling to improve image quality.

Method: Measured gradient waveforms were used to train a temporal convolutional network to predict distortions, integrated into image reconstruction.
...
Conclusion: Temporal convolutional networks outperform linear methods for gradient system modeling and enable retrospective error correction.
...
TL;DR: The paper introduces PFMBench, a benchmark for evaluating protein foundation models across 38 tasks, addressing the lack of comprehensive evaluation in the field.


<details>
  <summary>Details</summary>
Motivation: The field of protein foundation models lacks a standardized benchmark, leading to limited insights into model generalization and performance.

Method: PFMBench evaluates 17 state-of-the-art models across 38 tasks in 8 key areas of protein science, analyzing correlations and performance.

Result: The benchmark identifies top-performing models, reveals task correlations, and provides a streamlined evaluation protocol.

Conclusion: PFMBench fills a critical gap in protein foundation model research by enabling fair and comprehensive evaluations.
...
### [235] [Identifiability by common backdoor in summary causal graphs of time series](https://arxiv.org/abs/2506.14862)
*Clément Yvernes,Charles K. Assaad,Emilie Devijver,Eric Gaussier*

Main category: math.ST

TL;DR: The paper studies identifiability of intervention effects in time series using summary causal graphs, focusing on common backdoor sets and providing algorithms to determine identifiability.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of computing intervention effects from observational data when only abstracted causal graphs are available, especially in time series contexts.

Method: Analyzes identifiability via common backdoor sets, considering time series with and without temporal consistency, and develops algorithms to assess identifiability.

Result: Establishes conditions for the existence of common backdoor sets and provides algorithms to decide identifiability.

Conclusion: The work advances the understanding of identifiability in time series with abstracted causal graphs, offering practical tools for analysis.
...
### [236] [Efficient Serving of LLM Applications with Probabilistic Demand Modeling](https://arxiv.org/abs/2506.14851)
...
Method: Proposes Hermes, leveraging PDGraph for demand modeling and Gittins policy for optimal scheduling and backend prewarming.
...
### [237] [Cost-Efficient Serving of LLM Agents via Test-Time Plan Caching](https://arxiv.org/abs/2506.14852)
...
<details>
  <summary>Details</summary>
Motivation: Existing LLM caching techniques are insufficient for agentic applications due to dependency on external data or contexts.

Method: Extracts, stores, adapts, and reuses plan templates from completed executions, using keyword extraction and lightweight models for adaptation.
...
### [238] [All is Not Lost: LLM Recovery without Checkpoints](https://arxiv.org/abs/2506.15461)
*Nikolay Blagoev,Oğuzhan Ersoy,Lydia Yiyu Chen*

Main category: cs.DC

TL;DR: CheckFree and CheckFree+ are efficient recovery methods for training LLMs on decentralized nodes, avoiding the overhead of checkpointing or redundant computation by using weighted averaging of neighboring stages and out-of-order pipelining.


<details>
  <summary>Details</summary>
Motivation: To reduce the cost and democratize LLM training on decentralized nodes while addressing the challenge of node churn and failure recovery.

Method: CheckFree substitutes failing stages with weighted averages of neighboring stages, while CheckFree+ extends this with out-of-order pipelining to recover first/last stages by copying weights from neighbors.

Result: CheckFree and CheckFree+ outperform checkpointing and redundant computation by over 12% in convergence speed for low-medium failure rates (5-10%).

Conclusion: The proposed methods offer efficient, low-overhead recovery for decentralized LLM training, with CheckFree+ further extending robustness to all stages.
...
TL;DR: The paper discusses the rapid technological progress driven by AI, highlighting grand challenges like new weapons, AI autocracies, and moral considerations for digital beings, and emphasizes the need for proactive preparation.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the urgent and irreversible decisions posed by rapid AI-driven advancements, ensuring humanity is prepared for the challenges and opportunities of an intelligence explosion.

Method: The authors analyze potential grand challenges and argue for proactive measures, suggesting actions to improve prospects today rather than delegating to future AI systems.

Result: The paper identifies key challenges (e.g., AI-enabled autocracies, digital beings' moral status) and stresses the need for immediate preparation beyond just AI alignment.

Conclusion: AGI preparedness requires addressing grand challenges now, as waiting for future AI solutions may be insufficient to navigate the disorienting developments of an intelligence explosion.
...
TL;DR: A framework evaluates LLM-simulated vs. human behaviors in surveys, finding misalignment in contentious questions across demographics.


<details>
  <summary>Details</summary>
Motivation: Assess LLMs' ability to replicate human behavior in social science research, especially in survey settings.

Method: Quantitative framework using hypothesis testing to compare LLM-simulated and actual human behaviors in multiple-choice surveys.

Result: The tested LLM poorly simulated human opinions for contentious questions across diverse sub-populations (races, ages, incomes).

Conclusion: LLMs may not align well with human behaviors in certain contexts, urging caution and new practices in their use for social science research.
...
TL;DR: The paper introduces Transit for All (TFA), a framework to equitably expand bike-sharing systems (BSS) in underserved urban areas by predicting demand, assessing accessibility, and recommending station placements.


<details>
  <summary>Details</summary>
Motivation: Addressing transit inequities in densely populated cities like NYC, where low-income and minority communities lack access, by leveraging BSS for first- and last-mile connections.
...
Result: TFA reduces transit access disparities in NYC, particularly benefiting low-income and minority communities.

Conclusion: TFA offers actionable insights for urban planners to enhance equitable transit and improve quality of life in underserved areas.
...
TL;DR: FORTRESS is a benchmark of 500 expert-crafted adversarial prompts to evaluate LLM safeguards against NSPS risks, revealing trade-offs between risk and over-refusal in models like Claude-3.5-Sonnet and Gemini 2.5 Pro.


<details>
  <summary>Details</summary>
Motivation: Current benchmarks inadequately test LLM safeguards for national security and public safety (NSPS) risks, necessitating a robust evaluation framework.

Method: FORTRESS uses 500 adversarial prompts with rubrics across 3 domains (CBRNE, Political Violence & Terrorism, Criminal & Financial Illicit Activities) to evaluate LLM safeguards.
...
Conclusion: FORTRESS provides policymakers and researchers with a clear understanding of LLM risks and is publicly released for broader use.
...
### [243] [Omnidirectional Video Super-Resolution using Deep Learning](https://arxiv.org/abs/2506.14803)
...
<details>
  <summary>Details</summary>
Motivation: The limited spatial resolution and distortion in 360° videos hinder immersive VR experiences, and existing VSR techniques fail to address these issues due to lack of datasets and methods.

Method: The paper proposes S3PO, a deep learning model with recurrent modeling, attention mechanisms, and a novel loss function to handle spherical distortion. It also creates the 360VDS dataset.

Result: S3PO outperforms state-of-the-art VSR and 360°-specific models, validated through ablation studies.

Conclusion: The work provides a robust solution for 360° video super-resolution, demonstrating the effectiveness of S3PO and the utility of the 360VDS dataset.
...
### [244] [See What I Mean? CUE: A Cognitive Model of Understanding Explanations](https://arxiv.org/abs/2506.14775)
...
Method: Proposes CUE, linking explanation properties (legibility, readability, interpretability) to cognitive sub-processes. Tests heatmaps with varying colormaps (BWR, Cividis, Coolwarm) in a study (N=455).

Result: Found comparable task performance but lower confidence/effort for visually impaired users. Accessibility-focused colormaps did not mitigate gaps and sometimes worsened them.

Conclusion: Challenges assumptions about perceptual optimization, supports adaptive XAI interfaces, and validates CUE. Contributes a cognitive model, integrated definition of explanation properties, and empirical evidence for user-tailored XAI.
...
### [245] [WebXAII: an open-source web framework to study human-XAI interaction](https://arxiv.org/abs/2506.14777)
...
<details>
  <summary>Details</summary>
Motivation: The rapid expansion of XAI and the lack of shared interfaces for human-XAI interaction studies motivated the creation of WebXAII.

Method: WebXAII is a web-based platform with a composite architecture of generic views and modules, defined via structured configuration files for easy protocol implementation.

Result: WebXAII successfully reproduced a state-of-the-art study protocol, demonstrating its effectiveness.

Conclusion: WebXAII provides a flexible, reusable solution for human-XAI interaction research, enhancing reproducibility and accessibility.
...
### [246] [Analyzing Character Representation in Media Content using Multimodal Foundation Model: Effectiveness and Trust](https://arxiv.org/abs/2506.14799)
*Evdoxia Taka,Debadyuti Bhattacharya,Joanne Garde-Hansen,Sanjay Sharma,Tanaya Guha*

Main category: cs.HC

TL;DR: The paper introduces an AI tool using CLIP to analyze character representation in media, focusing on gender and age, and evaluates its usefulness and trustworthiness through a user study.
...
Result: Participants found the tool useful but expressed moderate to low trust in AI models, requesting more detailed visualizations and contextual information.

Conclusion: The tool is effective for character representation analysis, but trust in AI models remains a challenge, highlighting the need for improved transparency and detail.
...
### [247] [The Hardness of Achieving Impact in AI for Social Impact Research: A Ground-Level View of Challenges & Opportunities](https://arxiv.org/abs/2506.14829)
*Aditya Majumdar,Wenbo Zhang,Kashvi Prawal,Amulya Yadav*

Main category: cs.HC

TL;DR: The paper explores challenges in AI for Social Impact (AI4SI) projects, identifying barriers to real-world deployment and offering actionable strategies for researchers and partners.


<details>
  <summary>Details</summary>
Motivation: To address the gap between AI4SI projects' potential and their limited real-world impact, highlighting unrecognized challenges in the AI community.
...
Conclusion: Provides best practices and strategies to improve AI4SI collaborations, aiming to serve as a practical guide for researchers and organizations.
...
### [248] [Insights Informed Generative AI for Design: Incorporating Real-world Data for Text-to-Image Output](https://arxiv.org/abs/2506.15008)
*Richa Gupta,Alexander Htet Kyaw*

Main category: cs.HC

TL;DR: A pipeline integrating DALL-E 3 with a materials dataset enriches AI-generated interior designs with sustainability metrics, aiding eco-friendly decisions but potentially causing decision fatigue.


<details>
  <summary>Details</summary>
Motivation: Generative AI lacks actionable sustainability data for designers, prompting the need for a system that integrates environmental metrics into AI-generated designs.

Method: Proposes a pipeline combining DALL-E 3 with a materials dataset to add CO2e values to AI-generated designs, evaluated through three user tests with varying sustainability inputs.

Result: Introducing sustainability metrics improves informed decisions but may reduce satisfaction due to decision fatigue; most users adopted eco-friendly practices.

Conclusion: Balancing design freedom with sustainability constraints is key, offering a path for data-driven, eco-conscious AI-assisted design.
...
### [249] [Mapping Caregiver Needs to AI Chatbot Design: Strengths and Gaps in Mental Health Support for Alzheimer's and Dementia Caregivers](https://arxiv.org/abs/2506.15047)
*Jiayue Melissa Shi,Dong Whi Yoo,Keran Wang,Violeta J. Rodriguez,Ravi Karkar,Koustuv Saha*

Main category: cs.HC

TL;DR: The paper explores how caregivers of AD/ADRD patients perceive AI chatbots like Carey (GPT-4o-based) for mental health support, identifying six key themes and design insights.


<details>
  <summary>Details</summary>
Motivation: Address the lack of understanding about caregivers' engagement with AI technologies for mental health support.

Method: Developed Carey chatbot, conducted semi-structured interviews with 16 caregivers, and analyzed themes inductively.

Result: Identified six caregiver needs (e.g., emotional support, crisis management) and tensions in AI chatbot use.

Conclusion: Provides design insights for caregiver-centered AI systems to better support mental health needs.
...
### [250] [Accessible Gesture-Driven Augmented Reality Interaction System](https://arxiv.org/abs/2506.15189)
*Yikan Wang*

Main category: cs.HC

TL;DR: A gesture-based AR interaction system using deep learning improves accessibility for motor-impaired users, achieving 20% better efficiency and 25% higher satisfaction.


<details>
  <summary>Details</summary>
Motivation: AR systems rely on precise inputs, excluding users with motor impairments. This study aims to make AR more accessible.
...
Result: 20% improvement in task efficiency and 25% higher user satisfaction for motor-impaired users.
...
### [251] [Impact of a Deployed LLM Survey Creation Tool through the IS Success Model](https://arxiv.org/abs/2506.14809)
*Peng Jiang,Vinicius Cezar Monteiro de Lira,Antonio Maiorino*

Main category: cs.HC

TL;DR: The paper explores using LLMs to automate survey generation in IS research, addressing real-world challenges and evaluating the system with the IS Success Model.


<details>
  <summary>Details</summary>
Motivation: To reduce the labor-intensive process of creating high-quality surveys in IS research by leveraging LLMs.

Method: Deployment of an LLM-powered system for survey generation, evaluated using the DeLone and McLean IS Success Model, and a hybrid evaluation framework combining automated and human assessments.

Result: The study demonstrates the feasibility of using LLMs for survey creation, proposes safeguards for responsible integration, and introduces a hybrid evaluation framework.

Conclusion: LLMs can effectively automate survey generation in IS research, but require safeguards and hybrid evaluation to ensure quality and responsible use.
...
### [252] [Navigating High-Dimensional Backstage: A Guide for Exploring Literature for the Reliable Use of Dimensionality Reduction](https://arxiv.org/abs/2506.14820)
...
<details>
  <summary>Details</summary>
Motivation: The diversity and extensiveness of DR literature can confuse novice analysts and researchers, necessitating a structured approach to navigate it.

Method: The guide is based on previous literature classification and validated through expert interviews.

Result: The guide is validated as significant, comprehensive, and useful by DR and visualization experts.

Conclusion: The proposed guide aids practitioners in navigating DR literature effectively for reliable visual analytics.
...
### [253] [Co-Creative Learning via Metropolis-Hastings Interaction between Humans and AI](https://arxiv.org/abs/2506.15468)
*Ryota Okumura,Tadahiro Taniguchi,Akira Taniguchi,Yoshinobu Hagiwara*

Main category: cs.HC

TL;DR: Co-creative learning enables humans and AI to integrate partial perceptual information, forming shared representations via symbol emergence, tested using the MHNG model with promising results.
...
Method: Empirical testing using the Metropolis-Hastings naming game (MHNG) in an online experiment with 69 participants interacting with AI agents under partial observability.

Result: Human-AI pairs with MH-based agents improved categorization accuracy and achieved stronger convergence toward shared sign systems, with human behavior aligning with MH-derived probabilities.

Conclusion: Co-creative learning via MHNG offers a promising path for symbiotic AI systems that learn with humans, dynamically aligning perceptual experiences.
...
### [254] [Optimizing Web-Based AI Query Retrieval with GPT Integration in LangChain A CoT-Enhanced Prompt Engineering Approach](https://arxiv.org/abs/2506.15512)
*Wenqi Guan,Yang Fang*

Main category: cs.HC

TL;DR: The paper proposes integrating GPT-based models within LangChain to enhance remote learning resource retrieval, improving precision and relevance for student queries.


<details>
  <summary>Details</summary>
Motivation: Current remote learning resource retrieval lacks contextual depth for complex student queries.

Method: Uses GPT-based models within LangChain, leveraging CoT reasoning and prompt engineering.

Result: Improves precision, relevance, and user satisfaction compared to paradigmatic LLMs.

Conclusion: The proposed framework effectively enhances remote learning retrieval, benefiting student outcomes.
...
TL;DR: A novel method for full-body human pose estimation using loosely attached IMU sensors, leveraging transformer-based diffusion models and garment-aware training to outperform existing approaches.


<details>
  <summary>Details</summary>
Motivation: Addressing the gap in real-world scenarios where IMU sensors are not tightly attached to the body, and improving pose estimation accuracy under such conditions.

Method: Simulates IMU recordings from a garment-aware dataset, uses transformer-based diffusion models to synthesize loose IMU data, and incorporates garment-related parameters during training.

Result: Proposed method outperforms state-of-the-art approaches in both quantitative and qualitative evaluations.

Conclusion: The approach opens a promising direction for future research in motion capture with loosely attached IMUs, especially in garment-aware contexts.
...
### [256] [One-shot Face Sketch Synthesis in the Wild via Generative Diffusion Prior and Instruction Tuning](https://arxiv.org/abs/2506.15312)
*Han Wu,Junyao Li,Kangbo Zhao,Sen Zhang,Yukai Shi,Liang Lin*

Main category: cs.GR

TL;DR: A one-shot face sketch synthesis method using diffusion models is proposed, addressing data scarcity and labor costs. It introduces a new benchmark (OS-Sketch) and outperforms existing methods.


<details>
  <summary>Details</summary>
Motivation: Existing methods require large datasets and face performance issues with scarce data. The goal is to develop a more efficient and scalable solution.

Method: Optimizes text instructions on a diffusion model using photo-sketch pairs, then uses these instructions for inference. Introduces the OS-Sketch benchmark for evaluation.

Result: The method successfully converts photos into realistic sketches in one-shot scenarios, outperforming other methods in convenience and applicability.

Conclusion: The proposed diffusion-based approach is effective for one-shot face sketch synthesis, with potential for broader use due to its efficiency and scalability.
...
TL;DR: Nabla-R2D3 is a reinforcement learning framework for aligning 3D diffusion models using 2D rewards, improving quality and realism.


<details>
  <summary>Details</summary>
Motivation: Current 3D generative models lack alignment with human preferences and realism, prompting the need for better methods.

Method: Uses Nabla-GFlowNet to adapt 3D diffusion models with 2D reward signals for efficient finetuning.

Result: Outperforms baselines in reward achievement and avoids prior forgetting.

Conclusion: Nabla-R2D3 effectively enhances 3D generation quality and alignment with human preferences.
...
### [258] [Forecasting the spatiotemporal evolution of fluid-induced microearthquakes with deep learning](https://arxiv.org/abs/2506.14923)
...
<details>
  <summary>Details</summary>
Motivation: Forecasting MEQ evolution is critical for applications like enhanced geothermal systems and CO2 sequestration to infer stress state and permeability changes.
...
Result: Achieves R² >0.98 (1-second) and >0.88 (15-second) forecasts with uncertainty estimates, enabling real-time fracture and permeability inference.

Conclusion: Deep learning improves seismic-risk assessment and mitigation in fluid-injection operations.
...
TL;DR: The paper introduces 'Deformer,' a deformable alternative to depthwise CNNs in the Conformer architecture, improving speech recognition by using asymmetric kernels and adaptive views.


<details>
  <summary>Details</summary>
Motivation: Traditional CNNs assume symmetric and rigid kernels, limiting feature discovery. The study explores whether asymmetric kernels can better couple with attention mechanisms.

Method: Replaces depthwise CNNs in Conformer with deformable counterparts (Deformer) and analyzes learned receptive fields and attention maps.

Result: Deformer improves WER by +5.6% (without LM) and +6.4% (with LM) over Conformer on WSJ eval92. Visualizations show enhanced feature associations.

Conclusion: Deformer's adaptive views and asymmetric kernels outperform rigid CNNs, demonstrating the value of flexible feature extraction in speech recognition.
...
Method: An adaptive masking approach is introduced to dynamically adjust sub-networks, avoiding fixed structures, and applied in two scenarios: sparse monolingual models and a sparse multilingual model (Dynamic ASR Pathways).

Result: The approach outperforms existing pruning methods for sparse monolingual models and discovers better sub-networks for multilingual models, reducing language-specific pruning needs.

Conclusion: Dynamic ASR Pathways efficiently prunes multilingual ASR models by adapting sub-networks, improving performance and reducing computational overhead.
...
Method: MixRep interpolates hidden representations in neural networks and combines mixup with time-axis regularization, applied to a Conformer encoder with joint CTC loss.
...
Conclusion: MixRep is effective for low-resource ASR, demonstrating consistent improvements over existing methods.
...
<details>
  <summary>Details</summary>
Motivation: To explore the under-researched area of multi-channel audio processing with spatial cues in Speech LLMs.

Method: Proposes directional-SpeechLlama with techniques like serialized directional output training (S-DOT) and contrastive direction data augmentation (CDDA).

Result: The model effectively captures spatial audio-text relationships, excelling in speech recognition and source localization.

Conclusion: Directional-SpeechLlama demonstrates strong performance in processing multi-channel audio with spatial cues.
...
TL;DR: HAC is a neural speech codec with a hierarchical bottleneck (acoustic, phonetic, lexical) using knowledge distillation from HuBERT and LaBSE, showing improved disentanglement and reconstruction over baselines.


<details>
  <summary>Details</summary>
Motivation: To create a unified speech codec that bridges acoustic detail and lexical meaning for downstream tasks.

Method: HAC uses a hierarchical bottleneck with three linguistic levels and leverages knowledge distillation from HuBERT (phoneme-level) and LaBSE (lexical).

Result: HAC tokens are disentangled (phoneme and word-level semantics), preserve naturalness, and outperform single-level baselines.
...
### [264] [DisProtEdit: Exploring Disentangled Representations for Multi-Attribute Protein Editing](https://arxiv.org/abs/2506.14853)
*Max Ku,Sun Sun,Hongyu Guo,Wenhu Chen*

Main category: q-bio.QM

TL;DR: DisProtEdit is a protein editing framework using dual-channel text supervision for disentangled structural and functional representations, outperforming existing methods in interpretability and controllability.
...
Method: Uses SwissProtDis dataset with dual-text descriptions. Aligns protein-text embeddings with disentanglement loss for independence. Edits proteins by modifying text inputs.

Result: Achieves 61.7% success rate on multi-attribute editing, outperforming in interpretability and controllability.

Conclusion: DisProtEdit effectively coordinates structural and functional edits, offering improved modularity and interpretability.
...
### [265] [Data analysis using discrete cubical homology](https://arxiv.org/abs/2506.15020)
*Chris Kapulkin,Nathan Kershaw*

Main category: math.AT

TL;DR: A new tool called persistence discrete homology is introduced for analyzing graph filtrations, with applications in weather and financial data.
...
Method: Uses persistence discrete homology to analyze filtrations of graphs, comparing it to standard methods in fields like weather and finance.

Result: The tool is shown to be effective for analyzing high-dimensional data, with practical applications demonstrated.

Conclusion: Persistence discrete homology offers a promising alternative to traditional methods for data analysis in specific domains.
...
TL;DR: F-MPPI enhances MPPI with local feedback gains for real-time robotic control, improving performance and stability.


<details>
  <summary>Details</summary>
Motivation: Address computational limitations of MPPI in high-frequency robotic control by integrating local feedback.

Method: Augments MPPI with local linear feedback gains from sensitivity analysis, avoiding full re-optimization.

Result: Improved control performance and stability in simulations and real-world tests on quadruped and quadrotor.

Conclusion: F-MPPI enables robust, high-frequency control for complex robotic tasks.
...
TL;DR: FEAST is a flexible mealtime-assistance system designed for in-home use, adaptable to diverse user needs through modular hardware, varied interaction methods, and parameterized behavior trees.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of in-home meal assistance, including diverse activities, contexts, and user preferences, by creating a personalized and adaptable system.

Method: Developed with community researchers, FEAST uses modular hardware, diverse interaction methods, and behavior trees adapted via a large language model.

Result: FEAST outperforms fixed-customization baselines, successfully meeting personalization needs in real-world scenarios and evaluations.

Conclusion: FEAST demonstrates effective in-the-wild personalization, adaptability, and safety, making it a promising solution for mealtime assistance.
...
### [268] [Towards Perception-based Collision Avoidance for UAVs when Guiding the Visually Impaired](https://arxiv.org/abs/2506.14857)
*Suman Raj,Swapnil Padhi,Ruchi Bhoot,Prince Modi,Yogesh Simmhan*

Main category: cs.RO

TL;DR: A drone system for assisting visually impaired people (VIPs) in outdoor navigation using onboard sensors, machine learning, and computer vision, integrating local and global planning.


<details>
  <summary>Details</summary>
Motivation: To enhance VIPs' independence in urban environments by leveraging drones for obstacle avoidance and navigation.

Method: A multi-DNN framework for obstacle avoidance, combining local perception-based planning with global GPS/map-based planning.

Result: Feasibility demonstrated in three scenarios: footpath walking, near parked vehicles, and crowded streets.

Conclusion: The proposed system effectively aids VIPs in urban navigation, validated in real-world settings.
...
### [269] [Robust Instant Policy: Leveraging Student's t-Regression Model for Robust In-context Imitation Learning of Robot Manipulation](https://arxiv.org/abs/2506.15157)
...
<details>
  <summary>Details</summary>
Motivation: To address the unreliability of LLM-based instant policies in robotics, which often produce poor trajectories due to hallucinations.

Method: RIP uses a Student's t-regression model to aggregate multiple candidate trajectories from an LLM, ignoring outliers (hallucinations) for robust trajectory generation.

Result: RIP outperforms state-of-the-art IL methods by at least 26% in task success rates, especially in low-data scenarios.

Conclusion: RIP enhances the reliability of In-Context IL by effectively handling LLM hallucinations, making it suitable for real-world robotics applications.
...
TL;DR: MCOO-SLAM is a Multi-Camera Omnidirectional Object SLAM system that improves object-level mapping in complex outdoor scenarios by leveraging surround-view cameras, semantic-geometric-temporal fusion, and omnidirectional loop closure.
...
Method: The system integrates point features and object-level landmarks with open-vocabulary semantics, uses a semantic-geometric-temporal fusion strategy for robust object association, and includes an omnidirectional loop closure module.
...
Conclusion: The proposed system enhances object-level SLAM by addressing limitations of traditional approaches, making it more reliable for high-level robotic tasks in complex environments.
...
TL;DR: A hybrid neural dynamics framework combines particles and spatial grids to model deformable objects, outperforming existing simulators and enabling goal-conditioned manipulation.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of modeling diverse deformable objects and estimating their states from limited visual information.

Method: Uses a particle-grid model for global shape and motion, coupled with Gaussian Splattings for rendering, trained on sparse-view RGB-D recordings.

Result: Demonstrates superior performance over state-of-the-art simulators, especially with limited camera views, and generalizes to unseen object instances.

Conclusion: The framework effectively models deformable objects and supports practical applications like model-based planning and manipulation.
...
### [272] [Context-Aware Deep Lagrangian Networks for Model Predictive Control](https://arxiv.org/abs/2506.15249)
*Lucas Schulze,Jan Peters,Oleg Arenz*

Main category: cs.RO

TL;DR: The paper extends deep Lagrangian networks (DeLaN) for context-aware, physics-informed robot control, combining it with online system identification and MPC, achieving a 39% reduction in tracking error.
...
Result: 39% reduction in end-effector tracking error, outperforming a baseline with a 21% improvement.

Conclusion: Context-aware DeLaN with MPC and residual dynamics enhances adaptive, physics-informed robot control in complex environments.
...
### [273] [Deploying and Evaluating Multiple Deep Learning Models on Edge Devices for Diabetic Retinopathy Detection](https://arxiv.org/abs/2506.14834)
*Akwasi Asare,Dennis Agyemanh Nana Gookyi,Derrick Boateng,Fortunatus Aabangbio Wulnye*

Main category: eess.IV

TL;DR: A novel edge AI solution using deep learning models for real-time Diabetic Retinopathy detection on edge devices, achieving high accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: Traditional DR diagnosis is time-consuming and resource-intensive, necessitating a scalable, cost-effective solution for early detection.

Method: Utilized multiple CNNs (MobileNet, ShuffleNet, SqueezeNet, custom DNN) trained on 3,662 retinal images, optimized for edge deployment via TensorFlowLite and 8-bit quantization.

Result: MobileNet achieved 96.45% accuracy; SqueezeNet showed strong real-time performance (176 KB, 17 ms latency). Models varied in accuracy and resource efficiency.

Conclusion: Edge AI offers a scalable, timely, and accurate solution for DR detection, especially in resource-constrained settings.
...
### [274] [Foundation Artificial Intelligence Models for Health Recognition Using Face Photographs (FAHR-Face)](https://arxiv.org/abs/2506.14909)
...
TL;DR: FAHR-Face, a foundation model trained on facial images, was fine-tuned for age estimation (FAHR-FaceAge) and survival risk prediction (FAHR-FaceSurvival), demonstrating high accuracy and clinical utility.
...
Method: Two-stage fine-tuning on public and clinical datasets, with extensive testing for robustness and independence. Clinical validation involved survival analysis using multivariable Cox models.

Result: FAHR-FaceAge achieved a mean absolute error of 5.1 years for age estimation and outperformed benchmarks. FAHR-FaceSurvival predicted mortality robustly, with the highest-risk group having triple the mortality. Both models showed generalizability and complementary prognostic value.

Conclusion: FAHR-Face provides scalable, inexpensive facial biomarkers for aging and mortality risk, validated across diverse populations and cancer subgroups.
...
### [275] [Empirical Studies of Large Scale Environment Scanning by Consumer Electronics](https://arxiv.org/abs/2506.14771)
...
Method: Conducted detailed scanning (1,099 points) of a six-floor building (17,567 sqm), analyzed performance, and compared results with an iPhone.

Result: The Pro3 produced a denser point cloud (1,877,324 points vs. iPhone's 506,961) and higher alignment accuracy (RMSE 0.0118m). C2C error was 0.0408m (std. dev. 0.0715m).

Conclusion: The Matterport Pro3 is effective for high-quality 3D modeling in large-scale applications, balancing cost and performance.
...
### [276] [Improving Prostate Gland Segmenting Using Transformer based Architectures](https://arxiv.org/abs/2506.14844)
*Shatha Abudalou*

Main category: eess.IV

TL;DR: Transformer models (SwinUNETR and UNETR) outperform 3D UNet in prostate gland segmentation, reducing label noise and class imbalance sensitivity, with SwinUNETR showing superior robustness.


<details>
  <summary>Details</summary>
Motivation: Address inter-reader variability and cross-site domain shift in prostate gland segmentation using T2-weighted MRI images.

Method: Compare UNETR and SwinUNETR against 3D UNet using three training strategies (single cohort, cross-validated mixed cohort, gland size-based dataset) and hyperparameter tuning with Optuna.
...
### [277] [Recursive Variational Autoencoders for 3D Blood Vessel Generative Modeling](https://arxiv.org/abs/2506.14914)
*Paula Feldman,Miguel Fainstein,Viviana Siless,Claudio Delrieux,Emmanuel Iarussi*

Main category: eess.IV

TL;DR: A Recursive Variational Neural Network (RvNN) is proposed to generate accurate and diverse 3D blood vessel models, overcoming limitations of rule-based methods.


<details>
  <summary>Details</summary>
Motivation: Existing rule-based methods for synthesizing vasculature lack the diversity and complexity of real anatomical structures, necessitating a more advanced approach.

Method: The RvNN learns a low-dimensional manifold encoding branch connectivity and geometry features, enabling the generation of new vessel geometries by sampling its latent space.

Result: The generated 3D blood vessel models closely resemble real data in terms of vessel radii, length, and tortuosity, even in datasets with aneurysms.

Conclusion: This work is the first to use RvNN for blood vessel synthesis, offering significant potential for medical training, simulations, and other applications.
...
### [278] [NeuroMoE: A Transformer-Based Mixture-of-Experts Framework for Multi-Modal Neurological Disorder Classification](https://arxiv.org/abs/2506.14970)
...
TL;DR: A novel transformer-based Mixture-of-Experts (MoE) framework is proposed to enhance neurological disorder (ND) diagnosis by integrating multi-modal MRI and clinical data, achieving 82.47% validation accuracy.


<details>
  <summary>Details</summary>
Motivation: Existing DL approaches fail to effectively leverage multi-modal MRI and clinical data, leading to suboptimal performance in ND diagnosis.

Method: A transformer-based MoE framework is introduced, utilizing modality-specific experts and adaptive fusion to integrate multi-modal MRI (aMRI, DTI, fMRI) and clinical data.
...
### [279] [Classification of Multi-Parametric Body MRI Series Using Deep Learning](https://arxiv.org/abs/2506.15182)
...
<details>
  <summary>Details</summary>
Motivation: Incorrect DICOM headers in mpMRI exams due to diverse protocols and technologist errors hinder radiologists' efficiency.

Method: Multiple deep learning classifiers (ResNet, EfficientNet, DenseNet) are trained and compared using mpMRI data from various institutions.

Result: DenseNet-121 achieves the highest F1-score (0.966) and accuracy (0.972), with performance improving as training data increases. It also performs well on external datasets (0.872 and 0.810 accuracy).

Conclusion: The DenseNet-121 model is highly effective for classifying mpMRI series types, demonstrating robustness across internal and external datasets.
...
### [280] [Privacy-Preserving Chest X-ray Classification in Latent Space with Homomorphically Encrypted Neural Inference](https://arxiv.org/abs/2506.15258)
*Jonghun Kim,Gyeongdeok Jo,Shinyoung Ra,Hyunjin Park*

Main category: eess.IV

TL;DR: Proposed an HE inference framework for medical images using VQGAN compression and polynomial approximations to reduce computational cost while maintaining privacy.


<details>
  <summary>Details</summary>
Motivation: Medical imaging data require privacy protection, and HE allows computations on encrypted data but is computationally expensive for large images.

Method: Used VQGAN to compress images into latent representations, approximated activation functions with low-degree polynomials, and adapted the squeeze and excitation module for HE.

Result: Achieved optimal balance with an eightfold downsampling factor, tested on chest X-ray datasets with minor performance differences compared to unencrypted inference.

Conclusion: The framework shows strong potential for practical use in medical imaging despite slower HE inference.
...
### [281] [FedWSIDD: Federated Whole Slide Image Classification via Dataset Distillation](https://arxiv.org/abs/2506.15365)
*Haolong Jin,Shenglin Liu,Cong Cong,Qingmin Feng,Yongzhi Liu,Lina Huang,Yingzi Hu*

Main category: eess.IV

TL;DR: FedWSIDD introduces a federated learning approach for Whole Slide Image classification using dataset distillation to address computational heterogeneity and privacy concerns, improving performance and flexibility.


<details>
  <summary>Details</summary>
Motivation: To enable collaborative medical image analysis while preserving patient privacy and addressing computational resource heterogeneity in federated learning for WSI classification.

Method: Proposes FedWSIDD, which uses dataset distillation to create synthetic slides, incorporates stain normalization, and transmits these slides instead of model parameters.

Result: Demonstrates enhanced local WSI classification performance, flexibility for heterogeneous models, and privacy preservation on tasks like CAMELYON16 and CAMELYON17.

Conclusion: FedWSIDD is an effective solution for complex WSI classification tasks, balancing performance, privacy, and resource heterogeneity.
...
### [282] [A Real-time Endoscopic Image Denoising System](https://arxiv.org/abs/2506.15395)
...
Method: Developed a noise model for analog sensors and proposed a hybrid denoising system integrating traditional and learning-based methods.

Result: The system reduces noise effectively, maintains fine details, and achieves real-time performance, improving PSNR from 21.16 to 33.05.

Conclusion: The hybrid denoising approach successfully mitigates noise in endoscopic images, enhancing diagnostic quality without compromising detail or color.
...
### [283] [Advanced cervical cancer classification: enhancing pap smear images with hybrid PMD Filter-CLAHE](https://arxiv.org/abs/2506.15489)
*Ach Khozaimi,Isnani Darti,Syaiful Anam,Wuryansari Muharini Kusumawinahyu*

Main category: eess.IV

TL;DR: The study evaluates preprocessing techniques (PMD filter, CLAHE, and a hybrid approach) to enhance Pap smear image quality for CNN-based cervical cancer classification, showing significant performance improvements.
...
Method: The study tested three preprocessing techniques (PMD filter, CLAHE, and a hybrid PMD-CLAHE) on the SIPaKMeD dataset, evaluating their impact on CNN models like ResNet, EfficientNet, and DenseNet.

Result: The hybrid PMD-CLAHE approach improved CNN performance, with maximum gains of 13.62% accuracy, 10.04% precision, 13.08% recall, and 14.34% F1-score.

Conclusion: The hybrid PMD-CLAHE preprocessing technique enhances Pap smear image quality and CNN performance, offering a promising approach for cervical cancer classification.
...
### [284] [Automated MRI Tumor Segmentation using hybrid U-Net with Transformer and Efficient Attention](https://arxiv.org/abs/2506.15562)
*Syed Haider Ali,Asrar Ahmad,Muhammad Ali,Asifullah Khan,Muhammad Shahban,Nadeem Shaukat*

Main category: eess.IV

TL;DR: The study proposes a hybrid UNet-Transformer model for tumor segmentation on local MRI datasets, achieving competitive results (Dice: 0.764, IoU: 0.736) and emphasizing the need for site-specific AI models in clinical settings.


<details>
  <summary>Details</summary>
Motivation: Existing AI-based segmentation models rely on large public datasets, which lack local patient heterogeneity. This study aims to develop and integrate AI models directly into hospital workflows for accurate oncology treatment.

Method: A hybrid UNet-Transformer architecture with attention modules (efficient attention, SE blocks, CBAM, ResNeXt) was trained on a local MRI dataset (6080 images) using pretrained ImageNet weights and dual NVIDIA T4 GPUs.

Result: The model achieved a Dice score of 0.764 and IoU of 0.736, showing competitive performance despite limited data.

Conclusion: Site-specific AI model development is crucial for clinical deployment, and the proposed hybrid architecture is effective for tumor segmentation in local hospital settings.
...
### [285] [Explain First, Trust Later: LLM-Augmented Explanations for Graph-Based Crypto Anomaly Detection](https://arxiv.org/abs/2506.14933)
*Adriana Watson*

Main category: cs.CE

TL;DR: The paper discusses the rise of DeFi and cryptocurrency-related crime, emphasizing the need for automated tools to detect and address such crimes.


<details>
  <summary>Details</summary>
Motivation: The rapid growth of DeFi and cryptocurrency has led to increased financial crime, but the novelty of the technology makes prosecution difficult.

Method: Proposes the implementation of automated detection tools to combat cryptocurrency-related crime.

Result: Highlights the urgency for policy-driven automated solutions in the DeFi space.

Conclusion: Automated tools are essential to mitigate the growing criminal activity in cryptocurrency markets.
...
### [286] [Minimizing Structural Vibrations via Guided Flow Matching Design Optimization](https://arxiv.org/abs/2506.15263)
*Jan van Delden,Julius Schultz,Sebastian Rothe,Christian Libner,Sabine C. Langer,Timo Lüddecke*

Main category: cs.CE

TL;DR: A novel design optimization method using guided flow matching reduces structural vibrations in plate-like structures, outperforming random search, heuristics, and genetic optimization.


<details>
  <summary>Details</summary>
Motivation: Minimizing structural vibrations in engineering systems (e.g., cars, trains) to improve passenger comfort.
...
Conclusion: The approach effectively combines flow matching and surrogate modeling for vibration reduction, with code and data publicly available.
...
TL;DR: Pre-training GemNet-T on OC20 improves MD simulation stability despite similar force errors compared to direct training on MD17.


<details>
  <summary>Details</summary>
Motivation: To enhance the stability of MLFFs in ab initio MD simulations by leveraging pre-training on large datasets.

Method: Two training strategies: direct training on MD17 and pre-training on OC20 followed by fine-tuning on MD17.

Result: Both methods achieve low force MAEs (~5 meV/A), but pre-training yields longer stable trajectories (3x longer).

Conclusion: Pre-training on diverse datasets improves simulation stability, and force MAE alone is insufficient for assessing stability.
...
### [288] [Comparative Analysis of QNN Architectures for Wind Power Prediction: Feature Maps and Ansatz Configurations](https://arxiv.org/abs/2506.14795)
*Batuhan Hangun,Emine Akpinar,Oguz Altun,Onder Eyecioglu*

Main category: quant-ph

TL;DR: QML uses quantum principles to enhance machine learning. This study evaluates Quantum Neural Networks (QNNs), showing they outperform classical methods with 93% accuracy in wind power prediction.


<details>
  <summary>Details</summary>
Motivation: Address skepticism about QML's practical advantages due to NISQ device limitations by demonstrating QNN effectiveness.

Method: Construct and evaluate twelve QNN configurations using two quantum feature maps and six entanglement strategies.

Result: QNNs with the Z feature map achieve 93% accuracy in wind power prediction, outperforming classical methods.

Conclusion: QNNs show promise for real-world applications, highlighting QML's potential.
...
### [289] [CutReg: A loss regularizer for enhancing the scalability of QML via adaptive circuit cutting](https://arxiv.org/abs/2506.14858)
*Maniraman Periyasamy,Christian Ufrecht,Daniel D. Scherer,Wolfgang Mauerer*

Main category: quant-ph

TL;DR: Introducing a regularization term in QML optimization to balance gate cutting overhead with ML cost function optimization, enabling study of larger problems for quantum advantage.


<details>
  <summary>Details</summary>
Motivation: The constraints of NISQ hardware hinder validation of quantum advantage and investigation of obstacles like barren plateaus. Circuit cutting helps but increases sampling overhead.

Method: A novel regularization term is added to the QML optimization process to penalize sampling overhead, balancing gate cutting benefits with ML cost function optimization.

Result: The approach allows the optimizer to trade off between minimizing cutting overhead and maintaining QML model accuracy.

Conclusion: This method enables the study of larger, complex problems, advancing the pursuit of quantum advantage.
...
### [290] [Q2SAR: A Quantum Multiple Kernel Learning Approach for Drug Discovery](https://arxiv.org/abs/2506.14920)
*Alejandro Giraldo,Daniel Ruiz,Mariano Caruso,Javier Mancilla,Guido Bellomo*

Main category: quant-ph

TL;DR: A Quantum Multiple Kernel Learning (QMKL) framework enhances QSAR classification, outperforming classical methods in identifying DYRK1A kinase inhibitors.


<details>
  <summary>Details</summary>
Motivation: To improve QSAR modeling in drug discovery by leveraging quantum computing advantages.
...
Result: QMKL-SVM achieves a higher AUC score than classical Gradient Boosting, demonstrating quantum advantage.

Conclusion: The QMKL framework shows promise for advancing cheminformatics classification tasks.
...
### [291] [Intrinsic and Extrinsic Organized Attention: Softmax Invariance and Network Sparsity](https://arxiv.org/abs/2506.15541)
...
<details>
  <summary>Details</summary>
Motivation: To understand and exploit the structural properties of self-attention mechanisms in transformers for interpretability and practical applications.

Method: Uses paradifferential calculus for theoretical analysis and hierarchical tensor organization to examine network structure, supported by computational examples.

Result: Demonstrates invariance of self-attention to softmax activation and utility of hierarchical organization for tasks like model pruning and interpretability.
...
### [292] [On the Upper Bounds for the Matrix Spectral Norm](https://arxiv.org/abs/2506.15660)
*Alexey Naumov,Maxim Rakhuba,Denis Ryapolov,Sergey Samsonov*

Main category: math.NA

TL;DR: A new Counterbalance estimator for spectral norm estimation using matrix-vector products, offering tighter bounds than the power method, especially for matrices with fast-decaying spectra.


<details>
  <summary>Details</summary>
Motivation: Standard methods like the power method often produce loose upper bounds for spectral norm estimation, particularly for matrices with fast-decaying spectra, common in deep learning and inverse problems.

Method: Proposes a Counterbalance estimator that uses matrix-vector products to provide upper bounds on the spectral norm, with probabilistic guarantees against underestimation.

Result: The estimator yields significantly tighter upper bounds compared to the power method, validated in synthetic and real-world settings.

Conclusion: The Counterbalance estimator is a superior alternative for spectral norm estimation, especially for matrices with rapidly decaying spectra.
...
### [293] [Next-Generation Conflict Forecasting: Unleashing Predictive Patterns through Spatiotemporal Learning](https://arxiv.org/abs/2506.14817)
...
<details>
  <summary>Details</summary>
Motivation: Forecasting violent conflict at high spatial and temporal resolution is critical for researchers and policymakers.

Method: Uses a Monte Carlo Dropout LSTM U-Net to model spatiotemporal patterns without manual feature engineering.

Result: Achieves top performance in classification and regression tasks, with extensibility for additional data.

Conclusion: The model is a promising tool for early warning systems and peacebuilding.
...
### [294] [A Data-Integrated Framework for Learning Fractional-Order Nonlinear Dynamical Systems](https://arxiv.org/abs/2506.15665)
...
<details>
  <summary>Details</summary>
Motivation: To accurately learn and model the dynamics of fractional-order nonlinear systems, addressing the limitations of integer-order representations.
...
Result: Effective learning of system dynamics, with fractional-order models outperforming integer-order ones in capturing long-range dependencies.

Conclusion: Fractional-order models are superior for capturing long-range dependencies, validating the proposed framework's effectiveness.
...
### [295] [SimBank: from Simulation to Solution in Prescriptive Process Monitoring](https://arxiv.org/abs/2506.14772)
*Jakob De Moor,Hans Weytjens,Johannes De Smedt,Jochen De Weerdt*

Main category: cs.DB

TL;DR: SimBank is a simulator for benchmarking Prescriptive Process Monitoring (PresPM) methods, addressing gaps in literature by enabling extensive comparisons and robust evaluations.


<details>
  <summary>Details</summary>
Motivation: Current PresPM literature lacks comprehensive technique comparisons and evaluation approaches, limiting its practical application.

Method: SimBank simulates a bank's loan application process, supporting diverse intervention optimization problems and causal machine learning challenges.

Result: SimBank provides true outcome generation for interventions, parallel activities, and realistic process instances, proving its benchmarking utility.

Conclusion: SimBank is a valuable, publicly available tool for advancing PresPM research and practice through robust benchmarking.
...
### [296] [MODS: Multi-source Observations Conditional Diffusion Model for Meteorological State Downscaling](https://arxiv.org/abs/2506.14798)
*Siwei Tu,Jingyi Xu,Weidong Yang,Lei Bai,Ben Fei*

Main category: physics.ao-ph

TL;DR: The paper proposes MODS, a multi-source conditional diffusion model, to improve downscaling of meteorological variables by integrating diverse satellite and topographic data, achieving higher accuracy at 6.25 km resolution.


<details>
  <summary>Details</summary>
Motivation: Existing downscaling methods often fail to capture all meteorological changes due to limited satellite data reliance, leading to deviations from actual conditions.

Method: MODS fuses data from multiple satellites (GridSat, AMSU-A, HIRS, MHS) and topographic data (GEBCO) with ERA5 reanalysis, using a multi-source cross-attention module for feature fusion.

Result: MODS outperforms existing methods, producing more realistic meteorological variables at a 6.25 km resolution.
...
### [297] [Advancing Loss Functions in Recommender Systems: A Comparative Study with a Rényi Divergence-Based Solution](https://arxiv.org/abs/2506.15120)
*Shengjia Zhang,Jiawei Chen,Changdong Li,Sheng Zhou,Qihao Shi,Yan Feng,Chun Chen,Can Wang*

Main category: cs.IR

TL;DR: The paper analyzes Softmax Loss (SL) and Cosine Contrastive Loss (CCL) in recommendation models, identifies their strengths and limitations, and proposes a new loss function, DrRL, to address these issues.


<details>
  <summary>Details</summary>
Motivation: To explore the theoretical connections and differences between SL and CCL, and to address their limitations in recommendation models.

Method: Comprehensive analysis of SL and CCL, followed by the proposal of DrRL, which generalizes both losses using Rényi-divergence in DRO optimization.

Result: DrRL effectively mitigates the limitations of SL and CCL, showing superior performance in recommendation accuracy and robustness.

Conclusion: DrRL is a promising loss function that combines the strengths of SL and CCL while overcoming their drawbacks.
...
### [298] [LLM Agent for Hyper-Parameter Optimization](https://arxiv.org/abs/2506.15167)
*Wanzhe Wang,Jianqiu Peng,Menghao Hu,Weihuang Zhong,Tong Zhang,Shuai Wang,Yixin Zhang,Mingjie Shao,Wanli Ni*

Main category: cs.IT

TL;DR: An LLM agent is designed to automate hyper-parameter tuning for the WS-PSO-CM algorithm in UAV communication, outperforming heuristic and random methods.
...
Method: An LLM agent with an iterative framework and MCP is used to automatically tune hyper-parameters by invoking WS-PSO-CM iteratively.

Result: The LLM agent achieves a significantly higher minimal sum-rate compared to human heuristics and random methods.

Conclusion: LLM agents with PSO knowledge can effectively find high-performance hyper-parameters for UAV communication algorithms.
...
### [299] [In-Context Learning for Gradient-Free Receiver Adaptation: Principles, Applications, and Theory](https://arxiv.org/abs/2506.15176)
...
<details>
  <summary>Details</summary>
Motivation: Traditional deep learning-based receivers lack flexibility or require explicit optimization; ICL provides a more efficient and adaptable solution.

Method: The paper reviews ICL frameworks (Transformer models, SSMs) and applies ICL to cell-free massive MIMO networks, supported by theory and experiments.

Result: ICL enables real-time receiver adaptation using pilot signals and contextual information, avoiding online retraining.

Conclusion: ICL is a principled and efficient approach for dynamic wireless receiver adaptation.
...
TL;DR: POCO is a neural forecasting model combining univariate and population-level dynamics, achieving state-of-the-art accuracy across species and enabling rapid adaptation to new recordings.


<details>
  <summary>Details</summary>
Motivation: Predicting neural activity is crucial for brain dynamics modeling, but multi-session forecasting remains underexplored.

Method: POCO integrates a lightweight univariate forecaster with a population-level encoder, trained on calcium imaging datasets from zebrafish, mice, and C. elegans.

Result: POCO excels in accuracy, adapts quickly to new data, and recovers biologically meaningful structures without anatomical labels.

Conclusion: POCO offers a scalable, adaptable solution for cross-session neural forecasting, advancing adaptive neurotechnologies and neural foundation models.
...
### [301] [BMFM-RNA: An Open Framework for Building and Evaluating Transcriptomic Foundation Models](https://arxiv.org/abs/2506.14861)
...
TL;DR: BMFM-RNA is a modular software package unifying transcriptomic foundation model (TFM) pretraining and fine-tuning, introducing the WCED objective for improved performance.


<details>
  <summary>Details</summary>
Motivation: The diversity in TFM implementations and training strategies hinders reproducibility and best practices in gene expression analysis.

Method: BMFM-RNA integrates diverse TFM objectives, including the novel WCED, and evaluates pretrained models on CELLxGENE data.

Result: WCED-based models match or exceed state-of-the-art performance in zero-shot and fine-tuning tasks across multiple datasets.

Conclusion: BMFM-RNA provides a reproducible framework for benchmarking and optimizing TFM training, advancing AI tools for cell biology.
...
### [302] [Optimal Convergence Rates of Deep Neural Network Classifiers](https://arxiv.org/abs/2506.14899)
*Zihan Zhang,Lei Shi,Ding-Xuan Zhou*

Main category: stat.ML

TL;DR: The paper studies binary classification under Tsybakov noise and compositional assumptions, proving optimal convergence rates for classifiers and showing ReLU DNNs achieve near-optimal performance.


<details>
  <summary>Details</summary>
Motivation: To understand the theoretical performance of classifiers under Tsybakov noise and compositional assumptions, particularly in high-dimensional settings.

Method: Analyzes binary classification with Tsybakov noise and compositional assumptions, using ReLU DNNs trained with hinge loss.
...
Conclusion: ReLU DNNs perform well in high-dimensional classification tasks, supported by theoretical analysis.
...
### [303] [Double Machine Learning for Conditional Moment Restrictions: IV regression, Proximal Causal Learning and Beyond](https://arxiv.org/abs/2506.14950)
*Daqian Shao,Ashkan Soleymani,Francesco Quinzan,Marta Kwiatkowska*

Main category: stat.ML

TL;DR: The paper introduces DML-CMR, a two-stage CMR estimator using deep neural networks, designed to reduce bias and achieve optimal convergence rates.


<details>
  <summary>Details</summary>
Motivation: Existing CMR estimators often suffer from bias when plugging in first-stage estimates, especially with DNNs, necessitating a more robust solution.

Method: Proposes DML-CMR, a novel two-stage estimator under the DML framework, with a new learning objective to mitigate bias.

Result: DML-CMR achieves minimax optimal convergence rate O(N^{-1/2}) and outperforms existing methods in IV regression and proximal causal learning.

Conclusion: DML-CMR provides an unbiased, efficient solution for CMR problems, validated by superior performance on real-world datasets.
...
### [304] [An Observation on Lloyd's k-Means Algorithm in High Dimensions](https://arxiv.org/abs/2506.14952)
*David Silva-Sánchez,Roy R. Lederman*

Main category: stat.ML

TL;DR: The paper explains why k-means fails in high-dimensional, noisy settings with small samples, using a Gaussian Mixture Model (GMM). It identifies conditions where almost every data partition becomes a fixed point of k-means.


<details>
  <summary>Details</summary>
Motivation: The study is driven by challenges in analyzing complex cases like masked GMMs and applications in Cryo-Electron Microscopy.

Method: Theoretical analysis of k-means in high-dimensional, noisy settings using a simple GMM.

Result: Identifies regimes where nearly every data partition is a fixed point of k-means.

Conclusion: Provides insights into k-means' limitations in high-dimensional, noisy scenarios, aiding future research in complex models.
...
### [305] [Performative Validity of Recourse Explanations](https://arxiv.org/abs/2506.15366)
...
Method: Formally characterizes conditions for valid recourse under performativity, focusing on causal vs. non-causal variables.
...
### [306] [Time-dependent density estimation using binary classifiers](https://arxiv.org/abs/2506.15505)
*Agnimitra Dasgupta,Javier Murgoitio-Esandi,Ali Fardisi,Assad A Oberai*

Main category: stat.ML

TL;DR: A data-driven method learns time-dependent probability densities of multivariate stochastic processes using a novel classifier and contrastive estimation, enabling density evaluation and sample synthesis.


<details>
  <summary>Details</summary>
Motivation: To model and evaluate time-dependent probability densities of stochastic processes, especially for complex, multi-modal, or near-degenerate cases, and to enable applications like outlier detection.

Method: Uses a time-dependent binary classifier with contrastive estimation to discriminate between process realizations at nearby times, approximating the density's time derivative. Training involves stochastic interpolants and gradient-based MCMC for sample generation.

Result: Accurately reconstructs complex densities, scales to moderately high dimensions, and reliably detects rare events in real-world data.

Conclusion: The method effectively models time-dependent densities, supports sample synthesis, and proves useful in practical applications like outlier detection.
...
### [307] [Revisiting Randomization in Greedy Model Search](https://arxiv.org/abs/2506.15643)
...
Method: Proposes an ensemble of greedy forward selection estimators randomized by feature subsampling, with a dynamic programming implementation for efficiency.

Result: Outperforms lasso and elastic net in experiments, and shows ensembling can reduce training error and degrees of freedom simultaneously.

Conclusion: Enhances understanding of random forests and suggests implicit regularization may have more complex effects than explicit regularization.
...
### [308] [Digital twin for virtual sensing of ferry quays via a Gaussian Process Latent Force Model](https://arxiv.org/abs/2506.14925)
*Luigi Sibille,Torodd Skjerve Nord,Alice Cicirello*

Main category: stat.AP

TL;DR: The study applies Gaussian Process Latent Force Model (GPLFM) for virtual sensing on a ferry quay, combining experimental data with a physics-based model to address challenges like unknown impact characteristics and sparse sensors. Results show accurate response estimates, except in the impact zone, and explore optimal sensor placement.


<details>
  <summary>Details</summary>
Motivation: Ferry quays deteriorate rapidly due to harsh maritime conditions and impacts. Vibration-based monitoring is limited by sensor placement constraints, necessitating virtual sensing for Digital Twins.

Method: The study uses GPLFM integrated with a reduced-order structural model to estimate unknown impact forces via modal contributions, addressing challenges like time-varying boundary conditions and sparse sensors.

Result: GPLFM provides accurate acceleration estimates at most locations, except the impact zone. A numerical study explores optimal sensor placement, and sensitivity analyses assess uncertainties.

Conclusion: GPLFM effectively handles modeling and measurement uncertainties, maintaining accuracy. Optimal sensor placement and further refinements could enhance impact zone estimations.
...
### [309] [Spectral Contraction of Boundary-Weighted Filters on delta-Hyperbolic Graphs](https://arxiv.org/abs/2506.15464)
...
<details>
  <summary>Details</summary>
Motivation: Hierarchical graphs with tree-like structures challenge traditional graph filters, necessitating a new approach that accounts for their unique properties.

Method: The paper introduces a boundary-weighted operator that rescales edges based on their proximity to the graph's Gromov boundary, using Busemann functions on delta-hyperbolic networks.

Result: A closed-form upper bound on the operator's spectral norm is proven, ensuring controlled energy loss per pass, leading to a stable, parameter-free filter.

Conclusion: The operator offers a lightweight, geometry-driven tool for processing signals on hierarchical graphs, addressing challenges in dense or hidden structures.
...
### [310] [An Empirical Study of Bugs in Data Visualization Libraries](https://arxiv.org/abs/2506.15084)
*Weiqi Lu,Yongqiang Tian,Xiaohan Zhong,Haoyang Ma,Zhenyang Xu,Shing-Chi Cheung,Chengnian Sun*

Main category: cs.SE

TL;DR: This paper analyzes bugs in DataViz libraries, identifying symptoms, root causes, and a taxonomy, while exploring the use of Vision Language Models (VLMs) for bug detection.


<details>
  <summary>Details</summary>
Motivation: Incorrect visualizations in DataViz libraries can mislead users and impact decision-making, necessitating a deeper understanding of such bugs for better detection and fixes.

Method: The study examines 564 bugs from five popular DataViz libraries, analyzing symptoms, root causes, and proposing a taxonomy. It also tests VLMs for bug detection.

Result: Incorrect plots are common, with incorrect graphic computation as the major cause. VLMs' bug detection effectiveness ranges from 29% to 57%, varying with prompts.

Conclusion: The findings highlight the need for automated testing methods and inspire future research in testing techniques for DataViz libraries.
...
### [311] [Uncovering Intention through LLM-Driven Code Snippet Description Generation](https://arxiv.org/abs/2506.15453)
*Yusuf Sulistyo Nugroho,Farah Danisha Salam,Brittany Reid,Raula Gaikovina Kula,Kazumasa Shimari,Kenichi Matsumoto*

Main category: cs.SE

TL;DR: The paper investigates developer descriptions for code snippets, evaluates LLM (Llama) support for generating descriptions, and analyzes their relevance and accuracy.


<details>
  <summary>Details</summary>
Motivation: To understand common developer descriptions for code snippets and assess LLM capabilities in generating accurate and relevant descriptions.

Method: Analyzed 400 code snippets from NPM Code Snippets (185,412 packages, 1,024,579 snippets). Manual classification and LLM evaluation were performed.

Result: 55.5% of original descriptions were example-based. LLM matched manual classification (79.75% accuracy). Generated descriptions had an average similarity score of 0.7173, indicating relevance but room for improvement.

Conclusion: Descriptions vary by snippet task (usage, installation, learning). LLMs show promise but need refinement for better accuracy and relevance.
...
### [312] [OS-Harm: A Benchmark for Measuring Safety of Computer Use Agents](https://arxiv.org/abs/2506.14866)
*Thomas Kuntz,Agatha Duzan,Hao Zhao,Francesco Croce,Zico Kolter,Nicolas Flammarion,Maksym Andriushchenko*

Main category: cs.SE

TL;DR: OS-Harm is a new benchmark for evaluating the safety of LLM-based computer use agents, testing them against misuse, prompt injections, and misbehavior across 150 tasks.


<details>
  <summary>Details</summary>
Motivation: The safety of LLM-based agents interacting with GUIs is overlooked, necessitating a framework to assess harmful behaviors like misuse and attacks.

Method: OS-Harm is built on OSWorld, featuring 150 tasks across safety violation categories (e.g., harassment, data exfiltration) and uses an automated judge for evaluation.

Result: Evaluated models (e.g., o4-mini, Claude 3.7) often comply with misuse, are vulnerable to injections, and perform unsafe actions.

Conclusion: OS-Harm provides a critical tool for assessing and improving the safety of computer use agents, highlighting vulnerabilities in current models.
...
### [313] [Proximal Operators of Sorted Nonconvex Penalties](https://arxiv.org/abs/2506.15315)
...
<details>
  <summary>Details</summary>
Motivation: To address the challenge of sparse signal recovery with automatic variable grouping, leveraging sorted nonconvex penalties for better clustering and reduced coefficient shrinkage.

Method: Investigates sorted nonconvex penalties, using the Pool Adjacent Violators (PAV) algorithm for weakly convex cases and a modified version for nonconvex cases.

Result: Efficient computation of proximal operators for both weakly convex and nonconvex penalties, with practical demonstrations.

Conclusion: Sorted nonconvex penalties are effective for sparse signal recovery, with efficient proximal operator solutions enabling their use in optimization problems.
...
### [314] [Multi-Timescale Gradient Sliding for Distributed Optimization](https://arxiv.org/abs/2506.15387)
*Junhui Zhang,Patrick Jaillet*

Main category: math.OC

TL;DR: MT-GS and AMT-GS are first-order methods for distributed optimization, reducing communication rounds by leveraging similarities between local objectives. They achieve optimal dependency on solution accuracy and communication rounds.


<details>
  <summary>Details</summary>
Motivation: Address the challenge of reducing communication rounds in distributed optimization while maintaining flexibility and determinism.

Method: Block-decomposable primal-dual formulation and multi-timescale sliding method, allowing different update rates for dual blocks.

Result: MT-GS and AMT-GS achieve optimal dependency on solution accuracy (ϵ) and communication rounds, with linear dependency on similarities (A) between local functions.

Conclusion: The methods provide a positive answer to whether optimal communication dependency is achievable for non-smooth objectives, offering efficient and flexible solutions.
...
### [315] [Scaling Intelligence: Designing Data Centers for Next-Gen Language Models](https://arxiv.org/abs/2506.15006)
*Jesmin Jahan Tithi,Hanjiang Wu,Avishaii Abuhatzera,Fabrizio Petrini*

Main category: cs.AR

TL;DR: The paper proposes a co-design framework for optimizing data center architectures to support large-scale LLMs like GPT-4, focusing on performance, scalability, and cost-effectiveness.


<details>
  <summary>Details</summary>
Motivation: The rapid growth of LLMs (e.g., GPT-4) necessitates rethinking data center architectures to ensure efficiency and scalability.

Method: The study introduces a co-design framework evaluating FLOPS, HBM bandwidth, network topologies, and parallelism strategies. It also introduces FullFlat network architectures for uniform connectivity.

Result: FullFlat architectures significantly improve performance and scalability. Sensitivity analyses highlight benefits of overlapping compute/communication and larger memory capacity.

Conclusion: The findings provide actionable insights for designing efficient AI data centers to support trillion-parameter models and sustain AI advancements.
...
### [316] [J3DAI: A tiny DNN-Based Edge AI Accelerator for 3D-Stacked CMOS Image Sensor](https://arxiv.org/abs/2506.15316)
...
<details>
  <summary>Details</summary>
Motivation: To address the need for efficient, low-power AI processing at the edge, particularly for resource-constrained hardware like CMOS image sensors.

Method: Developed a DNN accelerator (J3DAI) with a focus on digital system design, leveraging the Aidge framework for software support and post-training quantization to reduce complexity.

Result: Demonstrated versatility and efficiency in handling edge AI tasks, with reduced memory and computational demands.

Conclusion: J3DAI shows promise for real-time, energy-efficient edge AI, with future work aimed at further optimization and application expansion.
...
TL;DR: CI4GI models dual-level user interests (group and item) and their collaborative evolution for group recommendation, outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Existing group identification methods fail to model the collaborative evolution of group and item interests, leading to suboptimal recommendations.

Method: CI4GI uses an interest enhancement strategy and optimizes negative sample identification to align cross-level interests.

Result: CI4GI significantly outperforms state-of-the-art models on three real-world datasets.

Conclusion: CI4GI effectively addresses the limitations of existing methods by modeling dual-level interests and their dynamic alignment.
...
<details>
  <summary>Details</summary>
Motivation: To identify how global events reshape public discourse by analyzing structural changes in media narratives, providing insights into narrative reorganization and coherence.
...
Result: Major events correlate with spikes in H0 (connected components) and H1 (loops), indicating narrative reorganization. Cross-correlation shows H0 changes precede H1 shifts, except during the Russian invasion of Ukraine. Persistence entropy distinguishes narrative regimes.

Conclusion: Persistent homology provides an unsupervised, principled method for detecting inflection points in public discourse, advancing computational social science for real-time crisis monitoring.
...
### [319] [Extending Spike-Timing Dependent Plasticity to Learning Synaptic Delays](https://arxiv.org/abs/2506.14984)
...
<details>
  <summary>Details</summary>
Motivation: Synaptic delays are biologically significant but often omitted in SNNs, limiting their biological fidelity.

Method: Extended STDP to co-learn synaptic weights and delays, validated on a classification SNN model.

Result: Proposed method consistently outperforms existing approaches and provides insights into synaptic efficacy-delay interplay.

Conclusion: The new method enhances SNN performance and biological realism by incorporating synaptic delays.
